...
export declare class ClientError extends ScrivitoError {
    ...
    constructor(message: string, code: string | undefined, details: object);
}
...
/** @public */
export declare function provideDataItem(name: string, get: ExternalDataItemConnection['get'], ...excessArgs: never[]): DataItem;

/** @public */
export declare function provideDataItem(name: string, connection: ExternalDataItemConnection, ...excessArgs: never[]): DataItem;
...
/** @public */
declare type ResultItem = ResultItemConvenienceId | ResultItemWithId;
...
declare interface ResultItemWithId extends ResultItemData {
    _id: DataId;
}
...
/** @public */
export declare const unstable_JrRestApi: ApiClient;

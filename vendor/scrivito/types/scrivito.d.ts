...
declare type DataAttributeDefinitionsCallback = () => Promise<DataAttributeDefinitions>;
...
declare type DataClassTitleCallback = () => Promise<DataClassTitle>;
...
declare type LazyAsyncDataAttributeDefinitions = DataAttributeDefinitions | Promise<DataAttributeDefinitions> | DataAttributeDefinitionsCallback;

declare type LazyAsyncDataClassTitle = DataClassTitle | Promise<DataClassTitle> | DataClassTitleCallback;
...
declare type NormalizedTypeInfo<Type extends CmsAttributeType> = Type extends keyof NormalizedTypeConfigMapping ? [Type, NormalizedTypeConfigMapping[Type]] : [Type, {}];
...
/** @public */
export declare function provideDataClass(name: string, params: AsyncOrSync<{

...
export class Obj<AttrDefs extends AttributeDefinitions = AttributeDefinitions> {
  ...
  get<AttributeName extends keyof AttrDefs & string>(
    ...
    // eslint-disable-next-line @typescript-eslint/no-non-null-assertion -- TypeScript will display an error if the attribute in question does not have a corresponding attribute definition.

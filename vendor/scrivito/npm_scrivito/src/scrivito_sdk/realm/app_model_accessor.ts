...
export function updateAppAttributes(
  ...
  // eslint-disable-next-line @typescript-eslint/no-non-null-assertion -- truthy appClass implies that model is neither Obj nor Widget itself. Every Subclass of Obj and Widget has a Schema.

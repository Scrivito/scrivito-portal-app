...
declare class ApiClient {
    ...
    fetchWithDefaults(path: string, defaults: FetchOptions): Promise<unknown>;
...
declare type AttributeEditingConfig = {
    title?: string;
    description?: string;
...
declare type AttributeEditor = 'colorPicker' | 'dimensionPicker';
...
/** @public */
export declare const BackgroundImageTag: ComponentType<BackgroundImageTagProps>;
...
declare interface BaseConfiguration {
...
/** @public */
export declare const ChildListTag: ComponentType<ChildListTagProps>;

declare type ChildListTagProps = HTMLAttributes<HTMLElement> & {
    parent?: Obj;
    tag?: string;
...
declare type CmsAttributeType = 'binary' | 'boolean' | 'datalocator' | 'date' | 'datetime' | 'enum' | 'float' | 'html' | 'integer' | 'link' | 'linklist' | 'multienum' | 'reference' | 'referencelist' | 'string' | 'stringlist' | 'widgetlist' | keyof InternalCmsAttributeType;

declare interface ColorPickerEditorAttributeEditingOptions {
    allowAlpha?: boolean;
}
...
declare type ComponentType_2<P = object> = ComponentClass<P> | SyncFunctionComponent<P>;

declare type Configuration = (TenantConfiguration | InstanceIdConfiguration) & BaseConfiguration;
...
/** @public */
export declare function configurePreviewSizes(previewSizes: PreviewSizeInput[]): void;
...
/** @public */
export declare function connect<Props extends LoadingProps, LoadingProps>(component: ComponentClass<Props>, options?: ConnectOptions<LoadingProps>): ComponentClass<Props>;

/** @public */
export declare function connect<Props extends LoadingProps, LoadingProps>(component: ComponentType_2<Props>, options?: ConnectOptions<LoadingProps>): ComponentType_2<Props>;

declare interface ConnectOptions<LoadingProps> {
    loading?: ComponentType_2<LoadingProps>;
}
...
declare type ContentTagType = {
    <AttrDefs extends AttributeDefinitions = AttributeDefinitions>(props: ContentTagProps<AttrDefs>): ReactElement | null;
};
...
/** @public */
export declare const CurrentPage: ComponentType<unknown>;
...
/** @public */
export declare interface CustomPageComponentProps extends CustomComponentProps {
    obj: Obj;
    page: Obj;
}

/** @public */
export declare interface CustomWidgetComponentProps extends CustomComponentProps {
    widget: Widget;
}

/* Excluded from this release type: DamImageSelectorProps */

/* Excluded from this release type: DamProps */
...
declare type DataAttributeDefinitionWithOptionalConfig = Exclude<DataAttributeType, 'enum' | 'multienum' | 'reference'>;

declare type DataAttributeType = 'boolean' | 'date' | 'enum' | 'multienum' | 'number' | 'reference' | 'string' | 'unknown';
...
declare interface DimensionPickerEditorAttributeEditingOptions {
    units?: readonly DimensionPickerUnit[];
}

declare type DimensionPickerUnit = 'px' | '%' | 'rem' | 'em' | 'vh' | 'vw';
...
declare type EditorSpecificAttributeEditingConfig = {
    editor: 'colorPicker';
...
declare type ExtensionComponent = ComponentType<{
    obj: Obj;
}> | ComponentType<{
    page: Obj;
}> | ComponentType<{
...
/** @public */
export declare function Extensions(): ReactPortal | null;
...
declare type GroupProperty = GroupPropertyWithConfig | GroupPropertyWithComponent | PreviewComponentDescription | string;

declare type GroupPropertyWithComponent = readonly [
string,
    {
...
declare type GroupPropertyWithConfig = readonly [
string,
    {
    enabled: boolean;
    component?: never;
...
declare interface HtmlAttributeEditingOptions {
...
declare type ImageTagType = {
    <AttrDefs extends AttributeDefinitions = AttributeDefinitions>(props: ImageTagProps<AttrDefs>): ReactElement | null;
};
...
/** @public */
export declare const InPlaceEditAsPageContent: FC<PropsWithChildren>;

/** @public */
export declare const InPlaceEditingOff: FC<PropsWithChildren>;

declare interface InstanceIdConfiguration {
    tenant?: never;
    instanceId: string;
}

/** Helper type for marking string union items as internal */
declare type InternalCmsAttributeType = {};
...
/** @public */
export declare const NotFoundErrorPage: ComponentType<NotFoundErrorPageProps>;
...
declare interface PreviewComponentDescription {
    key: string;
...
declare interface PreviewSizeInput {
    title: string;
    width?: number | null;
    description?: string;
    icon?: string;
...
/** @public */
export declare function provideComponent<AttrDefs extends AttributeDefinitions>(objClass: ObjClass<AttrDefs>, component: ComponentType_2<PageComponentProps<AttrDefs>>, options?: ProvidedComponentOptions<PageComponentProps<AttrDefs>>): void;

/** @public */
export declare function provideComponent(classNameOrObjClass: string | ObjClass, component: ComponentType_2<Partial<PageComponentProps>>, options?: ProvidedComponentOptions<Partial<PageComponentProps>>): void;

/** @public */
export declare function provideComponent<AttrDefs extends AttributeDefinitions>(widgetClass: WidgetClass<AttrDefs>, component: ComponentType_2<WidgetComponentProps<AttrDefs>>, options?: ProvidedComponentOptions<WidgetComponentProps<AttrDefs>>): void;

/** @public */
export declare function provideComponent(classNameOrWidgetClass: string | WidgetClass, component: ComponentType_2<Partial<WidgetComponentProps>>, options?: ProvidedComponentOptions<Partial<WidgetComponentProps>>): void;

/** @public */
export declare function provideDataClass(params: FuncOrAsyncOrSync<ProvideDataClassParamsWithRestApi | ({
...
/** @public */
export declare function provideDataService(baseUrl: string, options?: {
    headers?: Record<string, string>;
    namespace?: string;
}): Promise<DataClass[]>;

declare interface ProvidedComponentOptions<Props> {
    loading?: ComponentType_2<Props>;
}
...
/** @public */
export declare function provideLayoutComponent<AttrDefs extends AttributeDefinitions = AttributeDefinitions>(objClass: ObjClass<AttrDefs>, component: ComponentType_2<LayoutComponentProps<AttrDefs>>, options?: ProvidedComponentOptions<LayoutComponentProps<AttrDefs>>): void;

/** @public */
export declare function provideLayoutComponent(objClass: ObjClass, component: ComponentType_2, options?: ProvidedComponentOptions<LayoutComponentProps>): void;
...
/** @public */
export declare function registerComponent<P extends Partial<CustomPageComponentProps> | Partial<CustomWidgetComponentProps>>(componentId: string, component: ComponentType_2<P>): void;
...
declare type RenderChild = (child: Obj) => ReactElement<{
    child: Obj;
}>;
...
/** @public */
export declare const RestoreInPlaceEditing: FC<PropsWithChildren>;
...
declare interface StringAttributeEditingOptions {
    multiLine?: boolean;
}
...
declare interface TenantConfiguration {
...
/* Excluded from this release type: unstable_Dam */

/* Excluded from this release type: unstable_DamImageSelector */
...
/** @public */
export declare function uploadFile(source: Blob): Promise<string>;
...
/** @public */
export declare function useIsInPlaceEditingActive(): boolean;
...
/** @public */
export declare const WidgetTag: ComponentType<WidgetTagProps>;

declare type WidgetTagProps = HTMLAttributes<HTMLElement> & {
    tag?: string;
    ref?: Ref<Element>;
};

declare type Width = ImgHTMLAttributes<HTMLImageElement>['width'];

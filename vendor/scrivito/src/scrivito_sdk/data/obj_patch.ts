...
function buildPatchEntry<T, Resolution>(
  ...
  // eslint-disable-next-line @typescript-eslint/no-non-null-assertion -- Note: the return type `undefined` is actually impossible, because `valueA` and `valueB` are not both undefined

(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("history"), require("lodash-es/debounce"), require("lodash-es/difference"), require("lodash-es/escape"), require("lodash-es/flatten"), require("lodash-es/flattenDeep"), require("lodash-es/identity"), require("lodash-es/intersection"), require("lodash-es/isDate"), require("lodash-es/isElement"), require("lodash-es/isEmpty"), require("lodash-es/isEqual"), require("lodash-es/isObject"), require("lodash-es/mapValues"), require("lodash-es/once"), require("lodash-es/pick"), require("lodash-es/pickBy"), require("lodash-es/throttle"), require("lodash-es/unescape"), require("lodash-es/uniqBy"), require("react"), require("react-dom"), require("speakingurl"), require("tcomb-react"), require("tcomb-validation"), require("urijs"));
	else if(typeof define === 'function' && define.amd)
		define(["history", "lodash-es/debounce", "lodash-es/difference", "lodash-es/escape", "lodash-es/flatten", "lodash-es/flattenDeep", "lodash-es/identity", "lodash-es/intersection", "lodash-es/isDate", "lodash-es/isElement", "lodash-es/isEmpty", "lodash-es/isEqual", "lodash-es/isObject", "lodash-es/mapValues", "lodash-es/once", "lodash-es/pick", "lodash-es/pickBy", "lodash-es/throttle", "lodash-es/unescape", "lodash-es/uniqBy", "react", "react-dom", "speakingurl", "tcomb-react", "tcomb-validation", "urijs"], factory);
	else if(typeof exports === 'object')
		exports["scrivito"] = factory(require("history"), require("lodash-es/debounce"), require("lodash-es/difference"), require("lodash-es/escape"), require("lodash-es/flatten"), require("lodash-es/flattenDeep"), require("lodash-es/identity"), require("lodash-es/intersection"), require("lodash-es/isDate"), require("lodash-es/isElement"), require("lodash-es/isEmpty"), require("lodash-es/isEqual"), require("lodash-es/isObject"), require("lodash-es/mapValues"), require("lodash-es/once"), require("lodash-es/pick"), require("lodash-es/pickBy"), require("lodash-es/throttle"), require("lodash-es/unescape"), require("lodash-es/uniqBy"), require("react"), require("react-dom"), require("speakingurl"), require("tcomb-react"), require("tcomb-validation"), require("urijs"));
	else
		root["scrivito"] = factory(root["history"], root["lodash-es/debounce"], root["lodash-es/difference"], root["lodash-es/escape"], root["lodash-es/flatten"], root["lodash-es/flattenDeep"], root["lodash-es/identity"], root["lodash-es/intersection"], root["lodash-es/isDate"], root["lodash-es/isElement"], root["lodash-es/isEmpty"], root["lodash-es/isEqual"], root["lodash-es/isObject"], root["lodash-es/mapValues"], root["lodash-es/once"], root["lodash-es/pick"], root["lodash-es/pickBy"], root["lodash-es/throttle"], root["lodash-es/unescape"], root["lodash-es/uniqBy"], root["react"], root["react-dom"], root["speakingurl"], root["tcomb-react"], root["tcomb-validation"], root["urijs"]);
})((typeof self !== 'undefined' ? self : global), (__WEBPACK_EXTERNAL_MODULE__5119__, __WEBPACK_EXTERNAL_MODULE__4431__, __WEBPACK_EXTERNAL_MODULE__1827__, __WEBPACK_EXTERNAL_MODULE__9367__, __WEBPACK_EXTERNAL_MODULE__1383__, __WEBPACK_EXTERNAL_MODULE__5287__, __WEBPACK_EXTERNAL_MODULE__7754__, __WEBPACK_EXTERNAL_MODULE__5925__, __WEBPACK_EXTERNAL_MODULE__6998__, __WEBPACK_EXTERNAL_MODULE__9258__, __WEBPACK_EXTERNAL_MODULE__2750__, __WEBPACK_EXTERNAL_MODULE__1736__, __WEBPACK_EXTERNAL_MODULE__2232__, __WEBPACK_EXTERNAL_MODULE__1776__, __WEBPACK_EXTERNAL_MODULE__2497__, __WEBPACK_EXTERNAL_MODULE__9548__, __WEBPACK_EXTERNAL_MODULE__895__, __WEBPACK_EXTERNAL_MODULE__8542__, __WEBPACK_EXTERNAL_MODULE__2009__, __WEBPACK_EXTERNAL_MODULE__7127__, __WEBPACK_EXTERNAL_MODULE__9849__, __WEBPACK_EXTERNAL_MODULE__831__, __WEBPACK_EXTERNAL_MODULE__3579__, __WEBPACK_EXTERNAL_MODULE__239__, __WEBPACK_EXTERNAL_MODULE__7631__, __WEBPACK_EXTERNAL_MODULE__4898__) => {
...
/* harmony export */ });
/* harmony import */ var urijs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4898);
...
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6500);
...
/* harmony export */ });
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6500);
...
/* harmony import */ var urijs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4898);
/* harmony import */ var urijs__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(urijs__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var scrivito_sdk_app_support_browser_location__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2985);
...
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(6500);
/* harmony import */ var scrivito_sdk_loadable__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(9340);
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(4640);
...
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6500);
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4640);
...
/* harmony import */ var history__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5119);
...
/* harmony import */ var urijs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4898);
...
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6500);
/* harmony import */ var scrivito_sdk_state__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2757);
...
/* harmony export */ });
/* harmony import */ var scrivito_sdk_app_support_ui_adapter__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(3218);
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6500);
/* harmony import */ var scrivito_sdk_loadable__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9340);
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4640);
/* harmony import */ var scrivito_sdk_realm__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(105);
...
/* harmony import */ var urijs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4898);
/* harmony import */ var urijs__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(urijs__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var scrivito_sdk_app_support_ui_adapter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3218);
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6500);
/* harmony import */ var _routing__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3420);
...
function changeLocation(url) {
  if (scrivito_sdk_app_support_ui_adapter__WEBPACK_IMPORTED_MODULE_3__/* .uiAdapter */ .k) {
    scrivito_sdk_app_support_ui_adapter__WEBPACK_IMPORTED_MODULE_3__/* .uiAdapter */ .k.navigateToExternalUrl(url);
  } else {
    (0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__/* .redirectTo */ .gB)(url);
  }
}
function openInNewWindow(url) {
  if (scrivito_sdk_app_support_ui_adapter__WEBPACK_IMPORTED_MODULE_3__/* .uiAdapter */ .k && (0,_routing__WEBPACK_IMPORTED_MODULE_2__/* .isLocalUri */ .m4)(urijs__WEBPACK_IMPORTED_MODULE_0__(url))) {
    scrivito_sdk_app_support_ui_adapter__WEBPACK_IMPORTED_MODULE_3__/* .uiAdapter */ .k.openInNewUiWindow(convertToAbsoluteLocalUrl(url));
  } else {
    (0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__/* .openWindow */ .xw)(url, "_blank");
  }
}
function convertToAbsoluteLocalUrl(url) {
  const origin = (0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__/* .currentOrigin */ .ZJ)();
  if (origin === void 0)
    throw new scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__/* .InternalError */ .AQ();
...
/* harmony import */ var lodash_es_intersection__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5925);
...
/* harmony import */ var lodash_es_mapValues__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1776);
...
/* harmony import */ var scrivito_sdk_app_support_absolute_url__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1729);
/* harmony import */ var scrivito_sdk_app_support_ui_adapter__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(3218);
/* harmony import */ var scrivito_sdk_app_support_ui_adapter_compatible_value__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8493);
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6500);
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(4640);
...
function configureContentBrowser(configuration, ...excessArgs) {
  if (!scrivito_sdk_app_support_ui_adapter__WEBPACK_IMPORTED_MODULE_6__/* .uiAdapter */ .k) {
    return;
  }
  try {
    checkConfigure(configuration, ...excessArgs);
  } catch (e) {
    throw e instanceof Error ? new scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .ArgumentError */ .ir(removeUnionSubTypeIndexesFromKey(e.message)) : e;
  }
  ...
  if (baseFilter) {
    ...
    if (baseQuery) {
      scrivito_sdk_app_support_ui_adapter__WEBPACK_IMPORTED_MODULE_6__/* .uiAdapter */ .k.configureContentBrowser(
        (0,scrivito_sdk_app_support_ui_adapter_compatible_value__WEBPACK_IMPORTED_MODULE_3__/* .uiAdapterCompatibleValue */ .f)({ baseQuery })
      );
    }
  }
}
...
const checkConfigure = (() => {
  if (scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .nodeEnv */ .rR !== "development")
    return () => {
    };
  const SearchFieldType = scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.union */ .pC.union([scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.String */ .pC.String, scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.list */ .pC.list(scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.String */ .pC.String)]);
  const SearchOperatorType = scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.enums */ .pC.enums.of(
    lodash_es_intersection__WEBPACK_IMPORTED_MODULE_0___default()(scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_5__/* .OPERATORS */ .fP, [
      "contains",
      "containsPrefix",
      "equals",
      "startsWith",
  ...
  const SearchValueType = scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.union */ .pC.union(
    [
      ...
      scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.list */ .pC.list(scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.union */ .pC.union([scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.String */ .pC.String, scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.Nil */ .pC.Nil])),
      scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.list */ .pC.list(scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.union */ .pC.union([scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.Date */ .pC.Date, scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.Nil */ .pC.Nil])),
      scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.list */ .pC.list(scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.union */ .pC.union([scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.Number */ .pC.Number, scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.Nil */ .pC.Nil]))
    ],
    "SearchValue"
  );
  const FilterNodeType = scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb["interface"] */ .pC["interface"]({
  ...
  const FilterCollectionNodeType = FilterNodeType.extend({
    field: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.maybe */ .pC.maybe(SearchFieldType),
    operator: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.maybe */ .pC.maybe(SearchOperatorType),
    expanded: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.maybe */ .pC.maybe(scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.Boolean */ .pC.Boolean)
  });
  const RadioOptionType = FilterNodeType.extend({
    value: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.maybe */ .pC.maybe(SearchValueType),
    query: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.maybe */ .pC.maybe(scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_5__/* .ObjSearchType */ .d4),
    selected: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.maybe */ .pC.maybe(scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.Boolean */ .pC.Boolean)
  });
  const RadioFilterType = FilterCollectionNodeType.extend(
    {
      type: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.enums */ .pC.enums.of(["radioButton"]),
      options: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.dict */ .pC.dict(scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.String */ .pC.String, RadioOptionType)
    },
  ...
  const CheckboxFilterType = FilterCollectionNodeType.extend(
    {
      type: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.enums */ .pC.enums.of(["checkbox"]),
      options: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.dict */ .pC.dict(scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.String */ .pC.String, CheckboxOptionType)
    },
    "CheckboxFilterDefinition"
  );
  const TreeFilterType = scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.declare */ .pC.declare("TreeFilterDefinition");
  TreeFilterType.define(
    FilterNodeType.extend({
      type: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.maybe */ .pC.maybe(scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.enums */ .pC.enums.of(["tree"])),
      icon: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.maybe */ .pC.maybe(scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.String */ .pC.String),
      query: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.maybe */ .pC.maybe(scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_5__/* .ObjSearchType */ .d4),
      expanded: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.maybe */ .pC.maybe(scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.Boolean */ .pC.Boolean),
      value: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.maybe */ .pC.maybe(SearchValueType),
      field: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.maybe */ .pC.maybe(SearchFieldType),
      operator: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.maybe */ .pC.maybe(SearchOperatorType),
      selected: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.maybe */ .pC.maybe(scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.Boolean */ .pC.Boolean),
      options: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.maybe */ .pC.maybe(scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.dict */ .pC.dict(scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.String */ .pC.String, TreeFilterType))
    })
  );
  ...
  const FilterDefinitionType = scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.union */ .pC.union([
  ...
  const StaticFiltersType = scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.dict */ .pC.dict(scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.String */ .pC.String, FilterDefinitionType);
  const DynamicOrStaticFiltersType = scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.union */ .pC.union([scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.Function */ .pC.Function, StaticFiltersType]);
  DynamicOrStaticFiltersType.dispatch = (v) => scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.Function */ .pC.Function.is(v) ? DynamicOrStaticFiltersType.meta.types[0] : DynamicOrStaticFiltersType.meta.types[1];
  const BaseFilterType = scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb["interface"] */ .pC["interface"]({
    query: scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_5__/* .ObjSearchType */ .d4
  });
  const ConfigurationType = scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb["interface"] */ .pC["interface"](
    {
      filters: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.maybe */ .pC.maybe(DynamicOrStaticFiltersType),
      baseFilter: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.maybe */ .pC.maybe(BaseFilterType)
    },
    "Configuration"
  );
  return (0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .checkArgumentsFor */ .PJ)(
...
function copyWithAbsoluteUrls(contentBrowserFilters) {
  return lodash_es_mapValues__WEBPACK_IMPORTED_MODULE_1___default()(contentBrowserFilters, (_a) => {
    ...
    if (icon)
      item.icon = hasCustomIcon ? (0,scrivito_sdk_app_support_absolute_url__WEBPACK_IMPORTED_MODULE_2__/* .absoluteUrl */ .G)(icon) : icon;
    if (options)
...
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4640);
...
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(4640);
...
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6500);
/* harmony import */ var scrivito_sdk_loadable__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9340);
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(4640);
...
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4640);
...
/* harmony export */ });
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6500);
/* harmony import */ var scrivito_sdk_data_integration__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4867);
...
/* harmony export */ });
/* harmony import */ var scrivito_sdk_app_support_ui_adapter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3218);
/* harmony import */ var scrivito_sdk_client__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5478);
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4640);
...
/* harmony export */ });
/* harmony import */ var lodash_es_isEmpty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2750);
...
/* harmony import */ var scrivito_sdk_app_support_editing_config_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(384);
/* harmony import */ var scrivito_sdk_app_support_present_ui_adapter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4712);
/* harmony import */ var scrivito_sdk_loadable__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9340);
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(4640);
/* harmony import */ var scrivito_sdk_realm__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(105);
...
function initializeContentForObj(objId) {
  return (0,scrivito_sdk_loadable__WEBPACK_IMPORTED_MODULE_3__/* .load */ .zD)(() => scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_4__/* .BasicObj */ .Jj.get(objId)).then((basicObj) => {
    if (basicObj) {
...
const isEnabled = (0,scrivito_sdk_state__WEBPACK_IMPORTED_MODULE_0__/* .createStateContainer */ .JH)();
...
function isLayoutEditable() {
  ...
  if (!wantsLayoutEditing())
    return true;
  return !!((_a = scrivito_sdk_app_support_ui_adapter__WEBPACK_IMPORTED_MODULE_1__/* .uiAdapter */ .k) == null ? void 0 : _a.isLayoutEditable());
}
function isPageEditable() {
  var _a;
  if (!wantsLayoutEditing())
    return true;
  return !!((_a = scrivito_sdk_app_support_ui_adapter__WEBPACK_IMPORTED_MODULE_1__/* .uiAdapter */ .k) == null ? void 0 : _a.isPageEditable());
}
...
/* harmony import */ var react_dom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(831);
...
// EXTERNAL MODULE: external "lodash-es/pick"
var pick_ = __webpack_require__(9548);
...
// EXTERNAL MODULE: ./scrivito_sdk/common/index.ts + 57 modules
var common = __webpack_require__(6500);
...
function navigateTo(target, options, ...excessArgs) {
  ...
  const providesTarget = () => typeof target === "function" ? target() : target;
...
function extractRoutingTargetForLink(link, queryParameters, hashToApply) {
  ...
  const query = queryParameters && !lodash_es_isEmpty__WEBPACK_IMPORTED_MODULE_0___default()(queryParameters) ? queryParameters : link.queryParameters();
...
/* harmony export */ });
/* harmony import */ var lodash_es_uniqBy__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7127);
...
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6500);
/* harmony import */ var scrivito_sdk_state__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2757);
...
function configurePreviewSizes(previewSizes) {
  ...
  if (lodash_es_uniqBy__WEBPACK_IMPORTED_MODULE_0___default()(previewSizes, "width").length !== previewSizes.length) {
...
/* harmony import */ var lodash_es_uniqBy__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash_es_uniqBy__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var scrivito_sdk_app_support_editing_config_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(384);
/* harmony import */ var scrivito_sdk_app_support_get_class_name__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3449);
/* harmony import */ var scrivito_sdk_app_support_validations_config__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8142);
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6500);
/* harmony import */ var scrivito_sdk_data_integration__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(4867);
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(4640);
...
function getAttributeEditingOptionsFor(className, attributeName, attributeType) {
  ...
  if (Object.keys(invalidOptions).length === 0)
    return options;
  (0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .nextTick */ .Y3)(() => throwInvalidOptions(invalidOptions));
}
const { checkProvideEditingConfig, throwInvalidOptions } = (() => {
  ...
  const HtmlToolbarButtonType = scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.enums */ .pC.enums.of([
    "blockquote",
    "bold",
    "bulletList",
    "clean",
    ...
    scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb["interface"] */ .pC["interface"]({
      ...
      options: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.maybe */ .pC.maybe(
        scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb["interface"] */ .pC["interface"]({
          ...
          multiLine: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.maybe */ .pC.maybe(scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .tcomb.Boolean */ .pC.Boolean),
...
function haveGroupsUniqueKey(groups) {
  ...
  return lodash_es_uniqBy__WEBPACK_IMPORTED_MODULE_0___default()(groupsWithKey, "key").length === groupsWithKey.length;
}
...
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6500);
/* harmony import */ var scrivito_sdk_data_integration__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(4867);
/* harmony import */ var scrivito_sdk_link_resolution__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(4399);
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(4640);
...
var external_urijs_ = __webpack_require__(4898);
...
var loadable = __webpack_require__(9340);
// EXTERNAL MODULE: ./scrivito_sdk/models/index.ts + 35 modules
var models = __webpack_require__(4640);
...
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4640);
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  o: () => (/* reexport */ appAdapterDescription),
  a: () => (/* reexport */ uiAdapterDescription)
});
...
const appAdapterDescription = {
  getAdapterSpec: bridge/* GET */.HT,
  getCapabilities: bridge/* GET */.HT,
  getPreviewSizes: bridge/* GET */.HT,
  descriptionForObj: bridge/* GET */.HT,
  getClasses: bridge/* GET */.HT,
  getContentBrowserConfiguration: bridge/* GET */.HT,
  getHomepageId: bridge/* GET */.HT,
  getSiteIdForObj: bridge/* GET */.HT,
  titleForObj: bridge/* GET */.HT,
  titleForWidget: bridge/* GET */.HT,
  thumbnailForObj: bridge/* GET */.HT,
  getAuthGroups: bridge/* GET */.HT,
  getContentZoneData: bridge/* GET */.HT,
  getCurrentAppLocation: bridge/* GET */.HT,
  getCustomComponentDimensions: bridge/* GET */.HT,
  getDocumentTitle: bridge/* GET */.HT,
  getElementBoundaries: bridge/* GET */.HT,
  getExtensionsUrl: bridge/* GET */.HT,
  getMenuPatch: bridge/* GET */.HT,
  getObjClassForContentTypeMapping: bridge/* GET */.HT,
  getResolvedUrl: bridge/* GET */.HT,
  getScrollPosition: bridge/* GET */.HT,
  getValidationReport: bridge/* GET */.HT,
  getUrlFor: bridge/* GET */.HT,
  getForcedEditorLanguage: bridge/* GET */.HT,
  generalPropertiesForObj: bridge/* GET */.HT,
  generalPropertiesForWidget: bridge/* GET */.HT,
  propertiesGroupsForObj: bridge/* GET */.HT,
  propertiesGroupsForWidget: bridge/* GET */.HT,
  wantsLayoutEditing: bridge/* GET */.HT,
  objReplicationMessageStream: bridge/* STREAM */.M,
  executeCustomCommand: bridge/* SEND */.H8,
  initializeContentForObj: bridge/* SEND */.H8,
  initializeContentForWidget: bridge/* SEND */.H8,
  initializeCopy: bridge/* SEND */.H8,
  initializeObjCopy: bridge/* SEND */.H8,
  initializeWidgetCopy: bridge/* SEND */.H8,
  navigateTo: bridge/* SEND */.H8,
  scrollIntoView: bridge/* SEND */.H8,
  scrollToTop: bridge/* SEND */.H8,
  showCustomComponent: bridge/* SEND */.H8,
  showWidgetContent: bridge/* SEND */.H8,
  wantsAutoAttributeConversion: bridge/* GET */.HT
};
...
__webpack_require__.d(__webpack_exports__, {
  ...
  TokenAuthorizationProvider: () => (/* reexport */ TokenAuthorizationProvider),
  VisitorAuthenticationProvider: () => (/* reexport */ VisitorAuthenticationProvider),
  clientConfig: () => (/* reexport */ clientConfig),
  ...
  retryOnRequestFailed: () => (/* reexport */ retryOnRequestFailed),
  setLoggedInIndicatorParam: () => (/* reexport */ setLoggedInIndicatorParam),
...
// UNUSED EXPORTS: MissingWorkspaceError, fetchJson, isComparisonRange, isObjSpaceId, requestBuiltInUserSession, retrieveObjFieldDiffs, useDefaultPriority
...
function getClientVersion() {
  const clientVersion = "jssdk/1.29.0-dev-1-gfd65042ffbcb";
  if (!clientVersion)
    throw new common/* InternalError */.AQ();
...
function fetch_fetch(method, url, { params, authorization, priority }) {
  if (xmlHttpRequest === void 0) {
    return common/* ScrivitoPromise */.s8.resolve({
      status: 432,
...
function loginRedirectHandler(visit) {
  return login_redirect_handler_async(this, null, function* () {
    (0,common/* redirectTo */.gB)(yield authenticationUrl(visit));
...
function resetUserIsLoggedInParam() {
  ...
  return login_redirect_handler_async(this, null, function* () {
    ...
    if (authUrl.includes(JR_API_LOCATION_PLACEHOLDER)) {
      return authUrl.replace(
        ...
        (yield clientConfig.fetch()).jrApiLocation
      );
    }
    return authUrl;
  });
...
// EXTERNAL MODULE: external "lodash-es/isObject"
var isObject_ = __webpack_require__(2232);
...
function isErrorResponse(parsedResponse) {
  if (!isObject_default()(parsedResponse))
    return false;
  const errorType = typeof parsedResponse.error;
  const codeType = typeof parsedResponse.code;
  const details = parsedResponse.details;
  return errorType === "string" && (codeType === "string" || codeType === "undefined") && (isObject_default()(details) || typeof details === "undefined");
}
...
function requestApiIdempotent(request) {
  return retryOnRequestFailed(() => requestApiNonIdempotent(request));
}
function requestApiNonIdempotent(request) {
  return request_api_async(this, null, function* () {
    return parseResponse(yield requestWithRateLimitRetry(request));
  });
}
...
class CmsRestApi {
  ...
  requestBuiltInUserSession(sessionId, idp) {
    return cms_rest_api_async(this, null, function* () {
  ...
  currentPublicAuthorizationState() {
    ...
    if (this.authHeaderValueProvider) {
      if (this.authHeaderValueProvider.currentState) {
        return `[API] ${(_a = this.authHeaderValueProvider.currentState()) != null ? _a : "null"}`;
      }
  ...
  request(_0) {
    return cms_rest_api_async(this, arguments, function* ({
      ...
      const sendRequest = () => this.requestWithAuthorization(
        providedAuthorization === void 0 ? this.getAuthHeaderValueProvider() : providedAuthorization,
      ...
      try {
        return yield withLoginHandler(
          loginHandler,
          () => method === "POST" ? requestApiNonIdempotent(sendRequest) : requestApiIdempotent(sendRequest)
        );
      } catch (error) {
  ...
  requestWithAuthorization(providedAuthorization, request) {
    return cms_rest_api_async(this, null, function* () {
      if (providedAuthorization === null)
        return request();
      return typeof providedAuthorization === "string" ? request(providedAuthorization) : providedAuthorization.authorize(request);
    });
  }
...
var __spreadProps = (a, b) => __defProps(a, __getOwnPropDescs(b));
var api_client_async = (__this, __arguments, generator) => {
  return new Promise((resolve, reject) => {
    var fulfilled = (value) => {
      try {
        step(generator.next(value));
...
class ApiClient {
  ...
  getWithoutLogin(path, options) {
    return this.fetch(path, __spreadProps(__spreadValues({}, options), {
      ...
      loginHandler: () => api_client_async(this, null, function* () {
        return null;
      })
    }));
  }
...
function fetchJson(url, options) {
  return fetch_json_async(this, null, function* () {
    ...
    const plainRequest = (authorization) => fetchWithTimeout(
      url,
      authorization ? fetch_json_spreadProps(fetch_json_spreadValues({}, options), {
        ...
        credentials: "omit"
      }) : fetch_json_spreadProps(fetch_json_spreadValues({}, options), { credentials: "include" })
    );
    ...
    return isIdempotent ? requestApiIdempotent(authorizedRequest) : requestApiNonIdempotent(authorizedRequest);
  });
}
...
function getJrRestApiUrl(path) {
  return jr_rest_api_async(this, null, function* () {
    ...
    return `${(yield clientConfig.fetch()).jrApiLocation}/${sanitizedPath}`;
  });
}
const JrRestApi = new ApiClient(jr_rest_api_fetch);
function jr_rest_api_fetch(path, options) {
  return jr_rest_api_async(this, null, function* () {
    var _a, _b, _c;
    const method = (_b = (_a = options == null ? void 0 : options.method) == null ? void 0 : _a.toUpperCase()) != null ? _b : "GET";
    const config = yield clientConfig.fetch();
    const url = yield calculateRequestUrl(path, options == null ? void 0 : options.params);
    const loginHandler = (_c = options == null ? void 0 : options.loginHandler) != null ? _c : config.loginHandler === "redirect" ? loginRedirectHandler : void 0;
...
class TokenAuthorizationProvider {
  ...
  authorize(request) {
    return token_authorization_provider_async(this, null, function* () {
      ...
      while (true) {
        if (this.cachedToken === void 0) {
          if (fetchedTokenBefore)
            yield backoff.nextDelay();
          this.cachedToken = yield this.fetchToken();
          fetchedTokenBefore = true;
        }
        const response = this.cachedToken === null ? yield request(void 0) : yield request(`Bearer ${this.cachedToken}`);
        if (response.status !== 401)
          return response;
...
// UNUSED EXPORTS: bypassThrottle, cleanUniqueErrorMessage, clearLocalStorage, currentHash, detectUniqueErrorMessage, disableConsoleError, enableUniqueErrors, fetchMaybeTenant, getChildPath, hasTenantConfigurationBeenSet, isConfiguredWithoutTenant, isLocalhostUrl, isUnderscore, resetConfiguredTenant, setNextTickScheduler, setRegisterAsyncTaskHandler, setScrivitoPromise, sliceFromIterable, tryGetConfiguredTenant
...
var flatten_ = __webpack_require__(1383);
...
// EXTERNAL MODULE: external "lodash-es/isElement"
var isElement_ = __webpack_require__(9258);
var isElement_default = /*#__PURE__*/__webpack_require__.n(isElement_);
// EXTERNAL MODULE: external "lodash-es/isObject"
var isObject_ = __webpack_require__(2232);
var isObject_default = /*#__PURE__*/__webpack_require__.n(isObject_);
...
var external_tcomb_validation_ = __webpack_require__(7631);
...
;// CONCATENATED MODULE: ./scrivito_sdk/common/node_env.ts
...
function getScrivitoVersion() {
  const version = "1.29.0-dev-1-gfd65042ffbcb";
  if (!version) {
...
var throttle_ = __webpack_require__(8542);
...
function throttle(fn, ms, options) {
  return shouldBypassThrottle ? fn : throttle_default()(fn, ms, options);
}
...
class ConfigStore {
  ...
  set(config) {
    if (!this.configDeferred.isPending())
      throw new InternalError();
...
var isEmpty_ = __webpack_require__(2750);
...
// EXTERNAL MODULE: ./scrivito_sdk/client/index.ts + 36 modules
var client = __webpack_require__(5478);
// EXTERNAL MODULE: ./scrivito_sdk/common/index.ts + 57 modules
var common = __webpack_require__(6500);
// EXTERNAL MODULE: external "lodash-es/difference"
var difference_ = __webpack_require__(1827);
var difference_default = /*#__PURE__*/__webpack_require__.n(difference_);
// EXTERNAL MODULE: external "lodash-es/isEmpty"
var isEmpty_ = __webpack_require__(2750);
var isEmpty_default = /*#__PURE__*/__webpack_require__.n(isEmpty_);
// EXTERNAL MODULE: external "lodash-es/isEqual"
var isEqual_ = __webpack_require__(1736);
...
function eachKeyFrom(objectA, objectB, handler) {
  ...
  const keysOfAOnly = difference_default()(keysOfA, keysOfB);
...
function buildUpdatedWidgetPool(widgetPool, widgetPoolPatch) {
  if (!widgetPoolPatch || isEmpty_default()(widgetPoolPatch))
    return widgetPool;
...
function buildWidgetPoolPatch(widgetPoolA, widgetPoolB) {
  ...
  eachKeyFrom(widgetPoolA, widgetPoolB || {}, (widgetId, widgetA, widgetB) => {
    const widgetValue = buildPatchEntry(widgetA, widgetB, () => {
      ...
      if (!isEmpty_default()(widgetPatch))
        return widgetPatch;
    });
  ...
  eachKeyFrom(fromJson, toJson, (attribute, valueInA, valueInB) => {
    if (attribute === "_widget_pool") {
      ...
      const patchValue = buildPatchEntry(valueInA, valueInB, () => {
        if (!isEqual_default()(valueInA, valueInB))
          return valueInB;
      });
...
class ObjBackendReplication {
  ...
  finishSaving() {
    ...
    return finishSavingPromise.catch(() => common/* ScrivitoPromise */.s8.reject());
  }
  finishReplicating() {
    throw new common/* InternalError */.AQ();
  }
  ...
  replicateLocalStateToBackend(localState) {
    ...
    return isEmpty_default()(patch) ? (
      ...
      common/* ScrivitoPromise */.s8.resolve(this.backendState)
...
function assertValidDataItemAttributes(attributes) {
  if (!isObject_default()(attributes)) {
...
function handleExternalData(data) {
  ...
  if (isExternalData(data))
    return filterValidDataIdentifiers(data);
  throw new common/* ArgumentError */.ir("External data must be an object or null");
}
function isExternalData(data) {
  return isObject_default()(data) && typeof data !== "function" && !Array.isArray(data);
}
...
function getExternalDataQuery({
  ...
  const idQuery = new data/* IdBatchQuery */.hH(
    (batchNumber) => batchCollection.getBatch(
      ...
      -1,
      // Dummy value for the batch size, since it's ignored anyways
      batchNumber
    )
  );
  return (0,common/* transformContinueIterable */.Sy)(
...
class ExternalDataScope extends DataScope {
  ...
  create(attributes) {
    return external_data_class_async(this, null, function* () {
      ...
      setExternalData(
        dataClassName,
        id,
        !isEmpty_default()(dataFromCallback) && dataFromCallback || dataForCallback
      );
  ...
  getScopeId() {
    const { filters, search } = this._params;
    const hasOnlyIdFilter = filters && Object.keys(filters).length === 1 && filters._id;
...
function findItemInDataStackAndGlobalData(dataClassName, dataStack) {
  return findItemInDataStack(dataClassName, dataStack) || findItemInGlobalData(dataClassName);
}
function findScopeInDataStackAndGlobalData(dataClassName, dataStack) {
  return findInDataStack(dataClassName, dataStack, isDataScopePojo) || findScopeInGlobalData(dataClassName);
}
function findItemInDataStack(dataClassName, dataStack) {
  return findInDataStack(dataClassName, dataStack, isDataItemPojo);
}
function findInDataStack(dataClassName, dataStack, matcher) {
...
function isDataLocatorValueFilter(filter) {
  return isObject_default()(filter) && typeof filter.field === "string" && typeof filter.value === "string";
}
...
function applyDataLocator(dataStack, dataLocator) {
  ...
  if (className === null)
    return new EmptyDataScope();
  return dataLocator.viaRef() ? findMatchingDataScopeOrThrow(className, dataStack) : applyDataLocatorDefinition(className, dataStack, dataLocator);
}
...
function findMatchingDataScopeOrThrow(className, dataStack) {
  const itemElement = findMatchingScopeElementOrThrow(className, dataStack);
  if (isDataScopePojo(itemElement))
    return dataScopeFromPojo(itemElement);
...
function findMatchingScopeElementOrThrow(dataClass, dataStack) {
  if (!dataStack) {
    throw new DataLocatorError(`No ${dataClass} found`);
  }
...
function readAndFilterItem(params, dataClass) {
  return provide_external_data_item_async(this, null, function* () {
    ...
    const doesMatch = Object.keys(filters).every((attributeName) => {
      return attributeName === "_id" || consideredEqual(dataItem.get(attributeName), filters[attributeName]);
    });
...
function replacePlaceholder(identifier, placeholder, placeholders, dataStack) {
...
function replaceLegacyPlaceholder(identifier, placeholder, placeholders) {
...
/* harmony import */ var scrivito_sdk_app_support_ui_adapter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3218);
/* harmony import */ var scrivito_sdk_loadable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9340);



const moduleLoaders = {
  reactEditing: () => __webpack_require__.e(/* import() */ 226).then(__webpack_require__.bind(__webpack_require__, 1622)),
  editingSupport: () => __webpack_require__.e(/* import() */ 226).then(__webpack_require__.bind(__webpack_require__, 8504))
};
...
function resolveHtmlUrl(encodedUrl) {
  ...
  return escape_default()(newUrl.href());
}
...
function runWorker(attributeDataToConvert, objData, attributeName, widgetId) {
  ...
  return (0,loadable/* load */.zD)(convertValue).then((convertedData) => {
    if (isEqual_default()(convertedData, attributeDataToConvert))
      return;
...
class LinkResolution {
  ...
  start(objId) {
    ...
    const combinedPromise = priorPromise ? common/* ScrivitoPromise */.s8.all([priorPromise, promise]).then(() => void 0) : promise;
    this.cache[objId] = combinedPromise;
    notifyLinkResolutionIsActive(combinedPromise);
  }
  finish(objId) {
    return this.cache[objId] || common/* ScrivitoPromise */.s8.resolve();
  }
}
...
function performResolution(objData) {
  ...
  if (!workers.length)
    return;
  const resolution = common/* ScrivitoPromise */.s8.all(workers);
...
// EXTERNAL MODULE: external "lodash-es/once"
var once_ = __webpack_require__(2497);
...
function enqueueFlush(callback) {
  const runCallbackOnce = once_default()(callback);
...
var intersection_ = __webpack_require__(5925);
...
var data_integration = __webpack_require__(4867);
// EXTERNAL MODULE: ./scrivito_sdk/state/index.ts + 13 modules
var state = __webpack_require__(2757);
...
function deserializeMultienumValue(value, typeInfo) {
  if (isBackendValueOfType("stringlist", value)) {
    const [, { values }] = typeInfo;
    return intersection_default()(value[1], values);
  }
  return [];
}
...
var isDate_ = __webpack_require__(6998);
...
var link_resolution = __webpack_require__(4399);
...
function assertValidFacetOptions(options) {
  const invalidOptions = difference_default()(Object.keys(options), VALID_FACET_OPTIONS);
...
function deserializeMetadata(response) {
  ...
  if (!isObject_default()(backendMetadata)) {
    throw new common/* InternalError */.AQ();
  }
  const metadata = {};
...
class Binary {
  ...
  /** @internal */
  equals(binary) {
    return this.id() === binary.id() && (0,common/* equals */.fS)(this._objSpaceId, binary.objSpaceId()) && isEqual_default()(this.definition(), binary.definition());
  }
  /** @internal */
  isImage() {
...
var external_speakingurl_ = __webpack_require__(3579);
...
function serializeMultienumAttributeValue(value, name, { values }) {
  ...
  const forbiddenValues = difference_default()(value, values);
...
function isValidLinkInputValue(value) {
  ...
  if (isEmpty_default()(Object.values(value).filter(Boolean)))
    return false;
  const invalidKeys = difference_default()(
    Object.keys(value),
    ["hash", "obj_id", "query", "rel", "target", "title", "url"]
  );
  return isEmpty_default()(invalidKeys);
}
...
function updateReferencesWithSafeMapping(obj, mapping) {
  return __async(this, null, function* () {
    ...
    if (!workers.length)
      return;
    yield common/* ScrivitoPromise */.s8.all(workers);
  });
}
...
/* harmony import */ var scrivito_sdk_data_integration__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4867);
/* harmony import */ var scrivito_sdk_react_data_context_container__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(349);
/* harmony import */ var scrivito_sdk_react_hooks_use_data_locator__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7907);
/* harmony import */ var scrivito_sdk_react_connect__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8247);
...
const AutomaticDataContext = (0,scrivito_sdk_react_connect__WEBPACK_IMPORTED_MODULE_4__/* .connect */ .$j)(function AutomaticDataContext2({
  content,
  children
}) {
  const dataScope = (0,scrivito_sdk_react_hooks_use_data_locator__WEBPACK_IMPORTED_MODULE_3__/* .useDataLocator */ .$)(content.get("data", "datalocator"));
  if (dataScope instanceof scrivito_sdk_data_integration__WEBPACK_IMPORTED_MODULE_1__/* .EmptyDataScope */ .Vb)
    return children;
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(scrivito_sdk_react_data_context_container__WEBPACK_IMPORTED_MODULE_2__/* .PushOntoDataStack */ .ec, { item: dataScope }, children);
});
...
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6500);
/* harmony import */ var scrivito_sdk_react_component_registry__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(973);
...
/* harmony import */ var scrivito_sdk_react_connect__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8247);
...
/* harmony import */ var scrivito_sdk_react_connect__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8247);
...
function PushOntoDataStack({
  ...
  function computeStackElement() {
    if (item instanceof scrivito_sdk_data_integration__WEBPACK_IMPORTED_MODULE_1__/* .DataItem */ .zw) {
      return {
        _class: item.dataClass().name(),
        _id: item.id()
      };
    }
    return item instanceof scrivito_sdk_data_integration__WEBPACK_IMPORTED_MODULE_1__/* .DataScope */ .Cc ? item.toPojo() : item;
  }
}
...
/* harmony export */ });
/* harmony import */ var scrivito_sdk_data_integration__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4867);
...
var component_registry = __webpack_require__(973);
...
// EXTERNAL MODULE: ./scrivito_sdk/react_connect/index.ts + 6 modules
var react_connect = __webpack_require__(8247);
// EXTERNAL MODULE: ./scrivito_sdk/realm/index.ts + 22 modules
var realm = __webpack_require__(105);
...
function provideComponent(classNameOrClass, component, ...excessArgs) {
  ...
  const connectedComponent = (0,react_connect/* connect */.$j)(component);
...
const ValidScrivitoBackground = common/* tcomb.interface */.pC["interface"]({
  ...
  position: common/* tcomb.maybe */.pC.maybe(common/* tcomb.enums */.pC.enums.of(["center", "left", "right", "top", "bottom"])),
...
var get_comparison_range = __webpack_require__(5369);
// EXTERNAL MODULE: external "lodash-es/escape"
var escape_ = __webpack_require__(9367);
var escape_default = /*#__PURE__*/__webpack_require__.n(escape_);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/browser_location.ts
var browser_location = __webpack_require__(2985);
// EXTERNAL MODULE: external "urijs"
var external_urijs_ = __webpack_require__(4898);
...
function isCustomInnerHtml(maybeCustomInnerHtml) {
  return isObject_default()(maybeCustomInnerHtml) && typeof maybeCustomInnerHtml.__html === "string";
}
...
function getNextPage(page, layoutIndex) {
  ...
  if (path) {
    ...
    const ancestor = (0,loadable/* loadWithDefault */.n4)(
      "loading",
      () => (0,models/* getObjByPath */.nG)((0,current_app_space/* currentAppSpace */.q)(), ancestorPath)
    );
...
var external_react_dom_ = __webpack_require__(831);
...
// UNUSED EXPORTS: ReactConnectContext, forwardElementTypeProps
...
const ReactConnectContext = external_react_.createContext({
  hierarchyLevel: 0
});
class ComponentConnector {
  ...
  render(originalRender) {
    ...
    return /* @__PURE__ */ external_react_.createElement(ReactConnectContext.Consumer, __spreadValues({}, forwardElementTypeProps(reactElement)), (context) => /* @__PURE__ */ external_react_.createElement(
...
var mapValues_ = __webpack_require__(1776);
var mapValues_default = /*#__PURE__*/__webpack_require__.n(mapValues_);
// EXTERNAL MODULE: external "lodash-es/pickBy"
var pickBy_ = __webpack_require__(895);
...
function assertValidPublicAttributes(attributes) {
  const unknownAttrs = difference_default()(Object.keys(attributes), ALLOWED_ATTRIBUTES);
...
const {
  ...
  if (common/* nodeEnv */.rR !== "development") {
    return {
...
module.exports = __WEBPACK_EXTERNAL_MODULE__5119__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__4431__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__1827__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__9367__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__5287__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__7754__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__5925__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__6998__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__9258__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__2750__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__1736__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__2232__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__1776__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__9548__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__8542__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__2009__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__7127__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__9849__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__831__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__3579__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__4898__;
...
var document_title = __webpack_require__(9260);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/editing_context.ts
var editing_context = __webpack_require__(6993);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/content_tags_for_empty_attributes.ts
var content_tags_for_empty_attributes = __webpack_require__(9754);
...
function initializeLoggedInState() {
  (0,client.setLoggedInIndicatorParam)(USER_IS_LOGGED_IN_PARAM_NAME);
  const url = new URL((0,common/* currentHref */.RO)());
...
const loadableUserInfo = new loadable/* LoadableData */.of({
  loader: () => user_info_async(void 0, null, function* () {
    return client.JrRestApi.getWithoutLogin(yield getUserInfoPath());
  })
});
...
function stopPollingLoggedUser() {
  if (userLoggedInStatusInterval)
...
const insideUiAuthHandler = {
  ...
  iamAuthProvider() {
    return new client.TokenAuthorizationProvider(
      () => inside_ui_auth_handler_async(this, null, function* () {
        return (0,common/* assumePresence */.VV)(yield (0,loadable/* load */.zD)(() => {
          var _a;
...
function verifyUserIsLoggedIn() {
  return logged_in_visitor_auth_handler_async(this, null, function* () {
    const user = yield common/* ScrivitoPromise */.s8.race([
...
;// CONCATENATED MODULE: ./scrivito_sdk/app_support/default_cms_endpoint.ts





const DEFAULT_CMS_ENDPOINT = "api.scrivito.com";
function getDefaultCmsEndpoint({
  configuredJrRestApiEndpoint,
  configuredEndpoint
}) {
  return withEnsuredProtocol(
    isRunningInBrowser() && isUserLoggedIn() ? (configuredJrRestApiEndpoint || getJrRestApiDefaultEndpoint()) + "/scrivito" : configuredEndpoint || DEFAULT_CMS_ENDPOINT
  );
}
function withEnsuredProtocol(cmsEndpoint) {
  return cmsEndpoint.startsWith("http") ? cmsEndpoint : `https://${cmsEndpoint}`;
}
function getJrRestApiDefaultEndpoint() {
...
function importEditors() {
  return __webpack_require__.e(/* import() */ 226).then(__webpack_require__.bind(__webpack_require__, 1029));
}
...
function configure(configuration, ...excessArgs) {
  ...
  if (configuration.tenant === data/* IN_MEMORY_TENANT */.kI) {
    ...
    client.clientConfig.set({
      jrApiLocation: configuration.jrRestApiEndpoint || getJrRestApiDefaultEndpoint(),
...
function getCmsAuthProvider(apiKey, visitorAuthentication) {
  ...
  return getVisitorAuthenticationProvider(visitorAuthentication) || client.PublicAuthentication;
}
...
function importUiInterface() {
  return __webpack_require__.e(/* import() */ 226).then(__webpack_require__.bind(__webpack_require__, 8248));
}
...
function checkIfTrustedOrigin(origin) {
  if (origin === window.location.origin)
    return common/* ScrivitoPromise */.s8.resolve(true);
...
function getLocalOrigins() {
  var _a, _b;
  return (_b = (_a = (0,common/* getFromLocalStorage */.fp)("SCRIVITO_TRUSTED_UI_ORIGINS")) == null ? void 0 : _a.split(" ")) != null ? _b : [];
}

// EXTERNAL MODULE: ./scrivito_sdk/app_ui_protocol/index.ts + 2 modules
var app_ui_protocol = __webpack_require__(5388);
...
function establishUiConnection(uiWindow) {
  ...
  return (0,bridge/* createAdapterClient */.hb)(
    app_ui_protocol/* uiAdapterDescription */.a,
...
function loadEditingSupport() {
  return load_editing_support_async(this, null, function* () {
    ...
    return __webpack_require__.e(/* import() */ 226).then(__webpack_require__.bind(__webpack_require__, 8504));
  });
}
...
function initializeSdk() {
  ...
  initializeAssetUrlBase();
  (0,common/* setOriginProvider */.kx)(common/* windowLocationOrigin */.k9);
...
var react = __webpack_require__(2702);
// EXTERNAL MODULE: ./scrivito_sdk/react_connect/index.ts + 6 modules
var react_connect = __webpack_require__(8247);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/can_edit.ts
var can_edit = __webpack_require__(8083);
...
function provideDataItem(name, connectionOrGet, ...excessArgs) {
  if (typeof connectionOrGet === "function") {
    return provideDataItem(name, { get: connectionOrGet }, ...excessArgs);
  }
  (0,realm/* checkProvideDataItem */.yj)(name, connectionOrGet, ...excessArgs);
  (0,data_integration/* assertValidDataIdentifier */.kn)(name);

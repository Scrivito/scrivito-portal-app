(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("@justrelate/slugify"), require("history"), require("lodash-es/debounce"), require("lodash-es/escape"), require("lodash-es/isDate"), require("lodash-es/isEmpty"), require("lodash-es/isEqual"), require("lodash-es/mapValues"), require("lodash-es/memoize"), require("lodash-es/merge"), require("lodash-es/sortBy"), require("lodash-es/unescape"), require("lodash-es/upperFirst"), require("react"), require("react-dom"), require("react/jsx-runtime"));
	else if(typeof define === 'function' && define.amd)
		define(["@justrelate/slugify", "history", "lodash-es/debounce", "lodash-es/escape", "lodash-es/isDate", "lodash-es/isEmpty", "lodash-es/isEqual", "lodash-es/mapValues", "lodash-es/memoize", "lodash-es/merge", "lodash-es/sortBy", "lodash-es/unescape", "lodash-es/upperFirst", "react", "react-dom", "react/jsx-runtime"], factory);
	else if(typeof exports === 'object')
		exports["scrivito"] = factory(require("@justrelate/slugify"), require("history"), require("lodash-es/debounce"), require("lodash-es/escape"), require("lodash-es/isDate"), require("lodash-es/isEmpty"), require("lodash-es/isEqual"), require("lodash-es/mapValues"), require("lodash-es/memoize"), require("lodash-es/merge"), require("lodash-es/sortBy"), require("lodash-es/unescape"), require("lodash-es/upperFirst"), require("react"), require("react-dom"), require("react/jsx-runtime"));
	else
		root["scrivito"] = factory(root["@justrelate/slugify"], root["history"], root["lodash-es/debounce"], root["lodash-es/escape"], root["lodash-es/isDate"], root["lodash-es/isEmpty"], root["lodash-es/isEqual"], root["lodash-es/mapValues"], root["lodash-es/memoize"], root["lodash-es/merge"], root["lodash-es/sortBy"], root["lodash-es/unescape"], root["lodash-es/upperFirst"], root["react"], root["react-dom"], root["react/jsx-runtime"]);
})((typeof self !== 'undefined' ? self : global), (__WEBPACK_EXTERNAL_MODULE__5929__, __WEBPACK_EXTERNAL_MODULE__9226__, __WEBPACK_EXTERNAL_MODULE__16__, __WEBPACK_EXTERNAL_MODULE__3444__, __WEBPACK_EXTERNAL_MODULE__8307__, __WEBPACK_EXTERNAL_MODULE__5020__, __WEBPACK_EXTERNAL_MODULE__9477__, __WEBPACK_EXTERNAL_MODULE__7885__, __WEBPACK_EXTERNAL_MODULE__721__, __WEBPACK_EXTERNAL_MODULE__2925__, __WEBPACK_EXTERNAL_MODULE__5682__, __WEBPACK_EXTERNAL_MODULE__3655__, __WEBPACK_EXTERNAL_MODULE__5769__, __WEBPACK_EXTERNAL_MODULE__629__, __WEBPACK_EXTERNAL_MODULE__400__, __WEBPACK_EXTERNAL_MODULE__2198__) => {
...
/* harmony export */ });
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6687);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   KO: () => (/* binding */ assetLoadingReady),
/* harmony export */   Pu: () => (/* binding */ initializeAssetUrlBase),
/* harmony export */   Tq: () => (/* binding */ getAssetUrlBase),
/* harmony export */   zS: () => (/* binding */ configureAssetUrlBase)
/* harmony export */ });
/* unused harmony export resetAssetUrlBase */
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6687);
...
const config = new scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_0__/* .ConfigStore */ .s9();
...
(0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_0__/* .onReset */ .Nj)(resetAssetUrlBase);
...
/* harmony export */ });
/* harmony import */ var scrivito_sdk_state__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6324);
...
/* harmony export */ });
/* harmony import */ var scrivito_sdk_app_support_browser_location__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4599);
/* harmony import */ var scrivito_sdk_app_support_change_location__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2183);
/* harmony import */ var scrivito_sdk_app_support_destination_types__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7619);
/* harmony import */ var scrivito_sdk_app_support_routing__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1446);
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6687);
/* harmony import */ var scrivito_sdk_loadable__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(6084);
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(5436);
/* harmony import */ var scrivito_sdk_realm__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(687);
/* harmony import */ var scrivito_sdk_state__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(6324);
...
function destinationForUrl(url) {
  ...
  if ((0,scrivito_sdk_app_support_routing__WEBPACK_IMPORTED_MODULE_3__/* .isOriginLocal */ .Im)(url)) {
    ...
    return {
      type: "local",
      resource: (0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .toUrlResource */ .B6)(new URL(url))
    };
  }
...
/* harmony export */ });
/* harmony import */ var scrivito_sdk_app_support_routing__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1446);
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6687);
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5436);
/* harmony import */ var scrivito_sdk_realm__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(687);
...
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6687);
/* harmony import */ var scrivito_sdk_state__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6324);
...
function get() {
  return (0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__/* .toUrlResource */ .B6)(getHistory().location);
}
...
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6687);
/* harmony import */ var scrivito_sdk_loadable__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6084);
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5436);
/* harmony import */ var scrivito_sdk_realm__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(687);
...
/* harmony import */ var scrivito_sdk_app_support_ui_adapter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1391);
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6687);
/* harmony import */ var _routing__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1446);
...
__webpack_require__.d(__webpack_exports__, {
  ...
  r$: () => (/* binding */ getConfiguredInstanceId),
  qu: () => (/* binding */ tryGetConfiguration)
});

// UNUSED EXPORTS: importUiInterface, resetConfiguration, setConfiguration

// EXTERNAL MODULE: ./scrivito_sdk/app_support/browser_location.ts
var browser_location = __webpack_require__(4599);
// EXTERNAL MODULE: ./scrivito_sdk/common/index.ts + 65 modules
var common = __webpack_require__(6687);
;// ./scrivito_sdk/app_support/analytics_provider.ts
...
// EXTERNAL MODULE: ./scrivito_sdk/app_support/asset_url_base.ts
var asset_url_base = __webpack_require__(9191);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/content_tags_for_empty_attributes.ts
var content_tags_for_empty_attributes = __webpack_require__(7334);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/current_app_space.ts
var current_app_space = __webpack_require__(2945);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/current_page.ts
var current_page = __webpack_require__(5396);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/current_user.ts + 5 modules
var current_user = __webpack_require__(3225);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/extensions_url.ts
var extensions_url = __webpack_require__(5089);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/forced_editor_language.ts
var forced_editor_language = __webpack_require__(7531);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/initial_content_dump_url.ts
var initial_content_dump_url = __webpack_require__(7558);
;// ./scrivito_sdk/app_support/load_editing_assets.ts
...
function loadEditingCss() {
  (0,common/* loadCss */.qg)(`${(0,asset_url_base/* getAssetUrlBase */.Tq)()}/scrivito_editing.css`, (0,common/* getDocument */.YE)());
}
function importEditors() {
  return __webpack_require__.e(/* import() */ 723).then(__webpack_require__.bind(__webpack_require__, 7363));
}

// EXTERNAL MODULE: ./scrivito_sdk/app_support/logged_in_state.ts
var logged_in_state = __webpack_require__(8895);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/node_adapter.ts
var node_adapter = __webpack_require__(8001);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/responsive_breakpoints.ts
var responsive_breakpoints = __webpack_require__(1624);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/routing.ts + 2 modules
var routing = __webpack_require__(1446);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/treat_localhost_like.ts
var treat_localhost_like = __webpack_require__(5597);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/ui_adapter.ts
var ui_adapter = __webpack_require__(1391);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/unstable_multi_site_mode.ts
var unstable_multi_site_mode = __webpack_require__(6875);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/visitor_authentication.ts
var visitor_authentication = __webpack_require__(1522);
// EXTERNAL MODULE: ./scrivito_sdk/client/index.ts + 40 modules
var client = __webpack_require__(9421);
// EXTERNAL MODULE: ./scrivito_sdk/data/index.ts + 35 modules
var data = __webpack_require__(9180);
// EXTERNAL MODULE: ./scrivito_sdk/data_integration/index.ts + 40 modules
var data_integration = __webpack_require__(1871);
// EXTERNAL MODULE: ./scrivito_sdk/loadable/index.ts + 28 modules
var loadable = __webpack_require__(6084);
// EXTERNAL MODULE: ./scrivito_sdk/models/index.ts + 42 modules
var models = __webpack_require__(5436);
// EXTERNAL MODULE: ./scrivito_sdk/realm/index.ts + 21 modules
var realm = __webpack_require__(687);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/constraints_validation_callback.ts
var constraints_validation_callback = __webpack_require__(6693);
;// ./scrivito_sdk/app_support/configure.ts
...
function configure(configuration) {
  ...
  if (instanceId === data/* IN_MEMORY_TENANT */.hQ) {
    (0,data/* useInMemoryTenant */.mG)();
    (0,realm/* setCurrentSiteIdHandler */.kI)(() => data/* IN_MEMORY_TENANT */.hQ);
    (0,data/* disableObjReplication */.k0)();
  } else {
    (0,common/* setConfiguredTenant */.rK)(instanceId);
    if ((0,node_adapter/* isRunningInBrowser */.HF)()) (0,logged_in_state/* initializeLoggedInState */.BL)();
    (0,asset_url_base/* configureAssetUrlBase */.zS)(
    ...
    client/* clientConfig */.yO.set({
      ...
      iamTokenFetcher: (0,current_user/* getIamTokenFetcher */.iM)(),
      loginHandler: (0,current_user/* getLoginHandler */.aO)()
    });
    ...
    if (ui_adapter/* uiAdapter */.B) {
      configureWithUi(instanceId, ui_adapter/* uiAdapter */.B);
    } else {
  ...
  if (configuration.responsiveBreakpoints) {
    (0,responsive_breakpoints/* configureResponsiveBreakpoints */.$)(configuration.responsiveBreakpoints);
  }
  ...
  if (unofficialConfiguration == null ? void 0 : unofficialConfiguration.enforceBoundedQueries) {
    (0,models/* enforceBoundedQueries */.gy)();
  }
...
function resetConfiguration() {
  ...
  currentConfiguration = void 0;
  client/* clientConfig */.yO.reset();
}
function checkConfigure(configuration) {
  if (!(configuration && typeof configuration == "object" && getConfiguredInstanceId(configuration))) {
    throwInvalidConfigurationError(
      "The param 'tenant' or 'instanceId' is required."
    );
  }
  if (configuration.apiKey && (0,node_adapter/* isRunningInBrowser */.HF)()) {
    throwInvalidConfigurationError(
...
function configureCmsRestApi({
  ...
  client/* cmsRestApi */.gd.init({
    ...
    analyticsProvider: (0,node_adapter/* isRunningInBrowser */.HF)() ? browserAnalyticsProvider : nodeAnalyticsProvider,
    priority
  });
}
function getCmsAuthProvider(apiKey, visitorAuthentication) {
  if (node_adapter/* nodeAdapter */.y6 && apiKey) {
    return new node_adapter/* nodeAdapter */.y6.ApiKeyAuthorizationProvider(apiKey);
  }
  if ((0,node_adapter/* isRunningInBrowser */.HF)() && (0,current_user/* isUserLoggedIn */.x3)()) {
    return (0,client/* getTokenProvider */.R)({ audience: "https://api.justrelate.com" });
  }
  return (0,visitor_authentication/* getVisitorAuthenticationProvider */.mR)(visitorAuthentication);
}
...
function importUiInterface() {
  return __webpack_require__.e(/* import() */ 723).then(__webpack_require__.bind(__webpack_require__, 7440));
}
...
function getConfiguredInstanceId(configuration) {
  return "tenant" in configuration && typeof configuration.tenant === "string" ? configuration.tenant : configuration.instanceId;
}
...
/* harmony import */ var scrivito_sdk_app_support_absolute_url__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5614);
/* harmony import */ var scrivito_sdk_app_support_ui_adapter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1391);
/* harmony import */ var scrivito_sdk_app_support_ui_adapter_compatible_value__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1702);
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6687);
...
/* harmony export */ });
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6687);
/* harmony import */ var scrivito_sdk_state__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6324);
...
/* harmony export */ });
/* harmony import */ var scrivito_sdk_app_support_editing_context__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1457);
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5436);
...
/* harmony export */ });
/* harmony import */ var scrivito_sdk_app_support_current_page_data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(671);
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6687);
/* harmony import */ var scrivito_sdk_data__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9180);
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5436);
/* harmony import */ var scrivito_sdk_realm__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(687);
/* harmony import */ var scrivito_sdk_state__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(6324);
...
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6687);
/* harmony import */ var scrivito_sdk_loadable__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6084);
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5436);
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  Ny: () => (/* binding */ currentUser),
  z5: () => (/* binding */ ensureUserIsLoggedIn),
  iM: () => (/* binding */ getIamTokenFetcher),
  aO: () => (/* binding */ getLoginHandler),
  x3: () => (/* binding */ isUserLoggedIn),
  ri: () => (/* binding */ logout)
});
...
// EXTERNAL MODULE: ./scrivito_sdk/loadable/index.ts + 28 modules
var loadable = __webpack_require__(6084);
;// ./scrivito_sdk/app_support/user_info.ts
...
;// ./scrivito_sdk/app_support/user_logged_in_status.ts
...
;// ./scrivito_sdk/app_support/anonymous_visitor_auth_handler.ts
...
function ensureUserIsLoggedInAsync(params) {
  return anonymous_visitor_auth_handler_async(this, null, function* () {
    ...
    (0,logged_in_state/* changeLoggedInState */.bb)(true);
  });
}

// EXTERNAL MODULE: ./scrivito_sdk/app_support/get_editor_auth_token.ts
var get_editor_auth_token = __webpack_require__(9984);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/ui_adapter.ts
var ui_adapter = __webpack_require__(1391);
;// ./scrivito_sdk/app_support/inside_ui_auth_handler.ts
...
// EXTERNAL MODULE: ./scrivito_sdk/app_support/offline_mode.ts
var offline_mode = __webpack_require__(1226);
;// ./scrivito_sdk/app_support/logged_in_visitor_auth_handler.ts
...
const loggedInVisitorAuthHandler = {
  ...
  isUserLoggedIn() {
    ...
    if (!(0,offline_mode/* getOfflineMode */.j1)()) startPollingLoggedInUser();
    return true;
  },
  ensureUserIsLoggedIn() {
  },
...
function verifyUserIsLoggedIn() {
  return logged_in_visitor_auth_handler_async(this, null, function* () {
    ...
    if (!user) (0,logged_in_state/* changeLoggedInState */.bb)(false);
  });
}
...
var user = __webpack_require__(7842);
;// ./scrivito_sdk/app_support/current_user.ts
...
function authHandler() {
  if (node_adapter/* nodeAdapter */.y6) return node_adapter/* nodeAdapter */.y6.nodeAuthHandler;
  if (ui_adapter/* uiAdapter */.B) return insideUiAuthHandler;
  if ((0,logged_in_state/* isInLoggedInState */.Ar)()) return loggedInVisitorAuthHandler;
...
function recognizeDestinationUnavailable(fallbackUri) {
  ...
  if (fallbackHash.indexOf(scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_0__/* .DESTINATION_UNAVAILABLE_PREFIX */ .l9) === 0) {
    const encodedParams = fallbackHash.substr(
      scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_0__/* .DESTINATION_UNAVAILABLE_PREFIX */ .l9.length
    );
...
function getDestinationUnavailableFallbackUrl({
  ...
  return `${scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_0__/* .DESTINATION_UNAVAILABLE_PREFIX */ .l9}${objId}${search}${hash || ""}`;
}
...
/* harmony export */ });
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6687);
/* harmony import */ var scrivito_sdk_data_integration__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1871);
/* harmony import */ var scrivito_sdk_realm__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(687);
...
function getClassName(subject) {
  ...
  if (subject instanceof scrivito_sdk_data_integration__WEBPACK_IMPORTED_MODULE_1__/* .DataClass */ .bA) {
    ...
    if (!name) throw new scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_0__/* .ArgumentError */ .c1("Anonymous data classes have no name");
    return name;
  }
...
/* harmony export */ });
/* harmony import */ var scrivito_sdk_app_support_navigation_state__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2993);
/* harmony import */ var scrivito_sdk_loadable__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6084);
...
/* harmony export */ });
/* harmony import */ var scrivito_sdk_app_support_basic_url_for__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8549);
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6687);
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5436);
...
/* harmony export */ });
/* harmony import */ var scrivito_sdk_app_support_treat_localhost_like__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5597);
/* harmony import */ var scrivito_sdk_app_support_ui_adapter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1391);
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6687);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   z: () => (/* binding */ getInstanceId)
/* harmony export */ });
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6687);


function getInstanceId() {
  const configuredTenant = (0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_0__/* .tryGetConfiguredTenant */ .YY)();
...
/* harmony import */ var scrivito_sdk_app_support_editing_config_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4644);
/* harmony import */ var scrivito_sdk_app_support_present_ui_adapter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6051);
/* harmony import */ var scrivito_sdk_loadable__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6084);
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5436);
/* harmony import */ var scrivito_sdk_realm__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(687);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Ar: () => (/* binding */ isInLoggedInState),
/* harmony export */   BL: () => (/* binding */ initializeLoggedInState),
/* harmony export */   bb: () => (/* binding */ changeLoggedInState)
/* harmony export */ });
/* harmony import */ var scrivito_sdk_app_support_ui_adapter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1391);
/* harmony import */ var scrivito_sdk_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9421);
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6687);
...
function initializeLoggedInState() {
  (0,scrivito_sdk_client__WEBPACK_IMPORTED_MODULE_1__/* .setLoggedInIndicatorParam */ .If)(USER_IS_LOGGED_IN_PARAM_NAME);
  const url = new URL((0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .currentHref */ .pb)());
  ...
  if (searchParams.has(USER_IS_LOGGED_IN_PARAM_NAME)) {
    ...
    (0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .replaceHistoryState */ .G$)({}, "", url.toString());
    return;
  }
...
function isInLoggedInState() {
  if (loggedInState === void 0) {
    throw new scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .ScrivitoError */ .aS("not configured");
  }
...
function changeLoggedInState(state) {
  ...
  (0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .reload */ .yQ)();
}
...
function isUserLoggedInStorageKey() {
  return `SCRIVITO.${(0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .getConfiguredTenant */ .Ly)()}.IS_USER_LOGGED_IN`;
}
(0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .onReset */ .Nj)(() => loggedInState = void 0);
...
var state = __webpack_require__(6324);
;// ./scrivito_sdk/app_support/menu/menu_handler_builder.ts
...
var absolute_url = __webpack_require__(5614);
;// ./scrivito_sdk/app_support/menu/menu_patch_builder.ts
...
var menu_registry = __webpack_require__(8214);
;// ./scrivito_sdk/app_support/menu.ts
...
/* harmony import */ var lodash_es_isEmpty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5020);
/* harmony import */ var lodash_es_isEmpty__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash_es_isEmpty__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var scrivito_sdk_app_support_basic_navigate_to__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3221);
/* harmony import */ var scrivito_sdk_app_support_current_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5396);
/* harmony import */ var scrivito_sdk_app_support_get_details_page_url__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6802);
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6687);
/* harmony import */ var scrivito_sdk_data_integration__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(1871);
/* harmony import */ var scrivito_sdk_loadable__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(6084);
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(5436);
/* harmony import */ var scrivito_sdk_realm__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(687);
/* harmony import */ var scrivito_sdk_state__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(6324);
...
/* harmony import */ var scrivito_sdk_app_support_basic_navigate_to__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3221);
/* harmony import */ var scrivito_sdk_app_support_browser_location__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4599);
/* harmony import */ var scrivito_sdk_app_support_change_location__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2183);
/* harmony import */ var scrivito_sdk_app_support_current_app_space__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2945);
/* harmony import */ var scrivito_sdk_app_support_routing__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1446);
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(6687);
/* harmony import */ var scrivito_sdk_loadable__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(6084);
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(5436);
/* harmony import */ var scrivito_sdk_realm__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(687);
...
function recognizeLocation(location) {
  ...
  if ((0,scrivito_sdk_realm__WEBPACK_IMPORTED_MODULE_8__/* .isBinaryBasicObj */ .Xg)(obj)) {
    return (_b = (_a = obj.blob()) == null ? void 0 : _a.url()) != null ? _b : __spreadProps(__spreadValues({}, route), { objId: void 0 });
  }
  return route;
}
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   HF: () => (/* binding */ isRunningInBrowser),
/* harmony export */   y6: () => (/* binding */ nodeAdapter)
/* harmony export */ });
/* unused harmony export setNodeAdapter */
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6687);
...
(0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_0__/* .onReset */ .Nj)(() => nodeAdapter = void 0);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   C1: () => (/* binding */ deleteOfflineStore),
/* harmony export */   Dk: () => (/* binding */ enterOfflineMode),
/* harmony export */   gV: () => (/* binding */ leaveOfflineMode),
/* harmony export */   j1: () => (/* binding */ getOfflineMode),
/* harmony export */   pM: () => (/* binding */ initOfflineMode),
/* harmony export */   uX: () => (/* binding */ isInOfflineMode)
/* harmony export */ });
/* unused harmony export resetOfflineMode */
/* harmony import */ var scrivito_sdk_app_support_configure__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2469);
/* harmony import */ var scrivito_sdk_app_support_node_adapter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8001);
/* harmony import */ var scrivito_sdk_app_support_ui_adapter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1391);
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6687);
/* harmony import */ var scrivito_sdk_loadable__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6084);
...
function initOfflineMode() {
  (0,scrivito_sdk_loadable__WEBPACK_IMPORTED_MODULE_4__/* .setOfflineMode */ .XR)(
    (() => __async(null, null, function* () {
      return determineOfflineMode(yield (0,scrivito_sdk_app_support_configure__WEBPACK_IMPORTED_MODULE_0__/* .getConfiguration */ .D0)());
    }))()
  );
}
function enterOfflineMode() {
  if (!isInOfflineMode()) {
    if (!(0,scrivito_sdk_loadable__WEBPACK_IMPORTED_MODULE_4__/* .isOfflineStoreEnabled */ .Em)()) {
      throw new scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_3__/* .ScrivitoError */ .aS(
...
function waitUntilWritingFinishedAndReload() {
  return __async(this, null, function* () {
    yield (0,scrivito_sdk_loadable__WEBPACK_IMPORTED_MODULE_4__/* .waitUntilWritingFinished */ .mn)();
    (0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_3__/* .reload */ .yQ)();
  });
}
...
function deleteOfflineStore() {
  return __async(this, null, function* () {
    if (isInOfflineMode()) {
      throw new scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_3__/* .ScrivitoError */ .aS("Cannot delete the offline store in offline mode");
    }
    return (0,scrivito_sdk_loadable__WEBPACK_IMPORTED_MODULE_4__/* .deleteOfflineStoreCaches */ .$t)();
  });
}
...
function calculateOfflineMode(config) {
  ...
  if (!!scrivito_sdk_app_support_ui_adapter__WEBPACK_IMPORTED_MODULE_2__/* .uiAdapter */ .B || !(0,scrivito_sdk_app_support_node_adapter__WEBPACK_IMPORTED_MODULE_1__/* .isRunningInBrowser */ .HF)()) return false;
...
function getOfflineModeStorageKey() {
  return `SCRIVITO.${(0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_3__/* .getConfiguredTenant */ .Ly)()}.OFFLINE_MODE`;
}
(0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_3__/* .onReset */ .Nj)(resetOfflineMode);
...
/* harmony export */ });
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6687);
/* harmony import */ var _ui_adapter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1391);
...
function configurePreviewSizes(previewSizes) {
  ...
  if (!previewSizes.every(
    (size) => typeof size.title === "string" && size.title.length > 0
  )) {
    throw new scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_0__/* .ArgumentError */ .c1("Each preview size must have a non-empty title");
  }
  const numericWidths = previewSizes.map(({ width }) => width).filter((width) => typeof width === "number");
...
function validatePreviewSizeWidth(previewSize) {
  ...
  if (width === null || width === void 0) return true;
  return (0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_0__/* .isValidInteger */ .zh)(width) && width > 0;
}
function getPreviewSizes() {
  return state.get();
}
function normalizePreviewSize(input) {
  return input.width === null ? __spreadProps(__spreadValues({}, input), { width: void 0 }) : input;
}
...
/* harmony export */ });
/* harmony import */ var scrivito_sdk_app_support_editing_config_store__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4644);
/* harmony import */ var scrivito_sdk_app_support_get_class_name__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7886);
...
function getAttributeEditingOptionsFor(className, attributeName, attributeType) {
  ...
  if (!(attribute == null ? void 0 : attribute.options)) return;
  let invalidOptions = attribute.options;
  if (attribute.editor === "colorPicker") {
    const _b = attribute.options, { allowAlpha } = _b, rest = __objRest(_b, ["allowAlpha"]);
    invalidOptions = rest;
  } else if (attribute.editor === "dimensionPicker") {
    const _c = attribute.options, { units } = _c, rest = __objRest(_c, ["units"]);
    invalidOptions = rest;
  } else if (attributeType === "html") {
    const _d = attribute.options, { allowedTags, showHtmlSource, toolbar } = _d, rest = __objRest(_d, ["allowedTags", "showHtmlSource", "toolbar"]);
    invalidOptions = rest;
  } else if (attributeType === "string") {
    const _e = attribute.options, { multiLine } = _e, rest = __objRest(_e, ["multiLine"]);
    invalidOptions = rest;
  }
...
/* harmony export */ });
/* harmony import */ var scrivito_sdk_app_support_basic_url_for__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8549);
/* harmony import */ var scrivito_sdk_app_support_current_app_space__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2945);
/* harmony import */ var scrivito_sdk_app_support_routing__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1446);
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6687);
/* harmony import */ var scrivito_sdk_data_integration__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1871);
/* harmony import */ var scrivito_sdk_link_resolution__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(5924);
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(5436);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   $: () => (/* binding */ configureResponsiveBreakpoints),
/* harmony export */   P: () => (/* binding */ getResponsiveBreakpoints)
/* harmony export */ });
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6687);
/* harmony import */ var scrivito_sdk_state__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6324);
...
const state = (0,scrivito_sdk_state__WEBPACK_IMPORTED_MODULE_1__/* .createStateContainer */ .Ld)();
function configureResponsiveBreakpoints(breakpoints) {
...
function isValidPositiveInteger(value) {
  return (0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_0__/* .isValidInteger */ .zh)(value) && value > 0;
}
...
var current_page_data = __webpack_require__(671);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/destination_types.ts
var destination_types = __webpack_require__(7619);
// EXTERNAL MODULE: ./scrivito_sdk/common/index.ts + 65 modules
var common = __webpack_require__(6687);
// EXTERNAL MODULE: ./scrivito_sdk/data/index.ts + 35 modules
var data = __webpack_require__(9180);
...
// EXTERNAL MODULE: ./scrivito_sdk/models/index.ts + 42 modules
var models = __webpack_require__(5436);
;// ./scrivito_sdk/app_support/permalink_cache.ts
...
var homepage_callback = __webpack_require__(6974);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/current_app_space.ts
var current_app_space = __webpack_require__(2945);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/unstable_multi_site_mode.ts
var unstable_multi_site_mode = __webpack_require__(6875);
// EXTERNAL MODULE: ./scrivito_sdk/realm/index.ts + 21 modules
var realm = __webpack_require__(687);
;// ./scrivito_sdk/app_support/routing_path.ts
...
var site_mapping = __webpack_require__(9403);
;// ./scrivito_sdk/app_support/routing.ts
...
function generateDestination(options) {
  ...
  return (currentRoute == null ? void 0 : currentRoute.sitePath) || url.origin === (0,common/* currentOrigin */.u4)() ? { type: "local", resource: (0,common/* toUrlResource */.B6)(url) } : { type: "crossSite", url: url.href };
}
...
function generateDestinationForId(options) {
  ...
  return currentRoute.sitePath || url.origin === (0,common/* currentOrigin */.u4)() ? { type: "local", resource: (0,common/* toUrlResource */.B6)(url) } : { type: "crossSite", url: url.href };
}
...
function isOriginLocal(url) {
  ...
  return !parsedUrl || parsedUrl.origin === (0,common/* currentOrigin */.u4)();
}
...
/* harmony export */ });
/* harmony import */ var scrivito_sdk_app_support_current_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5396);
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6687);
...
/* harmony export */ });
/* harmony import */ var scrivito_sdk_app_support_get_current_page_id__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5553);
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6687);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   LQ: () => (/* binding */ setVisitorIdToken),
/* harmony export */   ip: () => (/* binding */ isVisitorAuthenticationEnabled),
/* harmony export */   mR: () => (/* binding */ getVisitorAuthenticationProvider)
/* harmony export */ });
/* unused harmony export resetVisitorAuthentication */
/* harmony import */ var scrivito_sdk_app_support_ui_adapter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1391);
/* harmony import */ var scrivito_sdk_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9421);
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6687);
...
function getVisitorAuthenticationProvider(visitorAuthentication) {
  if (!scrivito_sdk_app_support_ui_adapter__WEBPACK_IMPORTED_MODULE_0__/* .uiAdapter */ .B && visitorAuthentication) {
    return enableVisitorAuthentication();
  }
}
function enableVisitorAuthentication() {
  provider = new scrivito_sdk_client__WEBPACK_IMPORTED_MODULE_1__/* .VisitorAuthenticationProvider */ .gz();
  const timeoutId = (0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .setTimeout */ .wg)(() => {
    throw new scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .ScrivitoError */ .aS(
      `Scrivito.setVisitorIdToken was not called within 30 seconds. Visit ${(0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .docUrl */ .yJ)(DOC_LINK)} for more information.`
    );
  }, 3e4);
...
function setVisitorIdToken(token) {
  ...
  if (!provider) {
    throw new scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .ScrivitoError */ .aS(
      `Scrivito needs to be configured to use visitor authentication before Scrivito.setVisitorIdToken can be called. Visit ${(0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .docUrl */ .yJ)("js-sdk/configure")} and ${(0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .docUrl */ .yJ)(DOC_LINK)} for more information.`
    );
  }
...
(0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .onReset */ .Nj)(resetVisitorAuthentication);
...
;// ./scrivito_sdk/app_ui_protocol/app_adapter_description.ts


const FORCED_EDITOR_LANGUAGES = (/* unused pure expression or super */ null && ([
  "en",
  "de",
  "fr"
]));
const appAdapterDescription = {
  ...
  getResponsiveBreakpoints: bridge/* GET */.fG,
...
;// ./scrivito_sdk/app_ui_protocol/selected_obj_message.ts
...
;// ./scrivito_sdk/app_ui_protocol/general_group_key.ts

const GENERAL_GROUP_KEY = "scrivito.general";

;// ./scrivito_sdk/app_ui_protocol/index.ts
...
;// ./scrivito_sdk/bridge/adapter_description.ts
...
// EXTERNAL MODULE: ./scrivito_sdk/state/index.ts + 13 modules
var state = __webpack_require__(6324);
;// ./scrivito_sdk/bridge/adapter_client.ts
...
;// ./scrivito_sdk/bridge/adapter_proxy.ts
/* unused harmony import specifier */ var isPresent;
/* unused harmony import specifier */ var loadAndObserve;
/* unused harmony import specifier */ var observe;
...
;// ./scrivito_sdk/bridge/adapter_connection.ts
...
;// ./scrivito_sdk/bridge/link_via_port.ts
...
;// ./scrivito_sdk/bridge/post_message_link.ts
...
;// ./scrivito_sdk/bridge/start_adapter_server.ts
...
;// ./scrivito_sdk/bridge/initialize_adapter_client.ts
...
;// ./scrivito_sdk/bridge/close_link_on_signal.ts
...
;// ./scrivito_sdk/bridge/messages.ts
...
;// ./scrivito_sdk/bridge/stream_demux.ts
...
;// ./scrivito_sdk/bridge/adapter_message_client.ts
...
;// ./scrivito_sdk/bridge/adapter_invocation.ts
...
;// ./scrivito_sdk/bridge/adapter_message_server.ts
...
;// ./scrivito_sdk/bridge/anticipated_message_link.ts
...
;// ./scrivito_sdk/bridge/connect_client.ts
...
;// ./scrivito_sdk/bridge/wrap_with_logging.ts
/* unused harmony import specifier */ var Streamable;
...
__webpack_require__.d(__webpack_exports__, {
  ...
  _c: () => (/* reexport */ ExponentialBackoff),
...
class ApiClient {
  ...
  fetchWithDefaults(path, defaults) {
    return this.fetch(path, merge_default()({}, defaults, this.options));
  }
  get(path, options) {
...
// EXTERNAL MODULE: ./scrivito_sdk/common/index.ts + 65 modules
var common = __webpack_require__(6687);
;// ./scrivito_sdk/client/fetch_with_timeout.ts
...
;// ./scrivito_sdk/client/client_error.ts
...
;// ./scrivito_sdk/client/cms_rest_api/parse_or_throw_request_failed_error.ts
...
;// ./scrivito_sdk/client/is_error_response.ts
...
;// ./scrivito_sdk/client/parse_error_response.ts
...
;// ./scrivito_sdk/client/parse_response.ts
...
function parseResponseOrThrow(response, requestDetails) {
  return parse_response_async(this, null, function* () {
    ...
    const parsedResponse = parseOrThrowRequestFailedError(responseText);
    const message = httpStatus === 500 && isErrorResponse(parsedResponse) ? parsedResponse.error : (
...
;// ./scrivito_sdk/client/parse_url.ts


function parseUrl(url) {
  const parsed = URL.parse(url);
  if (parsed === null) throw new common/* ArgumentError */.c1(`Invalid URL: "${url}"`);
  return parsed;
}

;// ./scrivito_sdk/client/exponential_backoff.ts
  ...
  return retry_async(this, null, function* () {
    ...
    while (true) {
      try {
        ...
        (0,common/* logInfo */.fH)(`"${String(error)}". Retrying the request...`);
        yield backoff.nextDelay();
      }
    }
  });
...
;// ./scrivito_sdk/client/fetch_json.ts
...
function fetchJson(url, options) {
  return fetch_json_async(this, null, function* () {
    ...
    const performRequest = () => fetch_json_async(null, null, function* () {
      return parseResponseOrThrow(yield requestWithRateLimitRetry(authorizedRequest), {
        url,
...
;// ./scrivito_sdk/client/join_paths.ts
...
;// ./scrivito_sdk/client/login_handler.ts
...
;// ./scrivito_sdk/client/login_redirect_handler.ts
...
function loginRedirectHandler(visit, idp, prompt) {
  return login_redirect_handler_async(this, null, function* () {
    (0,common/* assignLocation */.dT)(yield authenticationUrl(visit, idp, prompt));
...
function authenticationUrl(visit, idp, prompt) {
  return login_redirect_handler_async(this, null, function* () {
    const authUrl = visit.replace("$RETURN_TO", encodeURIComponent(returnToUrl())).replace("$JR_API_LOCATION/iam/auth", yield getIamAuthUrl());
...
;// ./scrivito_sdk/client/create_rest_api_client.ts
  ...
  return create_rest_api_client_async(this, arguments, function* (url, {
    ...
    if (method === "GET") {
      return withLoginHandler(
        yield calculateLoginHandler({ loginHandler, idp, prompt }),
        fetchFn
      );
    }
    return fetchFn();
...
function calculateLoginHandler(_0) {
  return create_rest_api_client_async(this, arguments, function* ({
    ...
    return (visit) => loginRedirectHandler(visit, idp, prompt);
  });
}
...
;// ./scrivito_sdk/client/get_client_version.ts


function getClientVersion() {
  const clientVersion = "jssdk/1.29.0-dev-1-gfc5ed5147d6f";
  if (!clientVersion) throw new common/* InternalError */.Gd();
  return clientVersion;
}

;// ./scrivito_sdk/client/verificator_functions.ts
...
;// ./scrivito_sdk/client/public_authentication.ts
...
;// ./scrivito_sdk/client/cms_rest_api.ts
...
;// ./scrivito_sdk/client/request_failed_error.ts
...
;// ./scrivito_sdk/client/obj_json.ts
...
;// ./scrivito_sdk/client/obj_space_id.ts
...
function isObjSpaceId(maybeObjSpaceId) {
...
;// ./scrivito_sdk/client/obj_retrieval.ts
...
;// ./scrivito_sdk/client/binary_metadata_retrieval.ts
...
;// ./scrivito_sdk/client/binary_urls_retrieval.ts
...
;// ./scrivito_sdk/client/facet_query_retrieval.ts
...
;// ./scrivito_sdk/client/obj_field_diffs_retrieval.ts
...
;// ./scrivito_sdk/client/obj_query_retrieval.ts
...
;// ./scrivito_sdk/client/suggest_retrieval.ts
...
;// ./scrivito_sdk/client/cms_retrieval.ts
...
;// ./scrivito_sdk/client/jr_rest_api.ts


const JrRestApi = createRestApiClient("https://api.justrelate.com");

;// ./scrivito_sdk/client/config.ts

var config_async = (__this, __arguments, generator) => {
  return new Promise((resolve, reject) => {
    var fulfilled = (value) => {
      try {
        step(generator.next(value));
...
function toFetchedToken(response) {
  assertTokenResponse(response);
  const { access_token: token, expires_in: expiresIn } = response;
  return { token, expiresAt: new Date(Date.now() + expiresIn * 1e3) };
}
function assertTokenResponse(response) {
  if (response && typeof response === "object" && "access_token" in response && typeof response.access_token === "string" && "expires_in" in response && typeof response.expires_in === "number") {
    return;
  }
  throw new common/* InternalError */.Gd(JSON.stringify(response));
}
const clientConfig = new common/* ConfigStore */.s9();
function getIamAuthUrl(path = "") {
  return config_async(this, null, function* () {
...
;// ./scrivito_sdk/client/comparison_range.ts
/* unused harmony import specifier */ var comparison_range_isObjSpaceId;


function isComparisonRange(input) {
  if (!Array.isArray(input)) return false;
  if (input.length !== 2) return false;
  return input.every(comparison_range_isObjSpaceId);
}

;// ./scrivito_sdk/client/get_workspace_changes.ts
...
;// ./scrivito_sdk/client/browser_token.ts
...
;// ./scrivito_sdk/client/token_manager.ts
...
;// ./scrivito_sdk/client/visitor_authentication_provider.ts
...
;// ./scrivito_sdk/client/with_each_attribute_json.ts
...
;// ./scrivito_sdk/client/token_authorization_provider.ts
...
class TokenAuthorizationProvider {
  ...
  authorizeAbstract(callback) {
    return token_authorization_provider_async(this, null, function* () {
      ...
      while (true) {
        yield this.resetTokenIfExpired();
        ...
        const cached = yield tokenPromise;
        const outcome = yield callback(cached == null ? void 0 : cached.token);
  ...
  resetTokenIfExpired() {
    return token_authorization_provider_async(this, null, function* () {
      ...
      let cached;
      try {
        cached = yield this.fetchTokenPromise;
      } catch (e) {
        return;
      }
      if (!cached) return;
  ...
  injectToken(token) {
    this.fetchTokenPromise = Promise.resolve({
      token,
      expiresAt: /* @__PURE__ */ new Date(864e13)
    });
  }
}
...
;// ./scrivito_sdk/client/ingest_upload.ts

var ingest_upload_async = (__this, __arguments, generator) => {
  return new Promise((resolve, reject) => {
    var fulfilled = (value) => {
      try {
        step(generator.next(value));
...
function uploadFile(source) {
  return ingest_upload_async(this, null, function* () {
    const permission = yield requestUploadPermission();
    yield uploadToIngestService(permission, source);
    return getFileId(permission.uploadId);
  });
}
function requestUploadPermission() {
  return ingest_upload_async(this, null, function* () {
    return yield JrRestApi.get(
      `${yield getIngestServiceBasePath()}/upload-permission`
    );
  });
}
function uploadToIngestService(permission, blob) {
  return ingest_upload_async(this, null, function* () {
    const maxRetries = 3;
    const backoff = new ExponentialBackoff();
    while (backoff.numberOfRetries() <= maxRetries) {
      let response;
      try {
        response = yield fetch(permission.putUrl, { method: "PUT", body: blob });
      } catch (e) {
      }
      if (response) {
...
function getFileId(uploadId) {
  return ingest_upload_async(this, null, function* () {
    const {
      results: [result]
    } = yield JrRestApi.get(`${yield getIngestServiceBasePath()}/file`, {
      params: { upload_id: uploadId }
    });
    return result.id;
  });
}
function getIngestServiceBasePath() {
  return ingest_upload_async(this, null, function* () {
    return `ingest/instance/${yield (0,common/* fetchConfiguredTenant */.lT)()}`;
  });
}

;// ./scrivito_sdk/client/index.ts
...
__webpack_require__.d(__webpack_exports__, {
  ...
  l9: () => (/* reexport */ DESTINATION_UNAVAILABLE_PREFIX),
  ...
  qA: () => (/* reexport */ isPreviewComponentDescription),
...
;// ./scrivito_sdk/common/collect_and_schedule.ts
...
;// ./scrivito_sdk/common/logging.ts
...
;// ./scrivito_sdk/common/throw_invalid_arguments_error.ts
...
;// ./scrivito_sdk/common/deferred.ts
...
;// ./scrivito_sdk/common/sanitize_url.ts
...
function sanitizeUrl(rawUrl) {
  ...
  if (url.includes(".")) {
    ...
    const hostname = (_a = URL.parse(httpsUrl)) == null ? void 0 : _a.hostname;
    if (hostname && !hostname.includes("_")) return httpsUrl;
  }
  return url;
}

;// ./scrivito_sdk/common/next_tick.ts
...
;// ./scrivito_sdk/common/pretty_print.ts
...
;// ./scrivito_sdk/common/run_and_catch_exception.ts
...
;// ./scrivito_sdk/common/get_scrivito_version.ts


function getScrivitoVersion() {
  const version = "1.29.0-dev-1-gfc5ed5147d6f";
  if (!version) {
...
;// ./scrivito_sdk/common/asset_loading.ts
...
;// ./scrivito_sdk/common/is_present.ts

function isPresent(maybeValue) {
  return maybeValue !== null && maybeValue !== void 0;
}

;// ./scrivito_sdk/common/attribute_inflection.ts
...
;// ./scrivito_sdk/common/trans_iterator.ts
...
;// ./scrivito_sdk/common/is_system_attribute.ts

function isSystemAttribute(attributeName) {
  return attributeName[0] === "_";
}

;// ./scrivito_sdk/common/iterable.ts
...
;// ./scrivito_sdk/common/continue_iterable.ts
...
;// ./scrivito_sdk/common/reset_callbacks.ts
...
;// ./scrivito_sdk/common/unique_error_message.ts
...
;// ./scrivito_sdk/common/throttle.ts
...
;// ./scrivito_sdk/common/promise_and_finally.ts
...
;// ./scrivito_sdk/common/assume_presence.ts
...
;// ./scrivito_sdk/common/assume_string.ts
...
;// ./scrivito_sdk/common/app_url_from_packaged_ui_url.ts
...
;// ./scrivito_sdk/common/batch_retrieval.ts
...
;// ./scrivito_sdk/common/compute_cache_key.ts
...
;// ./scrivito_sdk/common/position.ts
...
;// ./scrivito_sdk/common/query_parameters.ts
...
;// ./scrivito_sdk/common/streamable.ts
...
;// ./scrivito_sdk/common/anticipated_stream.ts
...
;// ./scrivito_sdk/common/subject.ts
...
;// ./scrivito_sdk/common/extract_title_and_description.ts
...
;// ./scrivito_sdk/common/config_store.ts
...
;// ./scrivito_sdk/common/never.ts

function never() {
  return new Promise(() => void 0);
}

;// ./scrivito_sdk/common/prune_string.ts
...
;// ./scrivito_sdk/common/window_proxy.ts
...
;// ./scrivito_sdk/common/is_string_array.ts
...
;// ./scrivito_sdk/common/is_empty_value.ts
...
;// ./scrivito_sdk/common/compute_ancestor_paths.ts
...
;// ./scrivito_sdk/common/register_async_task.ts
...
;// ./scrivito_sdk/common/scroll_element_into_view.ts

function scrollElementIntoView(element, options) {
  element.scrollIntoView(options);
}

;// ./scrivito_sdk/common/timeout.ts
...
;// ./scrivito_sdk/common/cdn_asset_url_base.ts
...
;// ./scrivito_sdk/common/is_modifier_click.ts

function isModifierClick(event) {
  return event.ctrlKey || event.metaKey || event.shiftKey;
}

;// ./scrivito_sdk/common/configured_tenant.ts
/* unused harmony import specifier */ var configured_tenant_Deferred;
...
let deferredConfiguredTenant = new Deferred();
...
function resetConfiguredTenant() {
  deferredConfiguredTenant = new configured_tenant_Deferred();
  configuredTenant = void 0;
}

;// ./scrivito_sdk/common/current_origin.ts
...
;// ./scrivito_sdk/common/parameterize_data_class.ts
...
;// ./scrivito_sdk/common/is_object.ts

function isObject(arg) {
  return arg !== null && typeof arg === "object" && !Array.isArray(arg);
}

;// ./scrivito_sdk/common/is_preview_component_description.ts


function isPreviewComponentDescription(maybeProperty) {
  if (!isPlainObjectOrClassInstance(maybeProperty)) return false;
  const { component, key } = maybeProperty;
  return typeof key === "string" && (component === null || typeof component === "string" || typeof component === "function" || isObject(component));
}
function isPlainObjectOrClassInstance(maybeObject) {
  return isObject(maybeObject) && typeof maybeObject !== "function" && !Array.isArray(maybeObject);
}

;// ./scrivito_sdk/common/async_task_tracker.ts
...
;// ./scrivito_sdk/common/is_ISO8601.ts
...
;// ./scrivito_sdk/common/is_wrapping.ts
...
;// ./scrivito_sdk/common/is_blob.ts
...
;// ./scrivito_sdk/common/data_placeholders.tsx

const DATA_PLACEHOLDER_BODY = "__([a-zA-Z](?:[a-zA-Z0-9]|\\.[a-zA-Z]|(\\._id)|_(?!_)){0,100})__";
const DATA_PLACEHOLDERS = new RegExp(DATA_PLACEHOLDER_BODY, "gi");
const SINGLE_DATA_PLACEHOLDER = new RegExp(
  `^${DATA_PLACEHOLDER_BODY}$`,
  "i"
);

;// ./scrivito_sdk/common/url_resource.ts

function toUrlResource(url) {
  return `${url.pathname}${url.search}${url.hash}`;
}

;// ./scrivito_sdk/common/window_focus.ts
...
;// ./scrivito_sdk/common/destination_unavailable_prefix.ts

const DESTINATION_UNAVAILABLE_PREFIX = "#SCRIVITO_UNAVAILABLE_";

;// ./scrivito_sdk/common/index.ts
...
__webpack_require__.d(__webpack_exports__, {
  ...
  e7: () => (/* reexport */ observeWritingPromise),
...
// UNUSED EXPORTS: ObjData, REMOVE_THIS_KEY, ReplicationCache, clearObjDataCache, createObjReplicationProcess, diffObjJson, diffWidgetJson, getWriteStatus, hasAnyPendingChanges, hasObjContentDiff, isAttributeModified, isWriting, objDataFor, patchObjJson, registerObjWriteHook, setPublishedWriteHandler, setReplicationErrorHandler, threeWayMergeObjs

// EXTERNAL MODULE: ./scrivito_sdk/client/index.ts + 40 modules
var client = __webpack_require__(9421);
// EXTERNAL MODULE: ./scrivito_sdk/common/index.ts + 65 modules
var common = __webpack_require__(6687);
;// ./scrivito_sdk/data/in_memory_tenant.ts
...
;// ./scrivito_sdk/data/obj_repair.ts
...
function repairDanglingWidgets(obj, oldState) {
  ...
  const repairedPool = __spreadValues({}, (_a = obj._widget_pool) != null ? _a : {});
  let restoredInPass;
  let iterations = 0;
  do {
    restoredInPass = false;
    if (++iterations > 1e3) throw new common/* InternalError */.Gd();
    (0,client/* withEachAttributeJson */.Yy)(
      __spreadProps(__spreadValues({}, obj), { _widget_pool: repairedPool }),
      ([type, data]) => {
        if (type !== "widgetlist") return;
        data.forEach((widgetId) => {
          if (repairedPool[widgetId] === void 0 && oldPool[widgetId] !== void 0) {
  ...
  return __spreadProps(__spreadValues({}, obj), { _widget_pool: repairedPool });
}

;// ./scrivito_sdk/data/remove_this_key.ts
...
;// ./scrivito_sdk/data/obj_patch.ts
...
;// ./scrivito_sdk/data/replication_cache.ts
...
;// ./scrivito_sdk/data/obj_replication_pool.ts
...
;// ./scrivito_sdk/data/obj_write_tracker.ts

let objWriteHook;
function registerObjWriteHook(fn) {
  objWriteHook = fn;
}
function notifyObjWrite(objSpaceId, objId, previousData) {
  if (objWriteHook) objWriteHook(objSpaceId, objId, previousData);
}

;// ./scrivito_sdk/data/performance_constraint.ts
...
;// ./scrivito_sdk/data/published_write_handler.ts


let publishedWriteHandler;
function setPublishedWriteHandler(handler) {
  publishedWriteHandler = handler;
}
function getPublishedWriteHandler() {
  return publishedWriteHandler;
}
(0,common/* onReset */.Nj)(() => {
  publishedWriteHandler = void 0;
});
...
class ObjData {
  ...
  set(newState) {
    ...
    const previousData = (0,loadable/* loadableWithDefault */.s4)(void 0, () => this.get());
    if (previousData !== void 0) {
      notifyObjWrite(this._objSpaceId, this._id, previousData);
    }
  ...
  update(objPatch) {
    if (!getPublishedWriteHandler() && !isUsingInMemoryTenant() && (0,client/* isWorkspaceObjSpaceId */.Qk)(this._objSpaceId) && this._objSpaceId[1] === "published") {
...
;// ./scrivito_sdk/data/workspace_content_updater.ts
...
;// ./scrivito_sdk/data/content_updater.ts
...
;// ./scrivito_sdk/data/facet_query.ts
/* unused harmony import specifier */ var isWorkspaceObjSpaceId;
...
;// ./scrivito_sdk/data/find_widget_placement.ts
...
;// ./scrivito_sdk/data/obj_data_store.ts




function preloadObjData(objSpaceId, objId) {
  (0,loadable/* load */.Hh)(() => getObjData(objSpaceId, objId));
}
...
function getObjData(objSpaceId, objId) {
  const objData = objDataFor(objSpaceId, objId);
...
;// ./scrivito_sdk/data/get_obj_version.ts
...
;// ./scrivito_sdk/data/active_writes.ts

var active_writes_defProp = Object.defineProperty;
var active_writes_defProps = Object.defineProperties;
var active_writes_getOwnPropDescs = Object.getOwnPropertyDescriptors;
var active_writes_getOwnPropSymbols = Object.getOwnPropertySymbols;
var active_writes_hasOwnProp = Object.prototype.hasOwnProperty;
var active_writes_propIsEnum = Object.prototype.propertyIsEnumerable;
var active_writes_defNormalProp = (obj, key, value) => key in obj ? active_writes_defProp(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var active_writes_spreadValues = (a, b) => {
  for (var prop in b || (b = {}))
    if (active_writes_hasOwnProp.call(b, prop))
      active_writes_defNormalProp(a, prop, b[prop]);
  if (active_writes_getOwnPropSymbols)
    for (var prop of active_writes_getOwnPropSymbols(b)) {
      if (active_writes_propIsEnum.call(b, prop))
        active_writes_defNormalProp(a, prop, b[prop]);
    }
  return a;
};
var active_writes_spreadProps = (a, b) => active_writes_defProps(a, active_writes_getOwnPropDescs(b));

const active_writes_state = (0,state/* createStateContainer */.Ld)();
function active_writes_getState() {
  var _a;
  return (_a = active_writes_state.get()) != null ? _a : { count: 0, hasErrors: false };
}
function observeWritingPromise(promise) {
  const before = active_writes_getState();
  active_writes_state.set({
    count: before.count + 1,
    hasErrors: before.count > 0 ? before.hasErrors : false
  });
  promise.then(
    () => {
      const current = active_writes_getState();
      active_writes_state.set(active_writes_spreadProps(active_writes_spreadValues({}, current), { count: current.count - 1 }));
    },
    () => {
      const current = active_writes_getState();
      active_writes_state.set({ count: current.count - 1, hasErrors: true });
    }
  );
  return promise;
}
function isWriting() {
  return active_writes_getState().count > 0;
}
function getWriteStatus() {
  const { count, hasErrors } = active_writes_getState();
  return { writing: count > 0, hasErrors };
}

;// ./scrivito_sdk/data/disable_obj_replication.ts
...
;// ./scrivito_sdk/data/observed_value.ts
...
class ObservedValue {
  ...
  set(newValue) {
    ...
    this.value = newValue;
    (_a = this.onChange) == null ? void 0 : _a.call(this, oldValue, newValue);
  }
}

;// ./scrivito_sdk/data/reactive_any.ts


class ReactiveAny {
  constructor() {
    this.count = (0,state/* createStateContainer */.Ld)();
  }
  isAnyTrue() {
    var _a;
    return ((_a = this.count.get()) != null ? _a : 0) > 0;
  }
  memberChanged(oldValue, newValue) {
    var _a;
    if (oldValue === newValue) return;
    const current = (_a = this.count.get()) != null ? _a : 0;
    this.count.set(current + (newValue ? 1 : -1));
  }
}

;// ./scrivito_sdk/data/obj_backend_replication.ts
...
let replicationErrorHandler;
function setReplicationErrorHandler(handler) {
...
class ObjBackendReplication {
  constructor(objSpaceId, objId) {
    ...
    this.objId = objId;
    this.replicationActiveState = (0,state/* createStateContainer */.Ld)();
    this.replicationActive = new ObservedValue(
      (_oldValue, newValue) => this.replicationActiveState.set(newValue)
    );
    this.isUnreplicatedState = (0,state/* createStateContainer */.Ld)();
    this.isUnreplicated = new ObservedValue(
      (oldValue, newValue) => {
    ...
    const updateUnreplicated = () => this.isUnreplicated.set(
  ...
  notifyBackendState(notifiedBackendState) {
    ...
    const newestKnownBackendState = this.bufferedBackendState || this.backendState.get();
  ...
  replicateNow() {
    return obj_backend_replication_async(this, null, function* () {
      if (this.localState.get() === void 0) return;
  ...
  shouldAutoReplicate() {
    return (0,client/* getWorkspaceId */.LD)(this.objSpaceId) !== "published";
  }
  startReplication() {
  ...
  performReplication() {
    return obj_backend_replication_async(this, null, function* () {
      ...
      try {
        ...
        replicationErrorHandler == null ? void 0 : replicationErrorHandler(error);
  ...
  replicatePatchToBackend(patch) {
    return obj_backend_replication_async(this, null, function* () {
      const workspaceId = (0,client/* getWorkspaceId */.LD)(this.objSpaceId);
      if (workspaceId !== "published") {
        return client/* cmsRestApi */.gd.put(`workspaces/${workspaceId}/objs/${this.objId}`, {
          obj: patch
        });
      }
      ...
      yield handler(this.objId, patch);
      return (0,client/* retrieveObj */.yd)(this.objSpaceId, this.objId, "full");
    });
  }
  ...
  hasPendingChanges() {
    var _a;
    return (_a = this.isUnreplicatedState.get()) != null ? _a : false;
  }
  isReplicating() {
    var _a;
    return (_a = this.replicationActiveState.get()) != null ? _a : false;
  }
}
function isEqualState(stateA, stateB) {
  return stateA === stateB || !!stateA && !!stateB && isEmpty_default()(diffObjJson(stateA, stateB));
}
...
;// ./scrivito_sdk/replication/version_archive.ts
...
;// ./scrivito_sdk/replication/replication_agent.ts
...
;// ./scrivito_sdk/replication/replication_process.ts
...
;// ./scrivito_sdk/replication/index.ts



;// ./scrivito_sdk/data/obj_replication_process.ts
  ...
  constructor({
    ...
    this.loadableCollection = (0,loadable/* createLoadableCollection */.rL)({
      ...
      loadElement: ([params, index], batchSize) => ({
        ...
        skipOfflineHandling: skipOfflineHandling == null ? void 0 : skipOfflineHandling(params),
...
;// ./scrivito_sdk/data/id_batch_query.ts
...
;// ./scrivito_sdk/data/obj_offline_query.ts
...
;// ./scrivito_sdk/data/obj_query_store.ts
...
function getObjQuery(objSpaceId, params, batchSize) {
  ...
  return (0,common/* transformContinueIterable */.YB)(
    idQuery,
    (iterator) => iterator.map((id) => getObjData(objSpaceId, id)).takeWhile(common/* isPresent */.Wo).filter((objData) => !objData.isUnavailable())
  );
}
...
;// ./scrivito_sdk/data/obj_stream_replication.ts
...
;// ./scrivito_sdk/data/obj_field_diffs_data.ts
...
;// ./scrivito_sdk/data/get_widget_modification.ts
...
;// ./scrivito_sdk/data/is_attribute_modified.ts
/* unused harmony import specifier */ var isEqual;
/* unused harmony import specifier */ var is_attribute_modified_getObjData;
...
function getObjDataIfExistent(objSpaceId, objId) {
  const objData = is_attribute_modified_getObjData(objSpaceId, objId);
  if (objData && !objData.isUnavailable() && !objData.isForbidden()) {
    return objData;
  }
}

;// ./scrivito_sdk/data/index.ts
...
__webpack_require__.d(__webpack_exports__, {
  ...
  Co: () => (/* reexport */ addDataClassPrefix),
  ...
  rz: () => (/* reexport */ provideDataService),
...
// UNUSED EXPORTS: DataItemAttribute, ExternalDataScope, ObjDataScope, getDataAttributeDefinitions, getDataContextValue, isValidDataId, removeDataClassPrefix, setExternalData

// EXTERNAL MODULE: ./scrivito_sdk/realm/index.ts + 21 modules
var realm = __webpack_require__(687);
;// ./scrivito_sdk/data_integration/basic_obj_to_data_context.ts
...
// EXTERNAL MODULE: ./scrivito_sdk/common/index.ts + 65 modules
var common = __webpack_require__(6687);
;// ./scrivito_sdk/data_integration/data_class_name_prefix.ts


const NAMED_PREFIX = "named/";
const ANON_PREFIX = "anon/";
let anonCounter = 0;
function addDataClassPrefix(name) {
  if (name === null) {
    anonCounter++;
...
function removeDataClassPrefix(name) {
  if (name.startsWith(ANON_PREFIX)) return null;
  if (name.startsWith(NAMED_PREFIX)) return name.slice(NAMED_PREFIX.length);
  return name;
}
(0,common/* onReset */.Nj)(() => anonCounter = 0);

;// ./scrivito_sdk/data_integration/lazy_async.ts
...
// EXTERNAL MODULE: ./scrivito_sdk/state/index.ts + 13 modules
var state = __webpack_require__(6324);
;// ./scrivito_sdk/data_integration/data_class_schema.ts
...
function extractEnumDefinitionWithConfig(attributeName, attributeType, maybeConfig) {
...
// EXTERNAL MODULE: ./scrivito_sdk/models/index.ts + 42 modules
var models = __webpack_require__(5436);
;// ./scrivito_sdk/data_integration/data_class.ts
...
;// ./scrivito_sdk/data_integration/create_rest_api_connection.ts
...
;// ./scrivito_sdk/data_integration/data_id.ts

function isValidDataId(id) {
  return typeof id === "string" && !id.includes("^") && /^[\x21-\x7D]+$/.test(id);
}

;// ./scrivito_sdk/data_integration/attribute_serialization_and_deserialization.ts
...
function serializeMultienumAttribute(value, dataClassName, attributeName, attributeDefinition) {
  if (value === null) return null;
  const enumValues = getEnumValues(getAttributeConfig(attributeDefinition));
  if (Array.isArray(value) && value.every((v) => typeof v === "string" && enumValues.includes(v))) {
    return value;
  }
  throwTypeMismatch(
    dataClassName,
...
function deserializeMultienumAttribute(value, dataClassName, attributeName, attributeDefinition) {
...
;// ./scrivito_sdk/data_integration/data_connection_error.ts
...
;// ./scrivito_sdk/data_integration/disable_external_data_loading.ts
...
;// ./scrivito_sdk/data_integration/external_data_class_config.ts

var external_data_class_config_async = (__this, __arguments, generator) => {
  return new Promise((resolve, reject) => {
    var fulfilled = (value) => {
      try {
        step(generator.next(value));
...
let config = {};
function configureExternalDataClass(dataClassName, params) {
  ...
  config[dataClassName] = {
    ...
    skipOfflineHandling: () => external_data_class_config_async(null, null, function* () {
      return (yield normalizedSkip()) === true;
    })
  };
}
function getExternalDataClassNames() {
  return Object.keys(config);
}
function shouldRefetchOnWindowFocus(dataClassName) {
  return external_data_class_config_async(this, null, function* () {
    var _a;
    const entry = config[dataClassName];
    if (!entry) return false;
    return ((_a = yield entry.refetchOnWindowFocus()) != null ? _a : true) !== false;
  });
}
function shouldSkipOfflineHandlingFor(dataClassName) {
  return external_data_class_config_async(this, null, function* () {
    const entry = config[dataClassName];
...
;// ./scrivito_sdk/data_integration/add_missing_data_connection_handlers.ts
...
;// ./scrivito_sdk/data_integration/anticipated_data_connection.ts
...
;// ./scrivito_sdk/data_integration/external_data_connection.ts
...
;// ./scrivito_sdk/data_integration/external_data.ts





function setExternalData(classIdentifier, dataId, data) {
  loadableCollection.get([classIdentifier, dataId]).set(data);
}
function getExternalData(classIdentifier, dataId) {
...
// EXTERNAL MODULE: ./scrivito_sdk/data/index.ts + 35 modules
var data = __webpack_require__(9180);
;// ./scrivito_sdk/data_integration/external_data_offline_query.ts
...
;// ./scrivito_sdk/data_integration/index_params.ts
...
;// ./scrivito_sdk/data_integration/external_data_query.ts
...
;// ./scrivito_sdk/data_integration/external_data_class.ts
...
class ExternalDataClass extends DataClass {
  ...
  get(id) {
    return getExternalData(this._internalName, id) ? ExternalDataItem.build(this, id) : null;
  }
  getUnchecked(id) {
    return ExternalDataItem.buildUnchecked(this, id);
  }
  forceReloadAllQueries() {
...
class ExternalDataScope extends DataScope {
  ...
  toPojo() {
    return external_data_class_spreadValues({
      _class: (0,common/* assumeString */.uV)(this.dataClassName()),
  ...
  getIterator(attributes) {
    return (0,common/* transformContinueIterable */.YB)(
      getExternalDataQuery(
        external_data_class_spreadValues({
...
class ExternalDataItem extends DataItem {
  ...
  getLocalized(attributeName) {
    ...
    if (attributeType === "multienum" && Array.isArray(attributeValue)) {
      return attributeValue.map(
        (value) => typeof value === "string" ? localizeEnumValue(value, attributeConfig) : value
      );
    }
  ...
  delete() {
    return external_data_class_async(this, null, function* () {
      yield deleteViaDataConnection(this.internalDataClassName(), this._dataId);
  ...
  forceReload() {
    return external_data_class_async(this, null, function* () {
      ...
      setExternalData(
        dataClassName,
        this._dataId,
        yield getViaDataConnection(dataClassName, this._dataId)
      );
    });
  }
  /** @internal */
...
function localizeEnumValue(value, attributeConfig) {
...
;// ./scrivito_sdk/data_integration/obj_data_class.ts
...
class ObjDataItem extends DataItem {
  ...
  forceReload() {
    throw new common/* ArgumentError */.c1("Cannot force-reload a built-in data item");
  }
  getOrThrow() {
    const obj = this.getBasicObj();
    if (!obj) {
...
;// ./scrivito_sdk/data_integration/get_data_class.ts
...
;// ./scrivito_sdk/data_integration/empty_data_scope.ts
...
class EmptyDataScope extends DataScope {
  ...
  internalDataClassName() {
    var _a;
    return ((_a = this.dataClass()) == null ? void 0 : _a.internalName()) || null;
  }
  create(_attributes) {
...
;// ./scrivito_sdk/data_integration/data_stack.ts
...
;// ./scrivito_sdk/data_integration/global_data.ts
...
function provideGlobalData(dataItem) {
  const dataClassName = (0,common/* assumeString */.uV)(dataItem.dataClassName());
...
;// ./scrivito_sdk/data_integration/data_context.ts
...
function externalDataItemToDataContext(dataItem) {
  return data_context_spreadValues({
    _class: (0,common/* assumeString */.uV)(dataItem.dataClassName()),
    _id: dataItem.id()
...
;// ./scrivito_sdk/data_integration/register_external_data_class.ts
...
;// ./scrivito_sdk/data_integration/apply_data_locator.ts
...
;// ./scrivito_sdk/data_integration/filter_external_data_item.ts
...
;// ./scrivito_sdk/data_integration/singleton_data_classes.ts
...
;// ./scrivito_sdk/data_integration/provide_external_data_item.ts
...
;// ./scrivito_sdk/data_integration/activate_data_integration.ts
...
;// ./scrivito_sdk/data_integration/placeholder_replacement.ts
...
;// ./scrivito_sdk/data_integration/current_language.ts
...
;// ./scrivito_sdk/data_integration/fetch_schema.ts
...
const fetchSchema = memoize_default()(function(apiClient) {
  return fetch_schema_async(this, null, function* () {
    ...
    let response;
    try {
      response = yield apiClient.fetchWithDefaults("schema", {
...
;// ./scrivito_sdk/data_integration/create_rest_api_schema.ts
...
;// ./scrivito_sdk/data_integration/provide_data_class.ts
...
function provideDataClass(nameOrParams, maybeParams) {
...
;// ./scrivito_sdk/data_integration/provide_data_item.ts
...
// EXTERNAL MODULE: external "lodash-es/upperFirst"
var upperFirst_ = __webpack_require__(5769);
var upperFirst_default = /*#__PURE__*/__webpack_require__.n(upperFirst_);
;// ./scrivito_sdk/data_integration/data_service_namespace_registry.ts


const dataServiceNamespaces = /* @__PURE__ */ new Set();
...
;// ./scrivito_sdk/data_integration/provide_data_service.ts

var provide_data_service_async = (__this, __arguments, generator) => {
  return new Promise((resolve, reject) => {
    var fulfilled = (value) => {
      try {
        step(generator.next(value));
...
function provideDataService(baseUrl, options) {
  return provide_data_service_async(this, null, function* () {
    var _a;
    const namespace = (_a = options == null ? void 0 : options.namespace) != null ? _a : "";
    registerNamespace(namespace);
    const normalizedBaseUrl = baseUrl.replace(/\/+$/, "");
    const resources = yield fetchAndValidateManifest(normalizedBaseUrl);
    return resources.reduce((dataClasses, resourcePath) => {
...
function registerDataClassForResource(resourcePath, baseUrl, options) {
  const className = toClassName(resourcePath, options == null ? void 0 : options.namespace);
  if (!(0,models/* isValidDataIdentifier */.Wf)(className)) {
    throw new common/* ArgumentError */.c1(
  ...
  return provideDataClass(className, {
    restApi: { url: `${baseUrl}/${resourcePath}`, headers: options == null ? void 0 : options.headers }
  });
}
function fetchAndValidateManifest(baseUrl) {
  return provide_data_service_async(this, null, function* () {
    let audience;
    try {
      audience = new URL(baseUrl).origin;
    } catch (e) {
      throw new common/* ArgumentError */.c1(`Invalid baseUrl: "${baseUrl}"`);
    }
    const manifestUrl = `${baseUrl}/_manifest`;
    const response = yield (0,client/* fetchJson */.x6)(manifestUrl, {
      method: "GET",
      authProvider: (0,client/* getTokenProvider */.R)({ audience })
    });
    if (response && typeof response === "object" && "resources" in response && Array.isArray(response.resources) && response.resources.every((resource) => typeof resource === "string")) {
...
function toClassName(subPath, namespace) {
  const normalizedPath = subPath.split(/[-_]/).map((upperFirst_default())).join("");
  return namespace ? `${namespace}_${normalizedPath}` : normalizedPath;
}

;// ./scrivito_sdk/data_integration/external_data_invalidation.ts
...
function invalidateExternalData() {
  return external_data_invalidation_async(this, null, function* () {
    for (const dataClassName of getExternalDataClassNames()) {
      if (yield shouldRefetchOnWindowFocus(dataClassName)) {
...
;// ./scrivito_sdk/data_integration/index.ts
...
const moduleLoaders = {
  reactEditing: () => __webpack_require__.e(/* import() */ 723).then(__webpack_require__.bind(__webpack_require__, 6679)),
...
// UNUSED EXPORTS: formatInternalUrl, parseInternalUrl

;// ./scrivito_sdk/link_resolution/format_internal_links.ts
...
function formatInternalUrl(internalUrl) {
...
// EXTERNAL MODULE: ./scrivito_sdk/common/index.ts + 65 modules
var common = __webpack_require__(6687);
;// ./scrivito_sdk/link_resolution/resolve_url.ts
...
;// ./scrivito_sdk/link_resolution/content_conversion/resolve_html_url.ts
...
function resolveHtmlUrl(encodedUrl) {
  ...
  return escape_default()(formatInternalUrl({ obj_id, query, hash: fragment }));
}

;// ./scrivito_sdk/link_resolution/content_conversion.ts
...
// EXTERNAL MODULE: ./scrivito_sdk/loadable/index.ts + 28 modules
var loadable = __webpack_require__(6084);
;// ./scrivito_sdk/link_resolution/link_resolution_worker.ts
...
;// ./scrivito_sdk/link_resolution/link_resolution.ts
...
function notifyLinkResolutionIsActive(promise) {
  (0,data/* observeWritingPromise */.e7)(promise);
}
...
;// ./scrivito_sdk/link_resolution/index.ts
...
__webpack_require__.d(__webpack_exports__, {
  ...
  rP: () => (/* reexport */ loadableFunction),
  s4: () => (/* reexport */ loadableWithDefault),
  HP: () => (/* reexport */ observeSyncAndLoad),
  ...
  xT: () => (/* reexport */ withOptionalLoading),
...
;// ./scrivito_sdk/loadable/load_all_until.ts
/* unused harmony import specifier */ var runAndCatchErrorsWhileLoading;
...
// EXTERNAL MODULE: ./scrivito_sdk/common/index.ts + 65 modules
var common = __webpack_require__(6687);
;// ./scrivito_sdk/loadable/load_handler.ts
...
;// ./scrivito_sdk/loadable/loadable_state.ts
...
// EXTERNAL MODULE: ./scrivito_sdk/state/index.ts + 13 modules
var state = __webpack_require__(6324);
;// ./scrivito_sdk/loadable/observe_and_load.ts
...
function observeAndLoad(loadableExpression) {
  return new common/* Streamable */.RE((observer) => {
    ...
    const subscription = (0,state/* observe */.lB)(
      () => capture(() => (0,common/* runAndCatchException */.Bd)(loadableExpression))
    ).subscribe((captured) => {
...
;// ./scrivito_sdk/loadable/ignore_loading_state.ts
...
;// ./scrivito_sdk/loadable/loader_callback_process.ts
...
;// ./scrivito_sdk/loadable/offline_handling.ts
...
function applyOfflineHandling(loadable, params) {
  ...
  const skipOfflineHandling = (_a = params.skipOfflineHandling) != null ? _a : false;
  const resolveMode = () => offline_handling_async(null, null, function* () {
    if (yield skipOfflineHandling) return "skip";
    return (yield isInOfflineMode) ? "offline" : "online";
  });
  if (offlineLoader) {
    return {
      loader: () => offline_handling_async(null, null, function* () {
        return (yield resolveMode()) === "offline" ? offlineLoader() : loader();
      })
    };
  }
  ...
  return {
    loader: () => offline_handling_async(null, null, function* () {
      return (yield resolveMode()) === "offline" ? loadFromEntry(offlineEntry) : loader();
    }),
    onChange: (0,common/* collectAndSchedule */.Lu)(common/* nextTick */.dY, () => offline_handling_async(null, null, function* () {
      if (isEnabled && (yield resolveMode()) === "online") {
...
;// ./scrivito_sdk/loadable/stream_process.ts
...
;// ./scrivito_sdk/loadable/create_loader_process.ts
...
;// ./scrivito_sdk/loadable/loading_registry.ts
...
;// ./scrivito_sdk/loadable/not_loaded_error.ts
...
;// ./scrivito_sdk/loadable/offline_store.ts
/* unused harmony import specifier */ var Deferred;
...
;// ./scrivito_sdk/loadable/loadable_data.ts
...
;// ./scrivito_sdk/loadable/load_with_default.ts
...
;// ./scrivito_sdk/loadable/load_serial.ts
/* unused harmony import specifier */ var load_serial_capture;


function loadSerial(firstFn, secondFn) {
  const firstCaptured = load_serial_capture(firstFn);
  firstCaptured.forwardToCurrent();
  const secondCaptured = load_serial_capture(() => secondFn(firstCaptured.result));
  if (firstCaptured.isAllDataLoaded()) secondCaptured.forwardToCurrent();
  return secondCaptured.result;
}

;// ./scrivito_sdk/loadable/dejitter_state_stream.ts
...
;// ./scrivito_sdk/loadable/loadable_function.ts





function loadableFunction(defaultValue, argsToStringOrZeroArgsFn, fn) {
  if (!fn) {
...
;// ./scrivito_sdk/loadable/map_reduce.ts
/* unused harmony import specifier */ var sliceFromIterable;
/* unused harmony import specifier */ var map_reduce_loadSerial;
/* unused harmony import specifier */ var map_reduce_loadableFunction;
...
;// ./scrivito_sdk/loadable/loadable_with_default.ts
...
;// ./scrivito_sdk/loadable/run_and_catch_errors_while_loading.ts



function run_and_catch_errors_while_loading_runAndCatchErrorsWhileLoading(loadableFunction) {
  const captured = capture(() => (0,common/* runAndCatchException */.Bd)(loadableFunction));
...
;// ./scrivito_sdk/loadable/loadable_collection.ts
...
;// ./scrivito_sdk/loadable/data_recorder.ts
...
;// ./scrivito_sdk/loadable/load_and_observe.ts
...
;// ./scrivito_sdk/loadable/observe_sync_and_load.ts




function observeSyncAndLoad(observedExpression, listener) {
  const loadingSubscriber = new LoadingSubscriber();
  let lastResult = (0,state/* trackStateAccess */.j2)(observedExpression).result;
  const subscription = (0,state/* observeSync */.Ml)(
    () => capture(observedExpression),
    (captured) => {
      captured.subscribeLoading(loadingSubscriber);
      const nextResult = captured.result;
      if (lastResult === void 0 || !(0,common/* equalsBestEffort */.uw)(nextResult, lastResult)) {
        listener(nextResult);
...
;// ./scrivito_sdk/loadable/load_entire_iterable.ts
/* unused harmony import specifier */ var load_entire_iterable_sliceFromIterable;
/* unused harmony import specifier */ var load_entire_iterable_load;
...
function loadEntireIterable(iterable) {
  return load_entire_iterable_async(this, null, function* () {
    ...
    let continuation;
    do {
      const batch = yield load_entire_iterable_load(
        () => load_entire_iterable_sliceFromIterable(iterable, continuation, 1)
      );
...
;// ./scrivito_sdk/loadable/without_loading.ts
...
;// ./scrivito_sdk/loadable/with_optional_loading.ts


function withOptionalLoading(fn) {
  const captured = capture(fn);
  if (isCurrentlyCapturing()) {
    captured.forwardToCurrent();
  }
...
;// ./scrivito_sdk/loadable/index.ts
...
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6687);
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5436);
/* harmony import */ var scrivito_sdk_models_obj_space_for__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4476);
/* harmony import */ var scrivito_sdk_state__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6324);





const objSpaceIdState = (0,scrivito_sdk_state__WEBPACK_IMPORTED_MODULE_3__/* .createStateContainer */ .Ld)();
function currentObjSpaceId() {
  var _a;
  return (_a = objSpaceIdState.get()) != null ? _a : (0,scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_1__/* .publishedSpace */ .z7)();
}
...
function setCurrentWorkspaceId(id) {
  objSpaceIdState.set((0,scrivito_sdk_models_obj_space_for__WEBPACK_IMPORTED_MODULE_2__/* .objSpaceFor */ .v)(id));
}
function resetCurrentWorkspaceId() {
  objSpaceIdState.set((0,scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_1__/* .publishedSpace */ .z7)());
}
...
__webpack_require__.d(__webpack_exports__, {
  ...
  gy: () => (/* reexport */ enforceBoundedQueries),
...
// UNUSED EXPORTS: BasicObjFacetValue, CMS_ATTRIBUTE_TYPES, OPERATORS, countVersionsOnAllSites, deserializeValue, disableStrictObjIdValidation, enableStrictObjIdValidation, generateWidgetId, isCurrentWorkspacePublished, isDataLocatorValueOrOperatorFilter, isDataLocatorValueVia, isWrappingBasicWidget, normalizedRestriction, resetCurrentWorkspaceId, restrictToGlobal, serializeAttribute, serializeAttributes

// EXTERNAL MODULE: ./scrivito_sdk/common/index.ts + 65 modules
var common = __webpack_require__(6687);
;// ./scrivito_sdk/models/generate_widget_id.ts


function generateWidgetId(widgetPool = {}) {
  for (let i = 0; i < 10; i++) {
...
// EXTERNAL MODULE: ./scrivito_sdk/client/index.ts + 40 modules
var client = __webpack_require__(9421);
;// ./scrivito_sdk/models/auto_convert.ts
...
;// ./scrivito_sdk/models/exclude_deleted_objs.ts
...
// EXTERNAL MODULE: ./scrivito_sdk/data/index.ts + 35 modules
var scrivito_sdk_data = __webpack_require__(9180);
;// ./scrivito_sdk/models/obj_unavailable.ts
...
;// ./scrivito_sdk/models/obj_scope.ts
...
;// ./scrivito_sdk/models/obj_space_scope_excluding_deleted.ts
...
;// ./scrivito_sdk/models/attribute_deserializer.ts
...
function deserialize(model, value, typeInfo) {
  switch (typeInfo[0]) {
    ...
    case "referencelist":
      return deserializeValue(value, typeInfo).map(
        (id) => convertReference(id, model)
      );
    case "widget": {
    ...
    case "widgetlist":
      return deserializeValue(value, typeInfo).map(
        (id) => (
          ...
          (0,common/* assumePresence */.W3)(model.widget(id))
        )
      );
    default:
...
function deserializeValue(value, typeInfo) {
  switch (typeInfo[0]) {
    case "binary":
...
function deserializeBinaryValue(value) {
...
function deserializeReferenceValue(value) {
  if (isBackendValueOfType("reference", value)) {
    return value[1];
  }
  return null;
}
function deserializeReferencelistValue(value) {
...
function deserializeWidgetValue(value) {
...
function deserializeWidgetlistValue(value) {
...
var link_resolution = __webpack_require__(5924);
;// ./scrivito_sdk/models/basic_scope_get_methods.ts
...
;// ./scrivito_sdk/models/basic_field.ts
...
;// ./scrivito_sdk/models/basic_obj_facet_value.ts
...
;// ./scrivito_sdk/models/enforce_bounded_queries.ts


let boundedQueriesEnforced = false;
function enforceBoundedQueries() {
  boundedQueriesEnforced = true;
}
function areBoundedQueriesEnforced() {
...
;// ./scrivito_sdk/models/basic_obj_search.ts
...
// EXTERNAL MODULE: ./scrivito_sdk/state/index.ts + 13 modules
var state = __webpack_require__(6324);
;// ./scrivito_sdk/models/future_binary.ts
...
;// ./scrivito_sdk/models/metadata_collection.ts
...
;// ./scrivito_sdk/models/binary.ts
/* unused harmony import specifier */ var publishedSpace;
...
;// ./scrivito_sdk/models/basic_scope_create_methods.ts
...
;// ./scrivito_sdk/models/compute_parent_path.ts
...
var current_workspace_id = __webpack_require__(4603);
;// ./scrivito_sdk/models/restrict_to_site.ts
...
;// ./scrivito_sdk/models/basic_obj.ts
...
class BasicObj {
  ...
  objClass() {
    ...
    throw new common/* ScrivitoError */.aS("Object was deleted, possibly by another user.");
  }
  obj() {
    return this;
  }
  ...
  backlinksSearch() {
    return objSpaceScopeExcludingDeleted(this.objSpaceId()).search().and("*", "linksTo", this);
  }
  ancestors() {
    const parentPath = this.parentPath();
    const siteId = this.siteId();
  ...
  widgetClassNamesWithBadPerformance() {
    ...
    const classNames = new Set(
      Object.values(widgetPool).filter((value) => !!value).map((widgetJson) => widgetJson._obj_class).filter((objClass) => !!objClass)
    );
  ...
  getData() {
    return (0,common/* assumePresence */.W3)(this.objData.get());
  }
  getRawData() {
...
;// ./scrivito_sdk/models/basic_link.ts
...
;// ./scrivito_sdk/models/data_locator.ts
/* unused harmony import specifier */ var isDataLocatorValueFilter;
/* unused harmony import specifier */ var isDataLocatorOperatorFilter;
...
;// ./scrivito_sdk/models/is_obj_id.ts

const OBJ_ID_PATTERN = /^[0-9a-f]{16}$/;
let strictValidation = true;
function disableStrictObjIdValidation() {
  strictValidation = false;
}
function enableStrictObjIdValidation() {
  strictValidation = true;
}
function isObjId(value) {
  if (typeof value !== "string") return false;
  if (strictValidation) return OBJ_ID_PATTERN.test(value);
  return true;
}

;// ./scrivito_sdk/models/attribute_serializer.ts
...
function serializeAttribute(value, name, typeInfo) {
  if (value === null) return null;
...
function isValidReference(value) {
  return value === "" || isObjId(value) || value instanceof BasicObj || value instanceof ObjUnavailable;
}
...
;// ./scrivito_sdk/models/basic_widget.ts
...
class BasicWidget {
  ...
  objClass() {
    if (this.isPersisted()) {
      const objClass2 = this.getAttributeData("_obj_class");
      if (objClass2) return objClass2;
      throw new common/* ScrivitoError */.aS("Widget was deleted, possibly by another user.");
    }
...
;// ./scrivito_sdk/models/basic_attribute_content.ts
...
;// ./scrivito_sdk/models/all_sites_and_global.ts
...
;// ./scrivito_sdk/models/empty_scope.ts
...
;// ./scrivito_sdk/models/exclude_global.ts
...
;// ./scrivito_sdk/models/restrict_to_global.ts
...
;// ./scrivito_sdk/models/restrict_to_site_and_global.ts
...
;// ./scrivito_sdk/models/update_references.ts
...
;// ./scrivito_sdk/models/copy_obj_handler.ts
...
var obj_space_for = __webpack_require__(4476);
;// ./scrivito_sdk/models/restrict_to_obj_class.ts
...
;// ./scrivito_sdk/models/get_placement_modification_infos.ts
...
;// ./scrivito_sdk/models/content_versions.ts
...
function countVersionsOnAllSites(obj) {
  const contentId = obj.contentId();
...
;// ./scrivito_sdk/models/restrict_to_content.ts
...
;// ./scrivito_sdk/models/workspace.ts
...
;// ./scrivito_sdk/models/get_details_page_for_data_param.ts
...
;// ./scrivito_sdk/models/data_identifier.ts
...
;// ./scrivito_sdk/models/is_wrapping_basic_content.ts
...
;// ./scrivito_sdk/models/comparison_from_published.ts
...
;// ./scrivito_sdk/models/published_space.ts
...
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2198);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var scrivito_sdk_react_data_context_container__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7723);
/* harmony import */ var scrivito_sdk_react_hooks_use_data_locator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8857);
/* harmony import */ var scrivito_sdk_react_connect__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5841);
...
const AutomaticDataContext = (0,scrivito_sdk_react_connect__WEBPACK_IMPORTED_MODULE_3__/* .connect */ .Ng)(function AutomaticDataContext2({
  ...
  return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(scrivito_sdk_react_data_context_container__WEBPACK_IMPORTED_MODULE_1__/* .PushOntoDataStack */ .NN, { data: dataScope, children });
});
...
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2198);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(629);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var scrivito_sdk_app_support_editing_context__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1457);
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6687);
/* harmony import */ var scrivito_sdk_react_component_registry__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(9242);
/* harmony import */ var scrivito_sdk_react_components_automatic_data_context__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(4116);
/* harmony import */ var scrivito_sdk_react_components_widget_tag__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(8581);
/* harmony import */ var scrivito_sdk_react_connect_and_memoize__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(994);
/* harmony import */ var scrivito_sdk_realm__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(687);
...
const WidgetContent = (0,scrivito_sdk_react_connect_and_memoize__WEBPACK_IMPORTED_MODULE_7__/* .connectAndMemoize */ .M)(function WidgetContent2({
  fieldType,
  ...
  const widgetComponent = (0,scrivito_sdk_react_component_registry__WEBPACK_IMPORTED_MODULE_4__/* .getComponentForAppClass */ .cb)(
    widgetClass
  );
...
class WidgetContentErrorBoundary extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    if (this.state.hasError) {
      if ((0,scrivito_sdk_app_support_editing_context__WEBPACK_IMPORTED_MODULE_2__/* .isInPlaceEditingActive */ .HD)()) {
        return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(scrivito_sdk_react_components_widget_tag__WEBPACK_IMPORTED_MODULE_6__/* .WidgetTag */ .z, { children: /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { className: "content_error", children: "Widget could not be rendered due to application error." }) });
      }
      return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(scrivito_sdk_react_components_widget_tag__WEBPACK_IMPORTED_MODULE_6__/* .WidgetTag */ .z, {});
    }
    return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(AppWidgetWrapper, __spreadValues({}, this.props));
  }
}
function AppWidgetWrapper({
  ...
  if (widgetProps == null ? void 0 : widgetProps.hasOwnProperty("widget")) {
    (0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_3__/* .throwNextTick */ .JL)(
      new scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_3__/* .ArgumentError */ .c1(
        'The prop "widget" is not allowed inside "widgetProps"'
      )
    );
  }
  const widgetComponentProps = __spreadProps(__spreadValues({}, widgetProps), {
    widget: (0,scrivito_sdk_realm__WEBPACK_IMPORTED_MODULE_8__/* .wrapInAppClass */ .Dy)(widget)
  });
  return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(scrivito_sdk_react_components_automatic_data_context__WEBPACK_IMPORTED_MODULE_5__/* .AutomaticDataContext */ .T, { content: widget, children: (0,react__WEBPACK_IMPORTED_MODULE_1__.createElement)(
    widgetComponent,
    widgetComponentProps
  ) });
}
const WidgetTagContext = (0,react__WEBPACK_IMPORTED_MODULE_1__.createContext)({});
...
const Context = (0,react__WEBPACK_IMPORTED_MODULE_1__.createContext)("outermostLayout");
const CurrentEditableArea = (0,scrivito_sdk_react_connect__WEBPACK_IMPORTED_MODULE_3__/* .connect */ .Ng)(function CurrentEditableArea2({
  value,
  children
}) {
  if ((0,scrivito_sdk_app_support_editing_context__WEBPACK_IMPORTED_MODULE_2__/* .isInPlaceEditingActive */ .HD)()) {
    return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Context.Provider, { value: typeof value === "function" ? value() : value, children });
  }
...
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2198);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var scrivito_sdk_import_from__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(279);
/* harmony import */ var scrivito_sdk_react_connect__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5841);
...
const WidgetTag = (0,scrivito_sdk_react_connect__WEBPACK_IMPORTED_MODULE_2__/* .connect */ .Ng)(
  function WidgetTag2(props) {
    ...
    if (!WidgetTagWithEditing) return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(Tag, __spreadValues({}, otherProps));
    return /* @__PURE__ */ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(WidgetTagWithEditing, __spreadValues({ tag: Tag }, otherProps));
  }
);
...
/* harmony export */ });
/* harmony import */ var scrivito_sdk_react_memo__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2279);
/* harmony import */ var scrivito_sdk_react_connect__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5841);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6687);
/* harmony import */ var scrivito_sdk_data_integration__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1871);
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5436);
/* harmony import */ var scrivito_sdk_realm__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(687);
...
const DataStackReactContext = (0,react__WEBPACK_IMPORTED_MODULE_1__.createContext)(
  void 0
);
function useDataContextContainer() {
  return (0,react__WEBPACK_IMPORTED_MODULE_1__.useContext)(DataStackReactContext);
}
function usePlaceholders() {
  var _a;
  return (_a = (0,react__WEBPACK_IMPORTED_MODULE_1__.useContext)(DataStackReactContext)) == null ? void 0 : _a.placeholders;
}
function useDataStack() {
  var _a;
  return (_a = (0,react__WEBPACK_IMPORTED_MODULE_1__.useContext)(DataStackReactContext)) == null ? void 0 : _a.dataStack;
}
function useDataStackOrThrow() {
  var _a;
  const dataStack = (_a = (0,react__WEBPACK_IMPORTED_MODULE_1__.useContext)(DataStackReactContext)) == null ? void 0 : _a.dataStack;
  if (!dataStack) {
...
function useClosestMultiItemElement(dataClassName) {
  var _a, _b;
  return (_b = (_a = (0,react__WEBPACK_IMPORTED_MODULE_1__.useContext)(DataStackReactContext)) == null ? void 0 : _a.dataStack) == null ? void 0 : _b.find(
    (element) => {
      return (0,scrivito_sdk_data_integration__WEBPACK_IMPORTED_MODULE_3__/* .isMultiItemDataScopePojo */ .VI)(element) && (dataClassName === void 0 || element._class === dataClassName);
    }
  );
}
function useClosestSingleItemElement(dataClassName) {
  ...
  return (_b = (_a = (0,react__WEBPACK_IMPORTED_MODULE_1__.useContext)(DataStackReactContext)) == null ? void 0 : _a.dataStack) == null ? void 0 : _b.find(
    (element) => {
      return (0,scrivito_sdk_data_integration__WEBPACK_IMPORTED_MODULE_3__/* .isSingleItemElement */ .Uq)(element) && (dataClassName === void 0 && !("isBackground" in element) || element._class === dataClassName);
    }
  );
}
function PushOntoDataStack({
  ...
  function computeStackElement() {
    if (data instanceof scrivito_sdk_data_integration__WEBPACK_IMPORTED_MODULE_3__/* .DataItem */ .sO) {
      return {
        _class: (0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .assumeString */ .uV)(data.dataClassName()),
        _id: data.id()
      };
    }
    return data instanceof scrivito_sdk_data_integration__WEBPACK_IMPORTED_MODULE_3__/* .DataScope */ .bq ? data.toPojo() : data;
  }
}
function ProvidePlaceholders({
  ...
  function computeValue() {
    if (source instanceof scrivito_sdk_data_integration__WEBPACK_IMPORTED_MODULE_3__/* .DataScope */ .bq) {
      return {
        dataStack: [source.toPojo(), ...dataStack],
        placeholders: {}
      };
    }
    const placeholders = computePlaceholders((0,scrivito_sdk_realm__WEBPACK_IMPORTED_MODULE_5__/* .unwrapAppClass */ .zo)(source));
...
function computePlaceholders(from) {
  if (from instanceof scrivito_sdk_data_integration__WEBPACK_IMPORTED_MODULE_3__/* .DataItem */ .sO) {
    return (0,scrivito_sdk_data_integration__WEBPACK_IMPORTED_MODULE_3__/* .dataItemToDataContext */ .A_)(from);
  }
  if (from instanceof scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_4__/* .BasicObj */ .kI) {
    return (0,scrivito_sdk_data_integration__WEBPACK_IMPORTED_MODULE_3__/* .basicObjToDataContext */ .gk)(from);
  }
  return from;
}
...
/* harmony export */ });
/* harmony import */ var scrivito_sdk_data_integration__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1871);
/* harmony import */ var scrivito_sdk_react_data_context_container__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7723);
...
// EXTERNAL MODULE: ./scrivito_sdk/app_support/ui_adapter.ts
var ui_adapter = __webpack_require__(1391);
;// ./scrivito_sdk/app_support/editable_area.ts
...
var current_editable_area = __webpack_require__(8560);
// EXTERNAL MODULE: ./scrivito_sdk/react/edit_as_page_content_context.ts
var edit_as_page_content_context = __webpack_require__(3962);
// EXTERNAL MODULE: ./scrivito_sdk/react/in_place_editing_enabled_context.ts
var in_place_editing_enabled_context = __webpack_require__(5159);
;// ./scrivito_sdk/react/hooks/use_in_place_editing.ts
...
function useInPlaceEditing(page) {
  ...
  const inPlaceEditingEnabled = (0,external_react_.useContext)(in_place_editing_enabled_context/* InPlaceEditingEnabledContext */.F);
  const editAsPageContent = (0,external_react_.useContext)(edit_as_page_content_context/* EditAsPageContentContext */.m);
...
const InPlaceEditingEnabledContext = (0,react__WEBPACK_IMPORTED_MODULE_0__.createContext)(true);
...
var get_class_name = __webpack_require__(7886);
// EXTERNAL MODULE: ./scrivito_sdk/react/component_registry.ts
var component_registry = __webpack_require__(9242);
// EXTERNAL MODULE: ./scrivito_sdk/react/components/widget_tag.tsx
var widget_tag = __webpack_require__(8581);
// EXTERNAL MODULE: ./scrivito_sdk/react/memo.ts
var memo = __webpack_require__(2279);
// EXTERNAL MODULE: ./scrivito_sdk/react_connect/index.ts + 7 modules
var react_connect = __webpack_require__(5841);
;// ./scrivito_sdk/react/provide_component.ts
...
function wrapInWidgetTag(rendered) {
  return (0,react_connect/* getElementType */.BK)(rendered) === widget_tag/* WidgetTag */.z ? rendered : (0,external_react_.createElement)(widget_tag/* WidgetTag */.z, { children: rendered });
}
...
var connect_and_memoize = __webpack_require__(994);
// EXTERNAL MODULE: ./scrivito_sdk/realm/index.ts + 21 modules
var realm = __webpack_require__(687);
;// ./scrivito_sdk/react/provide_layout_component.ts
...
;// ./scrivito_sdk/react/provide_data_error_component.ts
...
;// ./scrivito_sdk/react/register_component.ts
...
var jsx_runtime_ = __webpack_require__(2198);
;// ./scrivito_sdk/app_support/decode/draw_img_on_canvas.ts
...
;// ./scrivito_sdk/app_support/decode/get_css_canvas_context.ts
...
;// ./scrivito_sdk/app_support/decode/decode_or_load_img.ts
...
;// ./scrivito_sdk/app_support/decode_background_image.ts
...
;// ./scrivito_sdk/app_support/background_image_decoder.ts
...
class BackgroundImageDecoder {
  ...
  ensureLoading(imageUrl) {
    ...
    const promise = (() => background_image_decoder_async(this, null, function* () {
      const { decodedBackgroundUrl, clear } = yield decodeBackgroundImage(imageUrl);
...
var scale_down_binary = __webpack_require__(9008);
// EXTERNAL MODULE: ./scrivito_sdk/models/index.ts + 42 modules
var models = __webpack_require__(5436);
;// ./scrivito_sdk/react/components/background_image_tag.tsx
...
const BackgroundImageTag = (0,react_connect/* connect */.Ng)(function BackgroundImageTag2(_a) {
  ...
  const [, forceUpdate] = (0,external_react_.useReducer)((x) => x + 1, 0);
  const decoder = (0,external_react_.useMemo)(
...
var data_context_container = __webpack_require__(7723);
;// ./scrivito_sdk/react/components/link_tag.tsx
...
const LinkTag = (0,react_connect/* connect */.Ng)(function LinkTag2(props) {
  ...
  function getChildren() {
    ...
    if (props.to instanceof realm/* Link */.N_) return props.to.title();
  }
  function getHref() {
    var _a2;
...
;// ./scrivito_sdk/react/components/child_list_tag/child_item.tsx
...
const ChildItem = (0,react_connect/* connect */.Ng)(function ChildItem2(props) {
  ...
  return /* @__PURE__ */ (0,jsx_runtime_.jsx)("li", { children: /* @__PURE__ */ (0,jsx_runtime_.jsx)(LinkTag, { to: appObj, children: props.child.get("title", "string") }) });
});
ChildItem.displayName = "Scrivito.ChildListTag.ChildItem";

;// ./scrivito_sdk/react/with_display_name.ts
...
;// ./scrivito_sdk/react/components/child_list_tag.tsx

var child_list_tag_defProp = Object.defineProperty;
var child_list_tag_defProps = Object.defineProperties;
var child_list_tag_getOwnPropDescs = Object.getOwnPropertyDescriptors;
...
var child_list_tag_spreadProps = (a, b) => child_list_tag_defProps(a, child_list_tag_getOwnPropDescs(b));
...
const ChildListTag = (0,react_connect/* connect */.Ng)(
  withDisplayName("Scrivito.ChildListTag", (props) => {
    ...
    const childComponents = orderedChildren.map((child) => /* @__PURE__ */ (0,jsx_runtime_.jsx)(ChildItem, { child, renderChild }, child.id()));
    const ChildListTagWithEditing = (0,import_from/* importFrom */.eW)(
      "reactEditing",
      "ChildListTagWithEditing"
    );
    if (!ChildListTagWithEditing) {
      return /* @__PURE__ */ (0,jsx_runtime_.jsx)(Tag, child_list_tag_spreadProps(child_list_tag_spreadValues({}, otherProps), { children: childComponents }));
    }
    return /* @__PURE__ */ (0,jsx_runtime_.jsx)(
      ChildListTagWithEditing,
      child_list_tag_spreadProps(child_list_tag_spreadValues({
        tag: Tag,
        basicParent
      }, otherProps), {
...
var editing_context = __webpack_require__(1457);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/get_comparison_range.ts
var get_comparison_range = __webpack_require__(3459);
// EXTERNAL MODULE: external "lodash-es/escape"
var escape_ = __webpack_require__(3444);
var escape_default = /*#__PURE__*/__webpack_require__.n(escape_);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/browser_location.ts
...
// EXTERNAL MODULE: ./scrivito_sdk/app_support/routing.ts + 2 modules
var routing = __webpack_require__(1446);
;// ./scrivito_sdk/app_support/find_click_target.ts
...
function findLinkTarget(currentNode, outermostNode, isModifier) {
  ...
  if (isHTMLAnchorElement(currentNode)) {
    ...
    return { openInCurrentWindow: (0,common/* toUrlResource */.B6)(new URL(url)) };
  }
...
var replace_internal_links = __webpack_require__(9063);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/scroll_into_view.ts
var scroll_into_view = __webpack_require__(3973);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/can_edit.ts
var can_edit = __webpack_require__(9162);
// EXTERNAL MODULE: ./scrivito_sdk/react/components/content_tag/widget_content.tsx
var widget_content = __webpack_require__(2747);
// EXTERNAL MODULE: ./scrivito_sdk/react/hooks/use_in_place_editing.ts + 1 modules
var use_in_place_editing = __webpack_require__(4861);
;// ./scrivito_sdk/react/components/content_tag/widget_value.tsx
...
const WidgetValueContent = (0,react_connect/* connect */.Ng)(function WidgetValueContent2({
  ...
  return WidgetPlaceholder ? /* @__PURE__ */ (0,jsx_runtime_.jsx)(WidgetPlaceholder, { field }) : null;
});

;// ./scrivito_sdk/react/components/content_tag/widgetlist_value.tsx
...
const WidgetlistValueContentForComparison = (0,react_connect/* connect */.Ng)(
  function WidgetlistValueContentForComparison2({
    ...
    const { placementModification: containerPlacementModification } = (0,external_react_.useContext)(widget_content/* WidgetTagContext */.K);
    const renderingDepth = (0,external_react_.useContext)(WidgetlistRenderingDepth) + 1;
    ...
    return /* @__PURE__ */ (0,jsx_runtime_.jsx)(WidgetlistRenderingDepth.Provider, { value: renderingDepth, children: infos.map((info) => {
      return /* @__PURE__ */ (0,jsx_runtime_.jsx)(
        widget_content/* WidgetContent */.i,
        {
          widget: info.widget,
        ...
        calculateKey(info.widget.id(), info.modification)
      );
    }) });
...
const WidgetlistRenderingDepth = (0,external_react_.createContext)(0);
const WidgetlistValueContent = (0,react_connect/* connect */.Ng)(function WidgetlistValueContent2({
  ...
  const widgets = field.get();
  if (widgets.length) {
    return /* @__PURE__ */ (0,jsx_runtime_.jsx)(jsx_runtime_.Fragment, { children: widgets.map((widget) => /* @__PURE__ */ (0,jsx_runtime_.jsx)(
      widget_content/* WidgetContent */.i,
      {
        widget,
        widgetProps,
  ...
  return WidgetlistPlaceholder ? /* @__PURE__ */ (0,jsx_runtime_.jsx)(WidgetlistPlaceholder, { field }) : null;
});

// EXTERNAL MODULE: ./scrivito_sdk/react/handle_ref_assignment.ts
var handle_ref_assignment = __webpack_require__(1881);
;// ./scrivito_sdk/react/components/content_tag/attribute_value.tsx
...
;// ./scrivito_sdk/react/components/content_tag.tsx
...
const ContentTagWithElementCallback = (0,react_connect/* connect */.Ng)(function ContentTagWithElementCallback2(_a) {
  ...
  const attributeValue = /* @__PURE__ */ (0,jsx_runtime_.jsx)(AttributeValueComponent, content_tag_spreadValues({}, contentTagProps));
  ...
  return /* @__PURE__ */ (0,jsx_runtime_.jsx)(data_context_container/* ProvidePlaceholders */.sT, { source: dataContext, children: attributeValue });
});
...
var automatic_data_context = __webpack_require__(4116);
// EXTERNAL MODULE: ./scrivito_sdk/react/components/current_editable_area.tsx
var current_editable_area = __webpack_require__(8560);
;// ./scrivito_sdk/react/scroll_window.ts
...
;// ./scrivito_sdk/react/components/page_scroll.tsx
...
;// ./scrivito_sdk/react/get_component_for_page_class.ts
...
;// ./scrivito_sdk/react/components/current_page/details_page_data_context.tsx
...
const DetailsPageDataContext = (0,react_connect/* connect */.Ng)(function DetailsPageDataContext2({
  ...
  return /* @__PURE__ */ (0,jsx_runtime_.jsx)(data_context_container/* ProvidePlaceholders */.sT, { source: dataContext, children });
});
function renderDataError() {
  const DataErrorComponent = (0,component_registry/* getDataErrorComponent */.Ey)();
  return DataErrorComponent ? /* @__PURE__ */ (0,jsx_runtime_.jsx)(DataErrorComponent, {}) : /* @__PURE__ */ (0,jsx_runtime_.jsx)(jsx_runtime_.Fragment, { children: "Data Not Found" });
}

;// ./scrivito_sdk/react/components/current_page/page_data_context.tsx
...
var get_current_page_id = __webpack_require__(5553);
;// ./scrivito_sdk/react/components/current_page/use_layout.tsx
...
const LayoutIndexContext = (0,external_react_.createContext)(0);
function useLayout(page, params) {
  const layoutIndex = (0,external_react_.useContext)(LayoutIndexContext);
  ...
  return /* @__PURE__ */ (0,jsx_runtime_.jsx)(PageLayout, { page: nextPage, params, layoutIndex });
}
...
const PageLayout = (0,react_connect/* connect */.Ng)(function PageLayout2({
  ...
  return /* @__PURE__ */ (0,jsx_runtime_.jsx)(PageDataContext, { page, children: /* @__PURE__ */ (0,jsx_runtime_.jsx)(DetailsPageDataContext, { page, params, children: /* @__PURE__ */ (0,jsx_runtime_.jsx)(current_editable_area/* CurrentEditableArea */.Z, { value: calculateCurrentEditableArea, children: /* @__PURE__ */ (0,jsx_runtime_.jsx)(LayoutIndexContext.Provider, { value: layoutIndex + 1, children: Component ? /* @__PURE__ */ (0,jsx_runtime_.jsx)(Component, { page: (0,realm/* wrapInAppClass */.Dy)(page) }) : /* @__PURE__ */ (0,jsx_runtime_.jsx)(CurrentPage, {}) }) }) }) });
...
;// ./scrivito_sdk/react/components/current_page.tsx
...
const CurrentPageWithLayout = (0,react_connect/* connect */.Ng)(function CurrentPageWithLayout2({
  ...
  return /* @__PURE__ */ (0,jsx_runtime_.jsx)(PageDataContext, { page: currentPage, children: /* @__PURE__ */ (0,jsx_runtime_.jsx)(DetailsPageDataContext, { page: currentPage, params, children: /* @__PURE__ */ (0,jsx_runtime_.jsx)(automatic_data_context/* AutomaticDataContext */.T, { content: currentPage, children: /* @__PURE__ */ (0,jsx_runtime_.jsxs)(current_editable_area/* CurrentEditableArea */.Z, { value: "currentPage", children: [
    /* @__PURE__ */ (0,jsx_runtime_.jsx)(PageScroll, { navigationState }),
    PageComponent && /* @__PURE__ */ (0,jsx_runtime_.jsx)(
      PageComponent,
      {
...
;// ./scrivito_sdk/react/components/extensions.tsx
...
function Extensions() {
  const [htmlElement, setHtmlElement] = (0,external_react_.useState)(null);
  const [reactElement, setReactElement] = (0,external_react_.useState)(
    null
  );
  (0,external_react_.useEffect)(() => {
...
// EXTERNAL MODULE: ./scrivito_sdk/app_support/configure.ts + 2 modules
var configure = __webpack_require__(2469);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/get_instance_id.ts
var get_instance_id = __webpack_require__(5639);
;// ./scrivito_sdk/react/components/get_ui_screen_url.ts




function getUiScreenUrl(screen, appUrl) {
  const configuration = (0,configure/* tryGetConfiguration */.qu)();
  if (!configuration) {
    throw new common/* ScrivitoError */.aS("must call 'Scrivito.configure' beforehand");
  }
  const adoptUi = configuration.adoptUi;
  const uiDomain = typeof adoptUi === "string" ? adoptUi : DEFAULT_UI_DOMAIN;
  return `${uiDomain}/${(0,get_instance_id/* getInstanceId */.z)()}/${screen}~${appUrl != null ? appUrl : ""}`;
}
const DEFAULT_UI_DOMAIN = "https://web-builder.justrelate.com";

;// ./scrivito_sdk/react/components/dam_frame.tsx
...
;// ./scrivito_sdk/react/components/dam.tsx



function Dam({ unstable_appUrl: appUrl }) {
  return /* @__PURE__ */ (0,jsx_runtime_.jsx)(DamFrame, { screen: "browseContent", appUrl });
}

// EXTERNAL MODULE: ./scrivito_sdk/app_ui_protocol/index.ts + 4 modules
var app_ui_protocol = __webpack_require__(8891);
// EXTERNAL MODULE: ./scrivito_sdk/bridge/index.ts + 17 modules
var bridge = __webpack_require__(4899);
;// ./scrivito_sdk/app_support/observe_selected_image.ts

var observe_selected_image_async = (__this, __arguments, generator) => {
  return new Promise((resolve, reject) => {
    var fulfilled = (value) => {
      try {
        step(generator.next(value));
...
function observeSelectedImage(isFromSource, onSelect) {
  return (0,bridge/* postMessageLinkFor */.TB)(window).incomingMessages.filter((event) => isFromSource(event.remoteWindow)).map((event) => event.data).filter(app_ui_protocol/* isSelectedObjMessage */.aG).takeOne().subscribe((message) => observe_selected_image_async(null, null, function* () {
    const objId = message.objId;
    const image = objId ? yield (0,loadable/* load */.Hh)(() => realm/* Obj */.OH.onAllSites().get(objId)) : null;
    onSelect(image);
  }));
}

;// ./scrivito_sdk/react/components/dam_image_selector.tsx





function DamImageSelector({
  onSelect,
  unstable_appUrl: appUrl
}) {
  const iframeRef = (0,external_react_.useRef)(null);
  const onSelectRef = (0,external_react_.useRef)(onSelect);
  onSelectRef.current = onSelect;
  const isFromIframe = (0,external_react_.useCallback)(
    (source) => {
      var _a;
      return source === ((_a = iframeRef.current) == null ? void 0 : _a.contentWindow);
    },
    []
  );
  (0,external_react_.useEffect)(() => {
    const subscription = observeSelectedImage(
      isFromIframe,
      (image) => onSelectRef.current(image)
    );
    return () => subscription.unsubscribe();
  }, [isFromIframe]);
  return /* @__PURE__ */ (0,jsx_runtime_.jsx)(DamFrame, { screen: "selectImage", appUrl, iframeRef });
}

;// ./scrivito_sdk/app_support/decode_image.ts
...
;// ./scrivito_sdk/app_support/image_decoder.ts
...
;// ./scrivito_sdk/react/image_placeholder.ts
...
;// ./scrivito_sdk/react/components/image_tag.tsx
...
const ImageTag = (0,react_connect/* connect */.Ng)(function ImageTag2(_a) {
  ...
  const [isLazy, setIsLazy] = (0,external_react_.useState)(htmlOptions.loading === "lazy");
  ...
  const setEagerIfComplete = (0,external_react_.useCallback)((node) => {
    if (isComplete(node)) setIsLazy(false);
  }, []);
  const [, setImageDecoderUpdateCounter] = (0,external_react_.useState)(0);
  const decoder = (0,external_react_.useMemo)(
  ...
  if (content instanceof models/* Binary */.yI) {
    ...
    return fullWidth === null ? null : /* @__PURE__ */ (0,jsx_runtime_.jsx)(
      "img",
...
// EXTERNAL MODULE: ./scrivito_sdk/react/in_place_editing_enabled_context.ts
var in_place_editing_enabled_context = __webpack_require__(5159);
;// ./scrivito_sdk/react/components/in_place_editing.tsx
...
function createInPlaceEditingToggle({ value }) {
  return ({ children }) => (0,editing_context/* isInPlaceEditingActive */.HD)() ? /* @__PURE__ */ (0,jsx_runtime_.jsx)(
    in_place_editing_enabled_context/* InPlaceEditingEnabledContext */.F.Provider,
    {
      value,
      children
    }
  ) : /* @__PURE__ */ (0,jsx_runtime_.jsx)(jsx_runtime_.Fragment, { children });
}

// EXTERNAL MODULE: ./scrivito_sdk/react/edit_as_page_content_context.ts
var edit_as_page_content_context = __webpack_require__(3962);
;// ./scrivito_sdk/react/components/in_place_edit_as_page_content.tsx
...
const InPlaceEditAsPageContent = ({
  children
}) => (0,editing_context/* isInPlaceEditingActive */.HD)() ? /* @__PURE__ */ (0,jsx_runtime_.jsx)(edit_as_page_content_context/* EditAsPageContentContext */.m.Provider, { value: true, children }) : /* @__PURE__ */ (0,jsx_runtime_.jsx)(jsx_runtime_.Fragment, { children });

;// ./scrivito_sdk/react/components/not_found_error_page.tsx
...
const NotFoundErrorPage = (0,react_connect/* connect */.Ng)(
  function NotFoundErrorPage2({ children }) {
    ...
    return /* @__PURE__ */ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, { children: [
      /* @__PURE__ */ (0,jsx_runtime_.jsx)(PageScroll, { navigationState }),
      children || /* @__PURE__ */ (0,jsx_runtime_.jsxs)("div", { children: [
        /* @__PURE__ */ (0,jsx_runtime_.jsx)("h1", { children: "The page you were looking for doesn't exist." }),
        /* @__PURE__ */ (0,jsx_runtime_.jsx)("p", { children: "You may have mistyped the address or the page may have moved." })
      ] })
    ] });
  }
);
...
;// ./scrivito_sdk/react/hooks/use_data.ts
...
;// ./scrivito_sdk/react/hooks/use_data_item.ts
...
var use_data_locator = __webpack_require__(8857);
;// ./scrivito_sdk/react/hooks/use_data_scope.ts
...
;// ./scrivito_sdk/react/hooks/use_attribute_definition.ts
...
var url_for = __webpack_require__(1368);
;// ./scrivito_sdk/react/hooks/use_url_for.ts
...
;// ./scrivito_sdk/react/hooks/use_resolved_value.ts
...
var has_component = __webpack_require__(4825);
;// ./scrivito_sdk/react/hooks/use_content.ts
...
var react_has_component = __webpack_require__(93);
;// ./scrivito_sdk/react/index.ts
...
// EXTERNAL MODULE: ./scrivito_sdk/loadable/index.ts + 28 modules
var loadable = __webpack_require__(6084);
;// ./scrivito_sdk/react_connect/display_name_from_component.ts

function displayNameFromComponent(component) {
  return component.displayName || component.name;
}

;// ./scrivito_sdk/react_connect/get_element_type.ts
...
;// ./scrivito_sdk/react_connect/hooks/use_force_update.ts


function useForceUpdate() {
  const [, setCounter] = (0,external_react_.useState)(0);
  return () => setCounter((counter) => counter + 1);
}

;// ./scrivito_sdk/react_connect/is_class_component.ts

function isClassComponent(component) {
  return typeof component === "function" && component.prototype && component.prototype.isReactComponent;
}

;// ./scrivito_sdk/react_connect/loading_monitor.ts
...
// EXTERNAL MODULE: ./scrivito_sdk/state/index.ts + 13 modules
var state = __webpack_require__(6324);
;// ./scrivito_sdk/react_connect/connect.tsx
...
function connectClassComponent(classComponent, options) {
  ...
  const connectedComponent = (_a = class extends classComponent {
    constructor(props) {
      ...
      const _scrivitoRenderWhileLoading = initialLoaderComponent ? () => (0,external_react_.createElement)(initialLoaderComponent, this.props) : this._scrivitoRenderWhileLoading;
...
function connectFunctionComponent(functionalComponent, options) {
  ...
  const connectedComponent = (props) => (
    ...
    useConnectedRender(
      ...
      initialLoaderComponent ? () => (0,external_react_.createElement)(initialLoaderComponent, props) : void 0
    )
  );
...
function useConnectedRender(originalRender, initialLoaderComponent) {
  ...
  const connectorRef = (0,external_react_.useRef)(void 0);
...
const ReactConnectContext = (0,external_react_.createContext)({
  hierarchyLevel: 0
});
class ComponentConnector {
  ...
  updateLoaderComponent(loaderComponent) {
  ...
  render(originalRender) {
    ...
    return /* @__PURE__ */ (0,jsx_runtime_.jsx)(ReactConnectContext.Consumer, __spreadProps(__spreadValues({}, forwardElementTypeProps(reactElement)), { children: (context) => /* @__PURE__ */ (0,jsx_runtime_.jsx)(
...
;// ./scrivito_sdk/react_connect/components/hibernation.tsx
...
/* unused harmony import specifier */ var BehaviorSubject;
/* unused harmony import specifier */ var hibernation_ReactConnectContext;
...
const Hibernation = ({
  ...
  const context = useContext(hibernation_ReactConnectContext);
  ...
  const awakenessRef = useRef(void 0);
  ...
  return /* @__PURE__ */ jsx(
    hibernation_ReactConnectContext.Provider,
    {
...
;// ./scrivito_sdk/react_connect/index.ts
...
class BasicSiteContext {
  ...
  create(attributes = {}) {
    ...
    const attributesForCreate = prepareAttributesForCreate(
      attributes,
      objClassName,
      // eslint-disable-next-line @typescript-eslint/no-non-null-assertion -- objClassNameForCreate above ensures that it's a subclass of Obj
...
;// ./scrivito_sdk/realm/assert_valid_extract_text_attributes.ts
...
;// ./scrivito_sdk/realm/schema_from_basic_obj_or_widget.ts
...
;// ./scrivito_sdk/realm/is_binary_basic_obj.ts
...
;// ./scrivito_sdk/realm/is_obj_class.ts
...
// EXTERNAL MODULE: ./scrivito_sdk/common/index.ts + 65 modules
var common = __webpack_require__(6687);
;// ./scrivito_sdk/state/primitive_value.ts
...
;// ./scrivito_sdk/state/conservative_update.ts
...
;// ./scrivito_sdk/state/copy_on_write_store.ts
...
;// ./scrivito_sdk/state/subscriber_set.ts
...
;// ./scrivito_sdk/state/subscribers.ts
...
;// ./scrivito_sdk/state/track_state_access.ts
...
;// ./scrivito_sdk/state/state_tree.ts
...
;// ./scrivito_sdk/state/global_state.ts
...
;// ./scrivito_sdk/state/batched_state_updater.ts
...
;// ./scrivito_sdk/state/observe_sync.ts
...
;// ./scrivito_sdk/state/create_state_container.ts
...
module.exports = __WEBPACK_EXTERNAL_MODULE__5769__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__2198__;
...
__webpack_require__.d(__webpack_exports__, {
  ...
  configure: () => (/* reexport */ configure/* configure */.jK),
  ...
  currentUser: () => (/* reexport */ current_user/* currentUser */.Ny),
  ...
  ensureUserIsLoggedIn: () => (/* reexport */ current_user/* ensureUserIsLoggedIn */.z5),
  ...
  getInstanceId: () => (/* reexport */ get_instance_id/* getInstanceId */.z),
  ...
  isUserLoggedIn: () => (/* reexport */ current_user/* isUserLoggedIn */.x3),
  load: () => (/* reexport */ loadable/* load */.Hh),
  logout: () => (/* reexport */ current_user/* logout */.ri),
  ...
  provideDataService: () => (/* reexport */ data_integration/* provideDataService */.rz),
  ...
  setVisitorIdToken: () => (/* reexport */ visitor_authentication/* setVisitorIdToken */.LQ),
  uiContext: () => (/* reexport */ uiContext),
  unstable_Dam: () => (/* reexport */ react/* Dam */.ZO),
  unstable_DamImageSelector: () => (/* reexport */ react/* DamImageSelector */.Nl),
  unstable_deleteOfflineStore: () => (/* reexport */ offline_mode/* deleteOfflineStore */.C1),
  unstable_enableOfflineStore: () => (/* reexport */ loadable/* enableOfflineStore */.a9),
  unstable_enterOfflineMode: () => (/* reexport */ offline_mode/* enterOfflineMode */.Dk),
  unstable_isInOfflineMode: () => (/* reexport */ offline_mode/* isInOfflineMode */.uX),
  unstable_isOfflineStoreEnabled: () => (/* reexport */ loadable/* isOfflineStoreEnabled */.Em),
  unstable_leaveOfflineMode: () => (/* reexport */ offline_mode/* leaveOfflineMode */.gV),
  ...
  uploadFile: () => (/* reexport */ client/* uploadFile */.QM),
  ...
  useIsInPlaceEditingActive: () => (/* reexport */ useIsInPlaceEditingActive),
...
// EXTERNAL MODULE: ./scrivito_sdk/state/index.ts + 13 modules
var state = __webpack_require__(6324);
;// ./scrivito_sdk/app_support/canonical_url.ts
...
function switchToCanonicalUrl(pageData) {
  return __async(this, null, function* () {
    ...
    browser_location/* replace */.HC((0,common/* toUrlResource */.B6)(locationUrl));
  });
}
...
// EXTERNAL MODULE: ./scrivito_sdk/app_support/current_app_space.ts
var current_app_space = __webpack_require__(2945);
;// ./scrivito_sdk/app_support/current_language.ts
...
var document_title = __webpack_require__(4317);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/editing_context.ts
var editing_context = __webpack_require__(1457);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/configure.ts + 2 modules
var configure = __webpack_require__(2469);
;// ./scrivito_sdk/app_support/trusted_ui_origins.ts
...
function checkIfTrustedOrigin(origin) {
  return trusted_ui_origins_async(this, null, function* () {
    var _a, _b;
    if (origin === window.location.origin || originMatches(origin, "https://*.scrivito.com") || originMatches(origin, "https://*.justrelate.com")) {
      return true;
    }
    const configuration = yield (0,configure/* getConfiguration */.D0)();
    const adoptUi = configuration.adoptUi;
...
// EXTERNAL MODULE: ./scrivito_sdk/bridge/index.ts + 17 modules
var bridge = __webpack_require__(4899);
;// ./scrivito_sdk/app_support/establish_ui_connection.ts
...
;// ./scrivito_sdk/app_support/extract_text/child_node_list_to_array.ts

function childNodeListToArray(childNodes) {
  return Array.prototype.slice.call(childNodes);
}

;// ./scrivito_sdk/app_support/extract_text/node_to_text.ts
...
;// ./scrivito_sdk/app_support/extract_text/string_to_html_element.ts
...
;// ./scrivito_sdk/app_support/extract_text/html_to_text_for_browser.ts
...
;// ./scrivito_sdk/app_support/extract_text/remove_html_tags.ts
...
var initialize_content = __webpack_require__(9909);
;// ./scrivito_sdk/app_support/load_editing_support.ts
...
function loadEditingSupport() {
  return load_editing_support_async(this, null, function* () {
    yield (0,asset_url_base/* assetLoadingReady */.KO)();
    return __webpack_require__.e(/* import() */ 723).then(__webpack_require__.bind(__webpack_require__, 8403));
  });
}

// EXTERNAL MODULE: ./scrivito_sdk/app_support/navigation_state.ts
var navigation_state = __webpack_require__(2993);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/offline_mode.ts
var offline_mode = __webpack_require__(1226);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/ui_adapter.ts
var ui_adapter = __webpack_require__(1391);
// EXTERNAL MODULE: ./scrivito_sdk/data_integration/index.ts + 40 modules
var data_integration = __webpack_require__(1871);
;// ./scrivito_sdk/app_support/refetch_external_data_on_window_focus.ts
...
;// ./scrivito_sdk/app_support/app_url_for_redirect_to_cloud_ui.ts
...
function handleAdoptUi(configuration) {
  ...
  const tenant = (0,configure/* getConfiguredInstanceId */.r$)(configuration);
  if (adoptUi) {
...
// EXTERNAL MODULE: ./scrivito_sdk/realm/initial_content_registry.ts
var initial_content_registry = __webpack_require__(1645);
;// ./scrivito_sdk/initialize_sdk_for_browser.ts
...
function initializeSdk() {
  return initialize_sdk_for_browser_async(this, null, function* () {
    ...
    (0,asset_url_base/* initializeAssetUrlBase */.Pu)();
    ...
    init();
    (0,offline_mode/* initOfflineMode */.pM)();
...
// EXTERNAL MODULE: ./scrivito_sdk/app_support/get_instance_id.ts
var get_instance_id = __webpack_require__(5639);
;// ./scrivito_sdk/app_support/select_image_from_content_browser.ts
...
function selectImageFromContentBrowser() {
  return select_image_from_content_browser_async(this, null, function* () {
    ...
    const selectImageUrl = `${uiDomain}/${(0,get_instance_id/* getInstanceId */.z)()}/selectImage~`;
...
// EXTERNAL MODULE: ./scrivito_sdk/react/index.ts + 46 modules
var react = __webpack_require__(322);
// EXTERNAL MODULE: ./scrivito_sdk/react_connect/index.ts + 7 modules
var react_connect = __webpack_require__(5841);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/can_edit.ts
var can_edit = __webpack_require__(9162);
;// ./scrivito_sdk/app_support/can_write.ts
...
var configure_content_browser = __webpack_require__(5968);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/crop_aspect_ratios.ts
var crop_aspect_ratios = __webpack_require__(8457);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/configure_obj_class_for_content_type.ts
var configure_obj_class_for_content_type = __webpack_require__(8361);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/preview_sizes.ts
var preview_sizes = __webpack_require__(7720);
// EXTERNAL MODULE: ./scrivito_sdk/import_from.ts
var import_from = __webpack_require__(279);
;// ./scrivito_sdk/app_support/current_editor.ts
...
// EXTERNAL MODULE: ./scrivito_sdk/app_support/current_user.ts + 5 modules
var current_user = __webpack_require__(3225);
;// ./scrivito_sdk/app_support/current_workspace.ts
...
var menu = __webpack_require__(6556);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/menu/menu_registry.ts
var menu_registry = __webpack_require__(8214);
;// ./scrivito_sdk/app_support/extend_menu.ts
...
;// ./scrivito_sdk/app_support/extract_text/extract_collector.ts
...
;// ./scrivito_sdk/app_support/extract_text/extract_blob_text.ts
...
;// ./scrivito_sdk/app_support/extract_text/extract_widgetlist.ts
...
;// ./scrivito_sdk/app_support/extract_text/extract_attribute.ts
...
;// ./scrivito_sdk/app_support/extract_text/extract_text_from_basic_obj_or_widget.ts
...
;// ./scrivito_sdk/app_support/extract_text_from_basic_obj.ts
...
;// ./scrivito_sdk/app_support/extract_text.ts
...
;// ./scrivito_sdk/app_support/is_editor_logged_in.ts
...
// EXTERNAL MODULE: ./scrivito_sdk/react/hooks/use_in_place_editing.ts + 1 modules
var use_in_place_editing = __webpack_require__(4861);
;// ./scrivito_sdk/react/hooks/use_is_in_place_editing_active.ts




function useIsInPlaceEditingActive() {
  var _a, _b;
  const inPlaceEditingEnabled = (0,use_in_place_editing/* useInPlaceEditing */.S)(
    (_b = (_a = (0,current_page_data/* getCurrentPageData */.Vd)()) == null ? void 0 : _a.currentPage) != null ? _b : null
  );
  return (0,editing_context/* isInPlaceEditingActive */.HD)() && inPlaceEditingEnabled;
}

// EXTERNAL MODULE: ./scrivito_sdk/app_support/navigate_to.ts
var navigate_to = __webpack_require__(9964);
;// ./scrivito_sdk/app_support/open_dialog.ts
...
;// ./scrivito_sdk/app_support/content_dump.ts
...
// EXTERNAL MODULE: ./scrivito_sdk/app_support/visitor_authentication.ts
var visitor_authentication = __webpack_require__(1522);
;// ./scrivito_sdk/app_support/preload.ts
...
function preload(preloadDump) {
  return preload_async(this, null, function* () {
    if ((0,visitor_authentication/* isVisitorAuthenticationEnabled */.ip)()) return { dumpLoaded: false };
    const dumpLoaded = !(0,current_user/* isUserLoggedIn */.x3)();
...
var auth_groups = __webpack_require__(8058);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/scale_down_binary.ts
var scale_down_binary = __webpack_require__(9008);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/site_mapping.ts
var site_mapping = __webpack_require__(9403);
;// ./scrivito_sdk/app_support/render_page.ts
...
;// ./scrivito_sdk/app_support/update_content.ts
...
// EXTERNAL MODULE: ./scrivito_sdk/app_support/get_details_page_url.ts
var get_details_page_url = __webpack_require__(6802);
;// ./scrivito_sdk/app_support/url_for_data_item.ts
...
function urlForDataItem(dataItem) {
  ...
  const siteId = (0,current_page/* currentSiteId */.OI)();
  if (obj) {
    if ((0,has_component/* hasComponent */.I)(dataClassName) || obj.isBinary()) {
...
;// ./scrivito_sdk/app_support/validation_results_stub.ts
...
;// ./scrivito_sdk/app_support/ui_context.ts
...
;// ./scrivito_sdk/app_support/editor_language.ts
...
// EXTERNAL MODULE: ./scrivito_sdk/app_support/replace_internal_links.ts
var replace_internal_links = __webpack_require__(9063);
;// ./scrivito_sdk/app_support/provide_content_class.ts
...
function provideObjClass(name, definition) {
  ...
  if ((0,data_integration/* isExternalDataClassProvided */.Wq)((0,data_integration/* addDataClassPrefix */.Co)(name))) {
    throw new common/* ArgumentError */.c1(`Class with name ${name} already exists`);
  }
...
var provide_editing_config = __webpack_require__(1288);
;// ./scrivito_sdk/app_support/is_on_current_path.ts
...
;// ./scrivito_sdk/app_support/perform_with_iam_token.ts

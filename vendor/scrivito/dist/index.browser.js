...
function initializeContentFromHook(content) {
  ...
  if (callback)
    callback((0,scrivito_sdk_realm__WEBPACK_IMPORTED_MODULE_5__/* .wrapInAppClass */ .Dy)(content));
}
...
function navigateToTarget(target, callId, options) {
  return __async(this, null, function* () {
    try {
      ...
      if ((0,scrivito_sdk_app_support_basic_navigate_to__WEBPACK_IMPORTED_MODULE_2__/* .isLatestNavigateToCallId */ .Dn)(callId))
        (0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .throwNextTick */ .JL)(e);
    }
  });
}
...
const uiAdapterDescription = {
  ...
  isLayoutEditable: bridge/* GET */.fG,
  isPageEditable: bridge/* GET */.fG,
...
const appAdapterDescription = {
  ...
  wantsLayoutEditing: bridge/* GET */.fG,
...
function switchToCanonicalUrl(pageData) {
  ...
  (0,loadable/* load */.Hh)(() => {
    if (browser_location/* get */.Jt() !== location)
      return;
...
function calculateOfflineMode(config) {
  ...
  if (!((_a = config.unstable) == null ? void 0 : _a.allowOfflineMode))
    return false;
  if (!!ui_adapter/* uiAdapter */.B || !isRunningInBrowser())
    return false;

...
function initializeContentForObj(objId) {
  return (0,scrivito_sdk_loadable__WEBPACK_IMPORTED_MODULE_3__/* .load */ .Hh)(() => scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_4__/* .BasicObj */ .kI.get(objId)).then((basicObj) => {
    if (basicObj) {
...
function initializeContentForWidget(objId, widgetId) {
  return (0,scrivito_sdk_loadable__WEBPACK_IMPORTED_MODULE_3__/* .load */ .Hh)(() => scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_4__/* .BasicObj */ .kI.get(objId)).then((basicObj) => {
    if (!basicObj) return;
    return (0,scrivito_sdk_app_support_present_ui_adapter__WEBPACK_IMPORTED_MODULE_2__/* .presentUiAdapter */ .H)().finishReplicatingObj((0,scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_4__/* .currentObjSpaceId */ .eb)(), objId).then(() => {
...
var pick_ = __webpack_require__(6986);
...
function navigateToAsync(target, options) {
  return __async(this, null, function* () {
    const callId = (0,scrivito_sdk_app_support_basic_navigate_to__WEBPACK_IMPORTED_MODULE_2__/* .getNextNavigateToCallId */ .fH)();
...
function navigateToTarget(target, callId, options) {
  return __async(this, null, function* () {
    try {
      ...
      return (0,scrivito_sdk_app_support_basic_navigate_to__WEBPACK_IMPORTED_MODULE_2__/* .basicNavigateTo */ .vU)(
        yield getRoutingTarget(basicTarget, options),
        callId
      );
    } catch (e) {
      if ((0,scrivito_sdk_app_support_basic_navigate_to__WEBPACK_IMPORTED_MODULE_2__/* .isLatestNavigateToCallId */ .Dn)(callId)) (0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_4__/* .throwNextTick */ .JL)(e);
    }
  });
}
function navigateToDataItem(dataItem, options, callId) {
  return __async(this, null, function* () {
    const url = yield (0,scrivito_sdk_loadable__WEBPACK_IMPORTED_MODULE_6__/* .load */ .Hh)(() => (0,scrivito_sdk_app_support_url_for_data_item__WEBPACK_IMPORTED_MODULE_3__/* .urlForDataItem */ .y)(dataItem));
    if (!url) return;
    ...
    return (0,scrivito_sdk_app_support_basic_navigate_to__WEBPACK_IMPORTED_MODULE_2__/* .basicNavigateTo */ .vU)({ url: uri.resource() }, callId);
  });
}
...
function extractRoutingTargetForLink(link, queryParameters, hashToApply) {
  ...
  const objId = linkObj instanceof scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_7__/* .BasicObj */ .kI ? linkObj.id() : link.objId();
...
function configurePreviewSizes(previewSizes) {
  ...
  if (lodash_es_uniqBy__WEBPACK_IMPORTED_MODULE_0___default()(previewSizes, "width").length !== previewSizes.length) {
    throw new scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__/* .ArgumentError */ .c1('A "width" must be unique for sizes');
  }
  if (!previewSizes.every(validatePreviewSizeWidth)) {
    throw new scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__/* .ArgumentError */ .c1('A "width" must be a positive integer');
  }
...
function validatePreviewSizeWidth(previewSize) {
  ...
  return (0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__/* .isValidInteger */ .zh)(width) && width > 0;
}
...
function initSiteMapping(config = {}) {
  ...
  siteForUrlCallback = (url) => {
    ...
    if (origin !== config.origin && origin !== (0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .currentOrigin */ .u4)()) return;
    if (!basePath) {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  b: () => (/* reexport */ appAdapterDescription),
  q: () => (/* reexport */ uiAdapterDescription)
});
...
function getClientVersion() {
  const clientVersion = "jssdk/1.29.0-dev-1-g8cca0c919882";
...
class CmsRestApi {
  ...
  getAuthorizationProviderForRequest(authorizationProvider) {
    if (authorizationProvider === void 0) {
      if (!this.authorizationProvider) throw new common/* InternalError */.Gd();
...
var isElement_ = __webpack_require__(1821);
...
function getScrivitoVersion() {
  const version = "1.29.0-dev-1-g8cca0c919882";
  if (!version) {
...
var throttle_ = __webpack_require__(8551);
...
function getContentStateId(objSpaceId) {
  if ((0,client/* isEmptySpaceId */.dQ)(objSpaceId)) return "";
...
class ReplicationProcess {
  ...
  finishReplicating() {
    ...
    return this.replicatedVersions.filter(common/* isPresent */.Wo).filter((version) => version >= currentVersion).waitForFirst().then(() => void 0);
  }
  replicationMessages() {
...
function assertiveThreeWayMergeObjs(myVersion, otherVersion, baseVersion) {
  if (otherVersion === void 0) return myVersion;
  if (myVersion === void 0) return otherVersion;
...
function serializeDateAttribute(dataClassName, attributeName, value) {
  ...
  if (lodash_es_isDate__WEBPACK_IMPORTED_MODULE_0___default()(value)) return value.toISOString();
  throwTypeMismatch(
    dataClassName,
    attributeName,
...
function serializeReferenceAttribute(dataClassName, attributeName, value, attributeDefinition) {
  if (value === null || (0,scrivito_sdk_data_integration_data_id__WEBPACK_IMPORTED_MODULE_5__/* .isValidDataId */ .o)(value)) return value;
...
/* harmony import */ var lodash_es_mapValues__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash_es_mapValues__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8523);
/* harmony import */ var scrivito_sdk_data_integration_lazy_async__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(4547);
/* harmony import */ var scrivito_sdk_loadable__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7090);
/* harmony import */ var scrivito_sdk_state__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1946);
...
function registerDataClassSchema(dataClassName, schema) {
  ...
  schemata[dataClassName] = (0,scrivito_sdk_data_integration_lazy_async__WEBPACK_IMPORTED_MODULE_4__/* .normalizeLazyAsync */ .Q)(schema);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   IF: () => (/* binding */ getExternalData),
/* harmony export */   Kg: () => (/* binding */ setExternalData),
/* harmony export */   eX: () => (/* binding */ findInExternalDataOfflineStore)
/* harmony export */ });
/* harmony import */ var scrivito_sdk_data_integration_disable_external_data_loading__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1032);
/* harmony import */ var scrivito_sdk_data_integration_external_data_connection__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5481);
/* harmony import */ var scrivito_sdk_loadable__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7090);
...
function getExternalData(dataClass, dataId) {
  if ((0,scrivito_sdk_data_integration_disable_external_data_loading__WEBPACK_IMPORTED_MODULE_0__/* .isExternalDataLoadingDisabled */ .c)()) return void 0;
  return loadableCollection.get([dataClass, dataId]).get();
}
const loadableCollection = (0,scrivito_sdk_loadable__WEBPACK_IMPORTED_MODULE_2__/* .createLoadableCollection */ .rL)({
  name: "externaldata",
  loadElement: ([dataClass, dataId]) => ({
    loader: () => (0,scrivito_sdk_data_integration_external_data_connection__WEBPACK_IMPORTED_MODULE_1__/* .getViaDataConnection */ .F_)(dataClass, dataId)
  })
});
...
// EXTERNAL MODULE: ./scrivito_sdk/data_integration/external_data.ts
var external_data = __webpack_require__(3528);
...
function queryExternalDataOfflineStore(_0) {
  return __async(this, arguments, function* ([
    ...
    const collection = yield (0,external_data/* findInExternalDataOfflineStore */.eX)(
      (data, [dataClass, id]) => {
...
function getExternalDataQuery({ _class: dataClass, filters, search, order, limit }, attributes) {
  if ((0,disable_external_data_loading/* isExternalDataLoadingDisabled */.c)()) return new common/* EmptyContinueIterable */.l6();
  validateFilters(dataClass, filters, attributes);
...
function handleResultItem(dataClass, resultItem) {
  ...
  (0,external_data/* setExternalData */.Kg)(dataClass, id, resultItem);
  return id;
}
function preloadExternalData(dataClass, id) {
  (0,loadable/* load */.Hh)(() => (0,external_data/* getExternalData */.IF)(dataClass, id));
}
...
function toDataResult(idOrItem, dataClass) {
  if (typeof idOrItem === "string") {
    return { id: idOrItem, data: (0,external_data/* getExternalData */.IF)(dataClass, idOrItem) };
  }
...
class ExternalDataClass extends data_class/* DataClass */.bA {
  ...
  get(id) {
    return (0,external_data/* getExternalData */.IF)(this._name, id) ? ExternalDataItem.build(this, id) : null;
  }
  getUnchecked(id) {
...
class ExternalDataScope extends data_class/* DataScope */.bq {
  ...
  create(attributes) {
    return external_data_class_async(this, null, function* () {
      ...
      (0,external_data/* setExternalData */.Kg)(dataClassName, id, data);
...
class ExternalDataItem extends data_class/* DataItem */.sO {
  ...
  update(attributes) {
    return external_data_class_async(this, null, function* () {
      ...
      (0,external_data/* setExternalData */.Kg)(dataClassName, this._dataId, {
  ...
  delete() {
    return external_data_class_async(this, null, function* () {
      ...
      (0,external_data/* setExternalData */.Kg)(this.dataClassName(), this._dataId, null);
      this.notifyWrite();
    });
  }
  /** @internal */
  ...
  getExternalData() {
    return (0,external_data/* getExternalData */.IF)(this.dataClassName(), this._dataId);
  }
  notifyWrite() {
...
function handleCommunicationError(request) {
  try {
    ...
    if (isCommunicationError(error)) throw new data_class/* DataScopeError */.Zz(error.message);
    throw error;
  }
}
...
// UNUSED EXPORTS: resetExternalDataConnections
...
function indexViaDataConnection(name, params) {
  return external_data_connection_async(this, null, function* () {
    ...
    if (result instanceof data_connection_error/* DataConnectionError */.B) throw result;
...
/* harmony export */ });
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8523);
/* harmony import */ var scrivito_sdk_data_integration_external_data_class__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4895);
...
// UNUSED EXPORTS: DataItemAttribute, ExternalDataScope, ObjDataScope, getDataAttributeDefinitions, getDataClass, getDataContextValue, isValidDataId, provideDataClass, setExternalData
...
function findScopeInGlobalData(dataClassName) {
  ...
  if (itemPojo) return (0,data_class/* itemPojoToScopePojo */.$v)(itemPojo);
}
...
function dataContextFromQueryParams(obj, params) {
  ...
  if (!(0,data_id/* isValidDataId */.o)(dataId)) return "unavailable";
...
// EXTERNAL MODULE: ./scrivito_sdk/data_integration/external_data_class.ts + 2 modules
var external_data_class = __webpack_require__(4895);
// EXTERNAL MODULE: ./scrivito_sdk/data_integration/data_class_schema.ts
var data_class_schema = __webpack_require__(135);
// EXTERNAL MODULE: ./scrivito_sdk/data_integration/external_data_connection.ts + 1 modules
var external_data_connection = __webpack_require__(5481);
// EXTERNAL MODULE: ./scrivito_sdk/data_integration/lazy_async.ts
var lazy_async = __webpack_require__(4547);
...
function registerExternalDataClass(name, params) {
  (0,external_data_connection/* setExternalDataConnection */.kz)(
    name,
    (0,lazy_async/* mapLazyAsync */.v)(params, (eagerParams) => eagerParams.connection)()
  );
  (0,data_class_schema/* registerDataClassSchema */.h$)(
    name,
    (0,lazy_async/* mapLazyAsync */.v)(params, (eagerParams) => eagerParams.schema)
  );
}
...
function findMatchingDataItemOrThrow(viaClass, dataStack) {
  ...
  if (item instanceof data_class/* DataItem */.sO) return item;
...
function findMatchingDataScopeOrThrow(className, dataStack, viaRef) {
  ...
  if (scope instanceof data_class/* DataScope */.bq) return scope;
...
function getDataItem(dataClassName, dataStack) {
  return (0,loadable/* loadableWithDefault */.s4)("loading", () => {
    ...
    if (element) return (_a = (0,get_data_class/* getDataClass */.D5)(dataClassName)) == null ? void 0 : _a.get(element._id);
  });
}
...
// EXTERNAL MODULE: ./scrivito_sdk/data_integration/current_language.ts
var current_language = __webpack_require__(1514);
// EXTERNAL MODULE: ./scrivito_sdk/data_integration/provide_data_class.ts
var provide_data_class = __webpack_require__(6647);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Q: () => (/* binding */ normalizeLazyAsync),
/* harmony export */   v: () => (/* binding */ mapLazyAsync)
/* harmony export */ });
...
function objClassScope(dataClass) {
  ...
  return dataClassName === "Obj" ? dataScope : dataScope.and((0,scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_4__/* .restrictToObjClass */ .Lw)(dataClassName));
}
...
function getReference(obj, attributeName, attributeConfig) {
  ...
  if (!(referenceObj instanceof scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_4__/* .BasicObj */ .kI)) return null;
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   E: () => (/* binding */ provideDataClass)
/* harmony export */ });
/* harmony import */ var scrivito_sdk_client__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(853);
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8523);
/* harmony import */ var scrivito_sdk_data_integration__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9800);
/* harmony import */ var scrivito_sdk_data_integration_lazy_async__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(4547);
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2207);
/* harmony import */ var scrivito_sdk_realm__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(7461);
/* harmony import */ var _create_rest_api_schema__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(1812);
...
function provideDataClass(name, params) {
  if (name === "Obj") {
    throw new scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__/* .ArgumentError */ .c1('"Obj" is not a valid data class name');
  }
  if ((0,scrivito_sdk_realm__WEBPACK_IMPORTED_MODULE_4__/* .getRealmClass */ .an)(name)) {
    throw new scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__/* .ArgumentError */ .c1(`Class with name "${name}" already exists`);
  }
  (0,scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_3__/* .assertValidDataIdentifier */ .AR)(name);
  (0,scrivito_sdk_data_integration__WEBPACK_IMPORTED_MODULE_2__/* .registerExternalDataClass */ .$T)(name, (0,scrivito_sdk_data_integration_lazy_async__WEBPACK_IMPORTED_MODULE_6__/* .mapLazyAsync */ .v)(params, desugar)());
  return new scrivito_sdk_data_integration__WEBPACK_IMPORTED_MODULE_2__/* .ExternalDataClass */ .Gf(name);
}
function desugar(params) {
  return __async(this, null, function* () {
    ...
    if ("restApi" in params) {
      ...
      return __spreadValues({
        connection: Promise.resolve((0,scrivito_sdk_data_integration__WEBPACK_IMPORTED_MODULE_2__/* .createRestApiConnectionForClass */ .En)(apiClient))
      }, (0,_create_rest_api_schema__WEBPACK_IMPORTED_MODULE_5__/* .createRestApiSchema */ .o)(
...
function createApiClient(restApiPromise) {
  return __async(this, null, function* () {
    ...
    return typeof restApi === "string" ? (0,scrivito_sdk_client__WEBPACK_IMPORTED_MODULE_0__/* .createRestApiClient */ .gM)(restApi) : (0,scrivito_sdk_client__WEBPACK_IMPORTED_MODULE_0__/* .createRestApiClient */ .gM)(restApi.url, restApi);
  });
}
...
var once_ = __webpack_require__(4102);
...
function setCurrentWorkspaceId(id) {
  objSpaceId = id === "published" ? scrivito_sdk_client__WEBPACK_IMPORTED_MODULE_0__/* .PUBLISHED_SPACE */ .M1 : ["workspace", id];
}
...
var isEqual_ = __webpack_require__(9477);
var isEqual_default = /*#__PURE__*/__webpack_require__.n(isEqual_);
// EXTERNAL MODULE: external "lodash-es/omitBy"
var omitBy_ = __webpack_require__(8547);
...
var external_speakingurl_ = __webpack_require__(2753);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   O: () => (/* binding */ CurrentEditableAreaContext)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(629);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);


const CurrentEditableAreaContext = react__WEBPACK_IMPORTED_MODULE_0__.createContext("outermostLayout");
...
// EXTERNAL MODULE: ./scrivito_sdk/react/current_editable_area_context.ts
var current_editable_area_context = __webpack_require__(6922);
...
function useInPlaceEditing() {
  const currentEditableArea = external_react_.useContext(current_editable_area_context/* CurrentEditableAreaContext */.O);
...
const PageLayout = (0,react_connect/* connect */.Ng)(function PageLayout2({
  ...
  return /* @__PURE__ */ external_react_.createElement(PageDataContext, { page }, /* @__PURE__ */ external_react_.createElement(DetailsPageDataContext, { page, params }, /* @__PURE__ */ external_react_.createElement(
    current_editable_area_context/* CurrentEditableAreaContext */.O.Provider,
    {
      value: calculateCurrentEditableArea()
    },
    /* @__PURE__ */ external_react_.createElement(LayoutIndexContext.Provider, { value: layoutIndex + 1 }, Component ? /* @__PURE__ */ external_react_.createElement(Component, { page: (0,realm/* wrapInAppClass */.Dy)(page) }) : /* @__PURE__ */ external_react_.createElement(CurrentPage, null))
  )));
...
const CurrentPageWithLayout = (0,react_connect/* connect */.Ng)(function CurrentPageWithLayout2({
  ...
  return /* @__PURE__ */ external_react_.createElement(PageDataContext, { page: currentPage }, /* @__PURE__ */ external_react_.createElement(DetailsPageDataContext, { page: currentPage, params }, /* @__PURE__ */ external_react_.createElement(automatic_data_context/* AutomaticDataContext */.T, { content: currentPage }, /* @__PURE__ */ external_react_.createElement(current_editable_area_context/* CurrentEditableAreaContext */.O.Provider, { value: "currentPage" }, /* @__PURE__ */ external_react_.createElement(PageScroll, { navigationState }), PageComponent && /* @__PURE__ */ external_react_.createElement(
    PageComponent,
    {
...
function showExtension(reactElement) {
  if (!onShowExtension) return (0,legacy_render_extension/* legacyRenderExtension */.b)(reactElement);
...
function scopeToBasicValue(dataScope, typeInfo) {
...
function attributeToBasicValue(dataAttribute, typeInfo) {
...
function itemToLink(dataItem) {
  ...
  if (detailsPageAndQuery) {
    const { detailsPage, query } = detailsPageAndQuery;
    link = new models/* BasicLink */.Re({ objId: detailsPage.id(), query });
  }
  return link;
}
...
var pickBy_ = __webpack_require__(5231);
...
module.exports = __WEBPACK_EXTERNAL_MODULE__2064__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__4737__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__9866__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__1821__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__8547__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__4102__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__6986__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__5231__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__8551__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__3718__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE__3103__;
...
__webpack_require__.d(__webpack_exports__, {
  ...
  provideDataClass: () => (/* reexport */ provide_data_class/* provideDataClass */.E),
...
function switchToCanonicalUrl(pageData) {
  ...
  (0,loadable/* load */.Hh)(() => {
    ...
    browser_location/* replace */.HC(locationUri.path(canonicalPath).toString());
  });
}
...
function setFlagInLocalStorage() {
  if (!ui_adapter/* uiAdapter */.B) (0,common/* setInLocalStorage */.Yz)(isUserLoggedInStorageKey(), "");
}
...
function getOfflineModeFromStorage() {
  return (0,common/* getFromLocalStorage */.zM)(getOfflineModeStorageKey());
}
...
function importEditors() {
  return __webpack_require__.e(/* import() */ 723).then(__webpack_require__.bind(__webpack_require__, 9658));
}
...
function getLocalOrigins() {
  var _a, _b;
  return (_b = (_a = (0,common/* getFromLocalStorage */.zM)("SCRIVITO_TRUSTED_UI_ORIGINS")) == null ? void 0 : _a.split(" ")) != null ? _b : [];
}

// EXTERNAL MODULE: ./scrivito_sdk/app_ui_protocol/index.ts + 2 modules
var app_ui_protocol = __webpack_require__(2296);
...
function establishUiConnection(uiWindow) {
  const promiseForMessagePort = (0,bridge/* connectTo */.m6)(
    uiWindow,
  ...
  return (0,bridge/* createAdapterClient */.xN)(
    app_ui_protocol/* uiAdapterDescription */.q,
    (0,bridge/* createAdapterMessageClient */.qo)((0,bridge/* anticipatedMessageLink */.mj)(promiseForMessagePort.then(bridge/* linkViaPort */.KA)))
  );
}
...
var react = __webpack_require__(1984);
// EXTERNAL MODULE: ./scrivito_sdk/react_connect/index.ts + 7 modules
var react_connect = __webpack_require__(3602);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/can_edit.ts
var can_edit = __webpack_require__(5057);
...
// EXTERNAL MODULE: ./scrivito_sdk/data_integration/provide_data_class.ts
var provide_data_class = __webpack_require__(6647);
// EXTERNAL MODULE: ./scrivito_sdk/data_integration/create_rest_api_schema.ts + 1 modules
var create_rest_api_schema = __webpack_require__(1812);
...
function provideDataItem(name, params) {
  ...
  (0,data_integration/* provideExternalDataItem */.wc)(
    ...
    (() => provide_data_item_async(this, null, function* () {
      return desugar(yield resolvedParams);
    }))()
  );
...
function desugar(params) {
  return provide_data_item_async(this, null, function* () {
    ...
    if ("restApi" in params) {
      ...
      }, (0,create_rest_api_schema/* createRestApiSchema */.o)(
        { attributes: params.attributes, title: params.title },
        apiClient
      ));
    }

...
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8335);
...
/* harmony export */ });
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8335);
...
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(8335);
/* harmony import */ var scrivito_sdk_loadable__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(6664);
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(5050);
...
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8335);
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5050);
...
// EXTERNAL MODULE: ./scrivito_sdk/common/index.ts + 61 modules
var common = __webpack_require__(8335);
...
/* harmony import */ var scrivito_sdk_app_support_ui_adapter__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(3218);
/* harmony import */ var scrivito_sdk_app_support_ui_adapter_compatible_value__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8493);
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8335);
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5050);
...
function configureContentBrowser(configuration, ...excessArgs) {
  ...
  try {
    ...
    throw e instanceof Error ? new scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .ArgumentError */ .ir(removeUnionSubTypeIndexesFromKey(e.message)) : e;
  }
  ...
  if (baseFilter) {
    ...
    if (baseQuery) {
      scrivito_sdk_app_support_ui_adapter__WEBPACK_IMPORTED_MODULE_4__/* .uiAdapter */ .k.configureContentBrowser(
        (0,scrivito_sdk_app_support_ui_adapter_compatible_value__WEBPACK_IMPORTED_MODULE_1__/* .uiAdapterCompatibleValue */ .f)({ baseQuery })
      );
    }
  }
}
...
const checkConfigure = (() => {
  if (scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .nodeEnv */ .rR !== "development")
    return () => {
    };
  const SearchFieldType = scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .tcomb.union */ .pC.union([scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .tcomb.String */ .pC.String, scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .tcomb.list */ .pC.list(scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .tcomb.String */ .pC.String)]);
  const SearchOperatorType = scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .tcomb.enums */ .pC.enums.of(
    (0,lodash_es_intersection__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z)(scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_3__/* .OPERATORS */ .fP, [
      "contains",
      "containsPrefix",
      "equals",
      "startsWith",
  ...
  const SearchValueType = scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .tcomb.union */ .pC.union(
    [
  ...
  const FilterNodeType = scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .tcomb["interface"] */ .pC["interface"]({
  ...
  const RadioFilterType = FilterCollectionNodeType.extend(
    {
      type: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .tcomb.enums */ .pC.enums.of(["radioButton"]),
  ...
  const CheckboxFilterType = FilterCollectionNodeType.extend(
    {
      type: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .tcomb.enums */ .pC.enums.of(["checkbox"]),
  ...
  const TreeFilterType = scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .tcomb.declare */ .pC.declare("TreeFilterDefinition");
  TreeFilterType.define(
    FilterNodeType.extend({
      type: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .tcomb.maybe */ .pC.maybe(scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .tcomb.enums */ .pC.enums.of(["tree"])),
  ...
  const FilterDefinitionType = scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .tcomb.union */ .pC.union([
  ...
  const StaticFiltersType = scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .tcomb.dict */ .pC.dict(scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .tcomb.String */ .pC.String, FilterDefinitionType);
  const DynamicOrStaticFiltersType = scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .tcomb.union */ .pC.union([scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .tcomb.Function */ .pC.Function, StaticFiltersType]);
  DynamicOrStaticFiltersType.dispatch = (v) => scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .tcomb.Function */ .pC.Function.is(v) ? DynamicOrStaticFiltersType.meta.types[0] : DynamicOrStaticFiltersType.meta.types[1];
  const BaseFilterType = scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .tcomb["interface"] */ .pC["interface"]({
    query: scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_3__/* .ObjSearchType */ .d4
  });
  const ConfigurationType = scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .tcomb["interface"] */ .pC["interface"](
    {
  ...
  return (0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_2__/* .checkArgumentsFor */ .PJ)(
...
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5050);
...
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5050);
...
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5050);
...
function initialContentFor(className, attributeName) {
  var _a;
  const initialContent = (_a = (0,scrivito_sdk_app_support_editing_config_store__WEBPACK_IMPORTED_MODULE_0__/* .getEditingConfigFor */ .xk)(className)) == null ? void 0 : _a.initialContent;
  if (initialContent) {
...
function initializeContentFromHook(content) {
  var _a;
  const callback = (_a = (0,scrivito_sdk_app_support_editing_config_store__WEBPACK_IMPORTED_MODULE_0__/* .getEditingConfigFor */ .xk)(content.objClass())) == null ? void 0 : _a.initialize;
  if (callback)
...
/* harmony export */ });
/* harmony import */ var lodash_es_isEmpty__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(6016);
/* harmony import */ var scrivito_sdk_app_support_basic_navigate_to__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4821);
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8335);
/* harmony import */ var scrivito_sdk_loadable__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6664);
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5050);
/* harmony import */ var scrivito_sdk_realm__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(105);
/* harmony import */ var scrivito_sdk_state__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(2757);
...
function navigateTo(target, options, ...excessArgs) {
  const callId = (0,scrivito_sdk_app_support_basic_navigate_to__WEBPACK_IMPORTED_MODULE_0__/* .getNextNavigateToCallId */ .oA)();
  (0,scrivito_sdk_state__WEBPACK_IMPORTED_MODULE_5__/* .failIfFrozen */ .un)("navigateTo");
  if (target === null) {
    (0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__/* .nextTick */ .Y3)(() => checkNavigateTo(target, options, ...excessArgs));
    return;
  }
  ...
  (0,scrivito_sdk_loadable__WEBPACK_IMPORTED_MODULE_2__/* .load */ .zD)(providesTarget).then((evaluatedTarget) => {
    checkEvaluatedTarget(evaluatedTarget);
    const basicTarget = (0,scrivito_sdk_realm__WEBPACK_IMPORTED_MODULE_4__/* .unwrapAppClass */ .bM)(evaluatedTarget);
    if (!(basicTarget instanceof scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_3__/* .BasicObj */ .Jj) && !(basicTarget instanceof scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_3__/* .BasicLink */ .AM)) {
      return;
    }
    return (0,scrivito_sdk_loadable__WEBPACK_IMPORTED_MODULE_2__/* .load */ .zD)(
      ...
      return (0,scrivito_sdk_app_support_basic_navigate_to__WEBPACK_IMPORTED_MODULE_0__/* .basicNavigateTo */ ._i)(routingTarget, callId);
    });
  }).catch((e) => {
    if ((0,scrivito_sdk_app_support_basic_navigate_to__WEBPACK_IMPORTED_MODULE_0__/* .isLatestNavigateToCallId */ .jc)(callId))
      (0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__/* .throwNextTick */ .a6)(e);
  });
}
function extractRoutingTarget(target, query, hash) {
  if (target instanceof scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_3__/* .BasicLink */ .AM) {
...
function extractRoutingTargetForLink(link, queryParameters, hashToApply) {
  ...
  const query = queryParameters && !(0,lodash_es_isEmpty__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z)(queryParameters) ? queryParameters : link.queryParameters();
  const linkObj = link.obj();
  const objId = linkObj instanceof scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_3__/* .BasicObj */ .Jj ? linkObj.id() : link.objId();
  return objId ? { objId, query, hash } : void 0;
}
const EvaluatedTargetType = scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__/* .tcomb.union */ .pC.union([scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_3__/* .ObjType */ .Bt, scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_3__/* .LinkType */ .Un]);
const TargetType = scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__/* .tcomb.union */ .pC.union([scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__/* .tcomb.Function */ .pC.Function, EvaluatedTargetType]);
const ParamsValueType = scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__/* .tcomb.dict */ .pC.dict(
  scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__/* .tcomb.String */ .pC.String,
  scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__/* .tcomb.maybe */ .pC.maybe(scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__/* .tcomb.union */ .pC.union([scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__/* .tcomb.String */ .pC.String, scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__/* .tcomb.list */ .pC.list(scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__/* .tcomb.String */ .pC.String), scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__/* .tcomb.Nil */ .pC.Nil]))
);
const checkNavigateTo = (0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__/* .checkArgumentsFor */ .PJ)(
  "navigateTo",
  [
    ["target", TargetType],
    [
      "options",
      scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__/* .tcomb.maybe */ .pC.maybe(
        scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__/* .tcomb["interface"] */ .pC["interface"](
          {
            ...
            params: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__/* .tcomb.maybe */ .pC.maybe(ParamsValueType)
          },
          { strict: false }
        )
      )
...
const checkNavigateToConvenience = (0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__/* .checkArgumentsFor */ .PJ)(
  "navigateTo",
  [
    ["target", TargetType],
    ["options", scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__/* .tcomb.maybe */ .pC.maybe(ParamsValueType)]
  ],
  {
    docPermalink: "js-sdk/navigateTo"
  }
);
const checkEvaluatedTarget = (0,scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_1__/* .checkArgumentsFor */ .PJ)(
  "navigateTo",
...
/* harmony import */ var scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8335);
/* harmony import */ var scrivito_sdk_data_integration__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(4867);
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(5050);
...
function provideEditingConfig(subject, editingConfig, ...excessArgs) {
  ...
  (0,scrivito_sdk_app_support_editing_config_store__WEBPACK_IMPORTED_MODULE_0__/* .setEditingConfigFor */ .ox)((0,scrivito_sdk_app_support_get_class_name__WEBPACK_IMPORTED_MODULE_1__/* .getClassName */ .g)(subject), editingConfig);
}
function getAttributeEditingOptionsFor(className, attributeName, attributeType) {
  var _a;
  const attributes = ((_a = (0,scrivito_sdk_app_support_editing_config_store__WEBPACK_IMPORTED_MODULE_0__/* .getEditingConfigFor */ .xk)(className)) == null ? void 0 : _a.attributes) || {};
...
const { checkProvideEditingConfig, throwInvalidOptions } = (() => {
  if (scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_3__/* .nodeEnv */ .rR !== "development") {
    return {
  ...
  const PropertiesGroupDescriptionType = scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_3__/* .tcomb["interface"] */ .pC["interface"]({
    title: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_3__/* .tcomb.String */ .pC.String,
    properties: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_3__/* .tcomb.list */ .pC.list(scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_3__/* .tcomb.String */ .pC.String),
  ...
  const RegisteredComponentGroupDescriptionType = scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_3__/* .tcomb["interface"] */ .pC["interface"]({
    ...
    properties: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_3__/* .tcomb.maybe */ .pC.maybe(scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_3__/* .tcomb.list */ .pC.list(scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_3__/* .tcomb.String */ .pC.String)),
    enabled: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_3__/* .tcomb.maybe */ .pC.maybe(scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_3__/* .tcomb.Boolean */ .pC.Boolean),
    key: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_3__/* .tcomb.maybe */ .pC.maybe(scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_3__/* .tcomb.String */ .pC.String)
  });
  ...
  const EditingConfigType = scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_3__/* .tcomb["interface"] */ .pC["interface"]({
    ...
    properties: scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_3__/* .tcomb.maybe */ .pC.maybe(scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_3__/* .tcomb.union */ .pC.union([scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_3__/* .tcomb.list */ .pC.list(scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_3__/* .tcomb.String */ .pC.String), scrivito_sdk_common__WEBPACK_IMPORTED_MODULE_3__/* .tcomb.Function */ .pC.Function])),
...
/* harmony import */ var scrivito_sdk_models__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(5050);
...
// EXTERNAL MODULE: ./scrivito_sdk/models/index.ts + 36 modules
var models = __webpack_require__(5050);
...
__webpack_require__.d(__webpack_exports__, {
  ...
  useDefaultPriority: () => (/* reexport */ useDefaultPriority),
  useXmlHttpRequest: () => (/* reexport */ useXmlHttpRequest),
  withEachAttributeJson: () => (/* reexport */ withEachAttributeJson)
});

// UNUSED EXPORTS: MissingWorkspaceError, isComparisonRange, isObjSpaceId, replaceCmsRetrieval, requestBuiltInUserSession, retrieveObjFieldDiffs, setupRegisterVerificator
...
function isErrorResponse(parsedResponse) {
  ...
  return errorType === "string" && (codeType === "string" || codeType === "undefined") && ((0,isObject/* default */.Z)(details) || typeof details === "undefined");
}
...
// UNUSED EXPORTS: BehaviorSubject, anticipatedStream, appUrlFromPackagedUiUrl, bypassThrottle, cleanUniqueErrorMessage, clearLocalStorage, currentHash, detectUniqueErrorMessage, disableConsoleError, enableUniqueErrors, fetchMaybeTenant, getChildPath, hasTenantConfigurationBeenSet, isConfiguredWithoutTenant, isLocalhostUrl, isUnderscore, resetConfiguredTenant, setNextTickScheduler, setRegisterAsyncTaskHandler, setScrivitoPromise, sliceFromIterable, tryGetConfiguredTenant, windowLocationOrigin
...
function throttle_throttle(fn, ms, options) {
  return shouldBypassThrottle ? fn : lodash_es_throttle(fn, ms, options);
}
...
// EXTERNAL MODULE: ../node_modules/lodash-es/isObject.js
var lodash_es_isObject = __webpack_require__(6743);
// EXTERNAL MODULE: ./scrivito_sdk/common/index.ts + 61 modules
var common = __webpack_require__(8335);
...
function assertValidDataItemAttributes(attributes) {
  if (!(0,lodash_es_isObject/* default */.Z)(attributes)) {
...
function assertValidResultItem(resultItem) {
  if (!(0,lodash_es_isObject/* default */.Z)(resultItem)) {
...
function isExternalData(data) {
  return (0,lodash_es_isObject/* default */.Z)(data) && typeof data !== "function" && !Array.isArray(data);
}
...
function assertValidIndexResult(result) {
  if (!(0,lodash_es_isObject/* default */.Z)(result)) {
...
function isDataLocatorValueFilter(filter) {
  return (0,lodash_es_isObject/* default */.Z)(filter) && typeof filter.field === "string" && typeof filter.value === "string";
}
...
/* harmony import */ var scrivito_sdk_app_support_ui_adapter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3218);
/* harmony import */ var scrivito_sdk_loadable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6664);
...
// UNUSED EXPORTS: BasicObjFacetValue, isCurrentWorkspacePublished, normalizedRestriction, resetCurrentWorkspaceId, restrictToGlobal, serializeAttributes, setBinaryHandler, setCopyObjHandler, setCurrentWorkspaceId
...
;// CONCATENATED MODULE: external "w3c-xmlhttprequest"
const external_w3c_xmlhttprequest_namespaceObject = require("w3c-xmlhttprequest");
// EXTERNAL MODULE: ./scrivito_sdk/app_support/current_page.ts
var current_page = __webpack_require__(4106);
// EXTERNAL MODULE: ./scrivito_sdk/common/index.ts + 61 modules
var common = __webpack_require__(8335);
...
function fetchIamToken(apiKey) {
  return __async(this, null, function* () {
    const response = yield (0,client.fetchJson)("https://api.justrelate.com/iam/token", {
      method: "POST",
      headers: {
...
class ApiKeyAuthorizationProvider {
  constructor(apiKey) {
    const authProvider = isIamTokenAuth(apiKey) ? new client.TokenAuthorizationProvider(() => fetchIamToken(apiKey)) : new LegacyApiKeyAuthorizationProvider(apiKey);
...
function importEditors() {
  return __webpack_require__.e(/* import() */ 29).then(__webpack_require__.bind(__webpack_require__, 1029));
}
...
const nodeAuthHandler = {
  ...
  iamAuthProvider() {
    return new client.TokenAuthorizationProvider(() => node_auth_handler_async(this, null, function* () {
...
function initializeSdk() {
  ...
  (0,client.useXmlHttpRequest)(external_w3c_xmlhttprequest_namespaceObject.XMLHttpRequest);
  (0,client.useDefaultPriority)("background");
...
// EXTERNAL MODULE: ./scrivito_sdk/data_integration/index.ts + 24 modules
var data_integration = __webpack_require__(4867);
// EXTERNAL MODULE: ./scrivito_sdk/react/index.ts + 38 modules
var react = __webpack_require__(2066);
// EXTERNAL MODULE: ./scrivito_sdk/react_connect/index.ts + 6 modules
var react_connect = __webpack_require__(8247);
// EXTERNAL MODULE: ./scrivito_sdk/app_support/can_edit.ts
var can_edit = __webpack_require__(8083);
...
exports.DataLocatorError = __webpack_exports__.DataLocatorError;
...
exports.unstable_JrRestApi = __webpack_exports__.unstable_JrRestApi;

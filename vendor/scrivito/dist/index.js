...
/* harmony export */ });
/* unused harmony exports isResponseMessage, isErrorMessage */
...
function getClientVersion() {
  const clientVersion = "jssdk/1.29.0.dev-1-gbf5783c9f3a0";
  if (!clientVersion)
    throw new common/* InternalError */.AQ();
...
function getScrivitoVersion() {
  const version = "1.29.0.dev-1-gbf5783c9f3a0";
  if (!version) {
...
function isEqualState(stateA, stateB) {
  return (0,external_underscore_.isEmpty)(obj_patch_diffObjJson(stateA, stateB));
}
...
function isExternalData(data) {
  return (0,external_underscore_.isObject)(data) && typeof data !== "function" && !Array.isArray(data);
}
...
function toDataResult(idOrItem, dataClass) {
  ...
  const _a = idOrItem, { _id: id } = _a, data = __objRest(_a, ["_id"]);
  return { id, data };
}
...
function initializeSdk() {
  ...
  (0,client.useXmlHttpRequest)(external_w3c_xmlhttprequest_.XMLHttpRequest);
